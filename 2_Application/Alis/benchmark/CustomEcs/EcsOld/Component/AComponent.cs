...
namespace Alis.Core.EcsOld.Component
{
    ...
    public abstract class AComponent : IComponent<GameObject>
    {
        ...
        public virtual void OnPressDownKey(Keys key) => Logger.Trace();

        /// <summary>
        ///     Ons the release key using the specified key
        /// </summary>
        /// <param name="key">The key</param>
        public virtual void OnReleaseKey(Keys key) => Logger.Trace();

        /// <summary>
        ///     Ons the press key using the specified key
        /// </summary>
        /// <param name="key">The key</param>
        public virtual void OnPressKey(Keys key) => Logger.Trace();
