...
namespace Alis.Builder.Core.EcsOld.Entity.Scene
{
    /// <summary>
    ...
    public class SceneBuilder :
        IBuild<Alis.Core.EcsOld.Entity.Scene>,
        IName<SceneBuilder, string>,
        IAdd<SceneBuilder, Func<GameObjectBuilder, Alis.Core.EcsOld.Entity.GameObject>>
    {
        /// <summary>
        ///     The context
        /// </summary>
        ...
        /// </summary>
        private Alis.Core.EcsOld.Entity.Scene Scene { get; } = new Alis.Core.EcsOld.Entity.Scene();
        ...
        public SceneBuilder Add<T>(Func<GameObjectBuilder, Alis.Core.EcsOld.Entity.GameObject> value)
        {
        ...
        public Alis.Core.EcsOld.Entity.Scene Build() => Scene;
