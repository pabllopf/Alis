...
using Alis.Builder.Core.Ecs.Component.Particle;
using Alis.Core.Aspect.Fluent;
using Alis.Core.Aspect.Logging;

namespace Alis.Core.Ecs.Component.Particle
{
    /// <summary>
    ///     The explosion particle class
    /// </summary>
    /// <seealso cref="Particle" />
    public class ExplosionParticle : Particle, IBuilder<ExplosionParticleBuilder>
    {
        /// <summary>
