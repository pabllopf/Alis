...
namespace Alis.Test.Core.EcsOld.System.Manager.Scene
{
    /// <summary>
    ...
    public class SceneManagerTest
    {
        ...
        public void Remove_ValidInput_RemovesScene()
        {
            VideoGame videoGame = new VideoGame();
            SceneManager sceneManager = new SceneManager(videoGame.Context);
            Alis.Core.EcsOld.Entity.Scene scene = new Alis.Core.EcsOld.Entity.Scene();
        ...
        public void Get_ValidInput_ReturnsScene()
        {
            ...
            Alis.Core.EcsOld.Entity.Scene scene = new Alis.Core.EcsOld.Entity.Scene();
            sceneManager.Scenes.Add(scene);
            Alis.Core.EcsOld.Entity.Scene result = sceneManager.Get<Alis.Core.EcsOld.Entity.Scene>();
        ...
        public void Contains_ValidInput_ReturnsTrue()
        {
            ...
            Alis.Core.EcsOld.Entity.Scene scene = new Alis.Core.EcsOld.Entity.Scene();
            sceneManager.Scenes.Add(scene);
            bool result = sceneManager.Contains<Alis.Core.EcsOld.Entity.Scene>();
            Assert.True(result);
        }
        ...
        public void Clear_ValidInput_ClearsScenes()
        {
            ...
            Alis.Core.EcsOld.Entity.Scene scene = new Alis.Core.EcsOld.Entity.Scene();
            sceneManager.Scenes.Add(scene);
            sceneManager.Clear<Alis.Core.EcsOld.Entity.Scene>();
