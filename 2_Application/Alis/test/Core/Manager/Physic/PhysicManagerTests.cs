...
namespace Alis.Test.Core.Manager.Physic
{
    /// <summary>
    /// The physic manager tests class
    /// </summary>
    public class PhysicManagerTests
    {
        /// <summary>
        /// The mock repository
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PhysicManagerTests"/> class
        /// </summary>
        public PhysicManagerTests()
        {
        ...
        private PhysicManager CreateManager()
        {
            return new PhysicManager();
        }
        ...
        /// <summary>
        /// Tests that attach body state under test expected behavior
        /// </summary>
        [Fact]
        public void AttachBody_StateUnderTest_ExpectedBehavior()
        {
            // Arrange
            var manager = this.CreateManager();
