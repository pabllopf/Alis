...
``` {frame="trBL" caption="Comando para crear un proyecto con el Core de Alis"}
...
``` {.java language="Java" frame="trBL" caption="Programa que permite probar el Core de Alis"}
...
![Resultado de ejecución de la prueba del
Core](Fotos_Manual/core_listo.PNG){width="70%"}
