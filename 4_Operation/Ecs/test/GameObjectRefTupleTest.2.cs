...
namespace Alis.Core.Ecs.Test
{
    ...
    public partial class GameObjectRefTupleTest
    {
        ...
        public void RefTuple2_Initialize_ShouldSetGameObjectAndComponents()
        {
            ...
            // Act
            var tuple = new GameObjectRefTuple<Position, Velocity>
            {
                GameObject = entity,
        ...
        public void RefTuple2_MultipleTuples_ShouldMaintainSeparateState()
        {
            ...
            // Act
            var tuple1 = new GameObjectRefTuple<Position, Velocity>
            {
                GameObject = entity1,
            ...
            var tuple2 = new GameObjectRefTuple<Position, Velocity>
            {
                GameObject = entity2,
        ...
        public void RefTuple2_WithSameComponentTypes_ShouldWork()
        {
            ...
            // Act
            var tuple = new GameObjectRefTuple<Health, Armor>
            {
                GameObject = entity,
