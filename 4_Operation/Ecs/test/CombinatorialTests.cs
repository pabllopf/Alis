...
namespace Alis.Core.Ecs.Test
{
    ...
    public class CombinatorialTests
    {
        ...
        [Theory, InlineData(1, 0), InlineData(2, 1), InlineData(3, 1), InlineData(5, 2), InlineData(10, 5), InlineData(3, 2), InlineData(5, 3), InlineData(10, 1)]
        ...
        /// <param name="componentType">The component type</param>
        [Theory, InlineData(1, 1), InlineData(2, 1), InlineData(3, 1), InlineData(5, 2), InlineData(10, 3), InlineData(5, 4), InlineData(10, 5)]
        ...
        [Theory, InlineData(1, 1), InlineData(1, 2), InlineData(2, 1), InlineData(2, 2), InlineData(3, 1), InlineData(3, 2), InlineData(5, 1), InlineData(5, 2), InlineData(5, 3), InlineData(10, 1), InlineData(10, 2), InlineData(10, 5), InlineData(20, 1), InlineData(20, 5), InlineData(50, 10), InlineData(100, 20)]
