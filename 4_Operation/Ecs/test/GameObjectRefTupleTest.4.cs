...
namespace Alis.Core.Ecs.Test
{
    ...
    public partial class GameObjectRefTupleTest
    {
        ...
        public void RefTuple4_Initialize_ShouldSetGameObjectAndAllComponents()
        {
            ...
            // Act
            var tuple = new GameObjectRefTuple<Position, Velocity, Health, Armor>
            {
                GameObject = entity,
        ...
        public void RefTuple4_Deconstruct_ShouldReturnGameObjectAndAllRefs()
        {
            ...
            // Act
            var (go, posRef, velRef, healthRef, armorRef) = tuple;
        ...
        public void RefTuple4_MultipleTuples_ShouldMaintainSeparateState()
        {
            ...
            // Act
            var tuple1 = new GameObjectRefTuple<Position, Velocity, Health, Armor>
            {
                GameObject = entity1,
            ...
            var tuple2 = new GameObjectRefTuple<Position, Velocity, Health, Armor>
            {
                GameObject = entity2,
