...
namespace Alis.Core.Ecs.Test
{
    ...
    public class MassiveEntityCreationTests
    {
        ...
        [Theory, InlineData(50), InlineData(100), InlineData(200), InlineData(500), InlineData(1000)]
        ...
        [Theory, InlineData(50, 2), InlineData(100, 3), InlineData(200, 5)]
        ...
        [Theory, InlineData(50), InlineData(100)]
