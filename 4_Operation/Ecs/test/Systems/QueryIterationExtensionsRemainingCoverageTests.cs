...
// 
//  --------------------------------------------------------------------------
//  File:QueryIterationExtensionsRemainingCoverageTests.cs
// 
...
{
    /// <summary>
    ///     The query iteration extensions remaining coverage tests class
    /// </summary>
    public class QueryIterationExtensionsRemainingCoverageTests
    {
        /// <summary>
        ...
        {
            RemInlineAction1.Reset();

            using Scene scene = new Scene();
            GameObject e1 = scene.Create(new Position {X = 1, Y = 1});
            GameObject e2 = scene.Create(new Position {X = 10, Y = 10}, new AnotherComponent2 {Data = 5});

            scene.Query<With<Position>>().Inline<RemInlineAction1, Position>(default(RemInlineAction1));

            Assert.Equal(2, RemInlineAction1.Calls);
            Assert.Equal(3, e1.Get<Position>().X);
            Assert.Equal(4, e1.Get<Position>().Y);
            Assert.Equal(12, e2.Get<Position>().X);
            Assert.Equal(13, e2.Get<Position>().Y);
        ...
        {
            RemInlineAction2.Reset();

            using Scene scene = new Scene();
            GameObject e1 = scene.Create(new Position {X = 1, Y = 1}, new Velocity {X = 1, Y = 2});
            GameObject e2 = scene.Create(new Position {X = 10, Y = 10}, new Velocity {X = 3, Y = 4}, new AnotherComponent2 {Data = 5});

            scene.Query<With<Position>, With<Velocity>>().Inline<RemInlineAction2, Position, Velocity>(default(RemInlineAction2));

            Assert.Equal(2, RemInlineAction2.Calls);
            Assert.Equal(2, e1.Get<Position>().X);
            Assert.Equal(3, e1.Get<Position>().Y);
            Assert.Equal(13, e2.Get<Position>().X);
            Assert.Equal(14, e2.Get<Position>().Y);
        ...
        {
            RemInlineAction3.Reset();

            using Scene scene = new Scene();
            GameObject e1 = scene.Create(new Position {X = 1, Y = 1}, new Velocity {X = 1, Y = 1}, new Health {Value = 10});
            GameObject e2 = scene.Create(new Position {X = 10, Y = 10}, new Velocity {X = 2, Y = 3}, new Health {Value = 20}, new AnotherComponent2 {Data = 5});

            scene.Query<With<Position>, With<Velocity>, With<Health>>().Inline<RemInlineAction3, Position, Velocity, Health>(default(RemInlineAction3));

            Assert.Equal(2, RemInlineAction3.Calls);
            Assert.Equal(2, e1.Get<Position>().X);
            Assert.Equal(12, e1.Get<Health>().Value);
            Assert.Equal(12, e2.Get<Position>().X);
            Assert.Equal(22, e2.Get<Health>().Value);
        ...
        public void Inline_Arity4_UpdatesAllMatchingAcrossArchetypes()
        {
            ...
            scene.Query<With<Position>, With<Velocity>, With<Health>, With<Armor>>().Inline<RemInlineAction4, Position, Velocity, Health, Armor>(default(RemInlineAction4));

            Assert.Equal(2, RemInlineAction4.Calls);
            Assert.Equal(2, e1.Get<Position>().X);
            Assert.Equal(9, e1.Get<Health>().Value);
            Assert.Equal(22, e1.Get<Armor>().Value);
            Assert.Equal(11, e2.Get<Position>().X);
        ...
        public void Inline_Arity5_UpdatesAllMatchingAcrossArchetypes()
        {
            ...
            scene.Query<With<Position>, With<Velocity>, With<Health>, With<Armor>, With<Damage>>().Inline<RemInlineAction5, Position, Velocity, Health, Armor, Damage>(default(RemInlineAction5));

            Assert.Equal(2, RemInlineAction5.Calls);
            Assert.Equal(2, e1.Get<Position>().X);
            Assert.Equal(13, e1.Get<Health>().Value);
            Assert.Equal(21, e1.Get<Armor>().Value);
            Assert.Equal(5, e1.Get<Damage>().Value);
        ...
        public void Inline_Arity6_UpdatesAllMatchingAcrossArchetypes()
        {
            ...
            scene.Query<With<Position>, With<Velocity>, With<Health>, With<Armor>, With<Damage>, With<Transform>>().Inline<RemInlineAction6, Position, Velocity, Health, Armor, Damage, Transform>(default(RemInlineAction6));

            Assert.Equal(2, RemInlineAction6.Calls);
            Assert.Equal(2, e1.Get<Position>().X);
            Assert.Equal(11, e1.Get<Health>().Value);
            Assert.Equal(21, e1.Get<Armor>().Value);
            Assert.Equal(4, e1.Get<Damage>().Value);
        ...
        public void Inline_Arity7_UpdatesAllMatchingAcrossArchetypes()
        {
            ...
            scene.Query<With<Position>, With<Velocity>, With<Health>, With<Armor>, With<Damage>, With<Transform>, With<TestComponent>>().Inline<RemInlineAction7, Position, Velocity, Health, Armor, Damage, Transform, TestComponent>(default(RemInlineAction7));

            Assert.Equal(2, RemInlineAction7.Calls);
            Assert.Equal(2, e1.Get<Position>().X);
            Assert.Equal(10, e1.Get<TestComponent>().Value);
            Assert.Equal(8, e1.Get<Health>().Value);
            Assert.Equal(5, e1.Get<Transform>().X);
        ...
        public void Inline_Arity8_UpdatesAllMatchingAcrossArchetypes()
        {
            ...
            scene.Query<With<Position>, With<Velocity>, With<Health>, With<Armor>, With<Damage>, With<Transform>, With<TestComponent>, With<AnotherComponent>>().Inline<RemInlineAction8, Position, Velocity, Health, Armor, Damage, Transform, TestComponent, AnotherComponent>(default(RemInlineAction8));

            Assert.Equal(2, RemInlineAction8.Calls);
            Assert.Equal(2, e1.Get<Position>().Y);
            Assert.Equal(11, e1.Get<Health>().Value);
            Assert.Equal(21, e1.Get<Armor>().Value);
            Assert.Equal(4, e1.Get<Damage>().Value);
        ...
        public void Inline_AllArities_DoNothingOnEmptyQuery()
        {
            ...
            Assert.Equal(0, RemInlineAction1.Calls);
            Assert.Equal(0, RemInlineAction2.Calls);
            Assert.Equal(0, RemInlineAction3.Calls);
            Assert.Equal(0, RemInlineAction4.Calls);
            Assert.Equal(0, RemInlineAction5.Calls);
            Assert.Equal(0, RemInlineAction6.Calls);
            Assert.Equal(0, RemInlineAction7.Calls);
            Assert.Equal(0, RemInlineAction8.Calls);
        }

        /// <summary>
        ///     The inline action
        /// </summary>
        internal struct RemInlineAction1 : Ecs.Systems.IAction<Position>
        {
            /// <summary>
            ///     The calls
            /// </summary>
        ...
        ///     The inline action
        /// </summary>
        internal struct RemInlineAction2 : IAction<Position, Velocity>
        {
            /// <summary>
            ///     The calls
            /// </summary>
        ...
        ///     The inline action
        /// </summary>
        internal struct RemInlineAction3 : IAction<Position, Velocity, Health>
        {
            /// <summary>
            ///     The calls
            /// </summary>
        ...
        ///     The inline action
        /// </summary>
        internal struct RemInlineAction4 : IAction<Position, Velocity, Health, Armor>
        {
            /// <summary>
            ///     The calls
            /// </summary>
        ...
        ///     The inline action
        /// </summary>
        internal struct RemInlineAction5 : IAction<Position, Velocity, Health, Armor, Damage>
        {
            /// <summary>
            ///     The calls
            /// </summary>
        ...
        ///     The inline action
        /// </summary>
        internal struct RemInlineAction6 : IAction<Position, Velocity, Health, Armor, Damage, Transform>
        {
            /// <summary>
            ///     The calls
            /// </summary>
        ...
        ///     The inline action
        /// </summary>
        internal struct RemInlineAction7 : IAction<Position, Velocity, Health, Armor, Damage, Transform, TestComponent>
        {
            /// <summary>
            ///     The calls
            /// </summary>
        ...
        ///     The inline action
        /// </summary>
        internal struct RemInlineAction8 : IAction<Position, Velocity, Health, Armor, Damage, Transform, TestComponent, AnotherComponent>
        {
            /// <summary>
            ///     The calls
            /// </summary>
