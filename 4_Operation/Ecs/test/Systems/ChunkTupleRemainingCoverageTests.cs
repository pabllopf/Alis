...
// 
//  --------------------------------------------------------------------------
//  File:ChunkTupleRemainingCoverageTests.cs
// 
...
{
    /// <summary>
    ///     Remaining coverage tests for ChunkTuple deconstruction across arities 1..8.
    /// </summary>
    public class ChunkTupleRemainingCoverageTests
    {
        /// <summary>
        ...
        public void ChunkTuple6_Deconstruct_ReturnsMappedSpans()
        {
            ...
            {
                Span1 = a1.AsSpan(), Span2 = a2.AsSpan(), Span3 = a3.AsSpan(), Span4 = a4.AsSpan(),
                Span5 = a5.AsSpan(), Span6 = a6.AsSpan()
            };

            tuple.Deconstruct(out Span<int> s1, out Span<int> s2, out Span<int> s3, out Span<int> s4,
                out Span<int> s5, out Span<int> s6);
            s6[0] = 60;
        ...
        public void ChunkTuple7_Deconstruct_ReturnsMappedSpans()
        {
            ...
            {
                Span1 = a1.AsSpan(), Span2 = a2.AsSpan(), Span3 = a3.AsSpan(), Span4 = a4.AsSpan(),
                Span5 = a5.AsSpan(), Span6 = a6.AsSpan(), Span7 = a7.AsSpan()
            };

            tuple.Deconstruct(out Span<int> s1, out Span<int> s2, out Span<int> s3, out Span<int> s4,
                out Span<int> s5, out Span<int> s6, out Span<int> s7);
            s7[0] = 70;
        ...
        public void ChunkTuple8_Deconstruct_ReturnsMappedSpans()
        {
            ...
            int[] a7 = new int[] { 7 };
            int[] a8 = new int[] { 8 };
            ChunkTuple<int, int, int, int, int, int, int, int> tuple =
                new ChunkTuple<int, int, int, int, int, int, int, int>
                {
                    Span1 = a1.AsSpan(), Span2 = a2.AsSpan(), Span3 = a3.AsSpan(), Span4 = a4.AsSpan(),
                    Span5 = a5.AsSpan(), Span6 = a6.AsSpan(), Span7 = a7.AsSpan(), Span8 = a8.AsSpan()
                };

            tuple.Deconstruct(out Span<int> s1, out Span<int> s2, out Span<int> s3, out Span<int> s4,
                out Span<int> s5, out Span<int> s6, out Span<int> s7, out Span<int> s8);
            s8[0] = 80;
        ...
        /// <summary>
        ///     Tests that default constructor yields empty span
        /// </summary>
        [Fact]
        public void DefaultConstructor_HasDefaultEntitiesAndEmptySpans()
        {
            ChunkTuple<int> tuple = new ChunkTuple<int>();

            Assert.Equal(0, tuple.Span.Length);
        }

        /// <summary>
        ///     Tests that chunk tuple 2 with different types deconstruct returns correct types
        /// </summary>
        [Fact]
        public void ChunkTuple2_DifferentTypes_Deconstruct_ReturnsCorrectTypes()
        {
            ChunkTuple<int, float> tuple = new ChunkTuple<int, float>
                { Span1 = new int[] { 1 }.AsSpan(), Span2 = new float[] { 2.5f }.AsSpan() };
