...
namespace Alis.Core.Ecs
{
    ...
    /// </summary>
    public ref struct GameObjectQueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
    {
        /// <summary>
        ///     The archetype index
        /// </summary>
        ...
        /// </summary>
        public GameObjectRefTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Current => new()
        {
        ...
        public struct QueryEnumerable(Query query)
        {
            ...
            /// </summary>
            public GameObjectQueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> GetEnumerator()
            {
                return new GameObjectQueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(query);
            }
        }
    }
}