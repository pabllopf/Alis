...
namespace Alis.Core.Ecs.Components
{
    ...
    {
        /// <summary>
        ///     This method is called whenever a component begins its lifetime, whether by any <see cref="Entity.Add{T}(in T)" />
        ///     method or any <see cref="World.Create{T}(in T)" /> method (but not <see cref="World.CreateMany{T}(int)" />).
        /// </summary>
