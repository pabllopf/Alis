...
// 
//  --------------------------------------------------------------------------
//  File:WorldQueryExtensions.15.cs
// 
...
namespace Alis.Core.Ecs
{
    ...
    public static partial class WorldQueryExtensions
    {
...

        {
            ...
            if (scene.QueryCache.TryGetValue(QueryHashCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.Value, out Query value))
            {
                return value;
            }
            ...
            scene.QueryCache[QueryHashCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.Value] = value;
            return value;
#else
            ref Query cachedValue = ref CollectionsMarshal.GetValueRefOrAddDefault(scene.QueryCache, QueryHashCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.Value, out bool exists);
            if (!exists)
            {
