...
namespace Alis.Core.Ecs
{
    ...
    public ref struct GameObjectQueryEnumerator<T1, T2, T3>
    {
        ...
        /// </summary>
        public GameObjectRefTuple<T1, T2, T3> Current => new()
        {
        ...
        public struct QueryEnumerable(Query query)
        {
            ...
            /// </summary>
            public GameObjectQueryEnumerator<T1, T2, T3> GetEnumerator()
            {
                return new GameObjectQueryEnumerator<T1, T2, T3>(query);
            }
        }
    }
}