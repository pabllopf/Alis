...
namespace Alis.Core.Ecs
{
    ...
    internal class NullUniformProvider : IUniformProvider
    {
        ...
        /// <returns>The</returns>
        public T GetUniform<T>() => throw new InvalidOperationException("Initialize the world with an IUniformProvider in order to use uniforms");
    }
}