...
public static partial class EntityExtensions
{
    ...
    public static void Deconstruct<T1, T2, T3, T4, T5, T6>(this Entity e, out Ref<T1> comp1, out Ref<T2> comp2, out Ref<T3> comp3, out Ref<T4> comp4, out Ref<T5> comp5, out Ref<T6> comp6)
    {
