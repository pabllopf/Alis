...
namespace Alis.Core.Ecs
{
    ...
    partial struct GameObject
    {
        ...
        private static void InvokeComponentWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(ref Event<ComponentID> @event, GameObject gameObject)
        {
        ...
        private static void InvokePerEntityEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(GameObject gameObject, bool hasGenericEvent, ref ComponentEvent events, ref T1 component1, ref T2 component2, ref T3 component3, ref T4 component4, ref T5 component5, ref T6 component6, ref T7 component7, ref T8 component8, ref T9 component9, ref T10 component10, ref T11 component11,
            ref T12 component12, ref T13 component13)
        {
        ...
        private struct NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> : IArchetypeGraphEdge
        {
            ...
            public void ModifyTags(ref FastImmutableArray<TagId> tags, bool add)
            {
                if (add)
                {
                    tags = MemoryHelpers.Concat(tags, [Ecs.Tag<T1>.ID, Ecs.Tag<T2>.ID, Ecs.Tag<T3>.ID, Ecs.Tag<T4>.ID, Ecs.Tag<T5>.ID, Ecs.Tag<T6>.ID, Ecs.Tag<T7>.ID, Ecs.Tag<T8>.ID, Ecs.Tag<T9>.ID, Ecs.Tag<T10>.ID, Ecs.Tag<T11>.ID, Ecs.Tag<T12>.ID, Ecs.Tag<T13>.ID]);
                }
                else
                {
                    tags = MemoryHelpers.Remove(tags, [Ecs.Tag<T1>.ID, Ecs.Tag<T2>.ID, Ecs.Tag<T3>.ID, Ecs.Tag<T4>.ID, Ecs.Tag<T5>.ID, Ecs.Tag<T6>.ID, Ecs.Tag<T7>.ID, Ecs.Tag<T8>.ID, Ecs.Tag<T9>.ID, Ecs.Tag<T10>.ID, Ecs.Tag<T11>.ID, Ecs.Tag<T12>.ID, Ecs.Tag<T13>.ID]);
                }
            }
