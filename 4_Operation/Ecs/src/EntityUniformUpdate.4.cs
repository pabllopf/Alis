...
namespace Alis.Core.Ecs;
    internal class EntityUniformUpdate<TComp, TUniform, TArg1, TArg2, TArg3, TArg4>(int capacity) : ComponentStorage<TComp>(capacity)
        where TComp : IEntityUniformComponent<TUniform, TArg1, TArg2, TArg3, TArg4>
    {
        ...
        ref TArg4 arg4 = ref b.GetComponentDataReference<TArg4>();
            ...
            for (int i = b.EntityCount - 1; i >= 0; i--)
            {
                ...
                comp.Update(entity, uniform, ref arg1, ref arg2, ref arg3, ref arg4);
