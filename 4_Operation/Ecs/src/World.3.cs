...
//it just so happens Archetype and Create both end with "e"
    partial class World
    {
        ...
        {
            var archetypes = Archetype<T1, T2, T3>.CreateNewOrGetExistingArchetypes(this);
            ...
            ref T1 ref1 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T1>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3>.OfComponent<T1>.Index))[eloc.Index]; ref1 = comp1;
        ref T2 ref2 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T2>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3>.OfComponent<T2>.Index))[eloc.Index]; ref2 = comp2;
        ref T3 ref3 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T3>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3>.OfComponent<T3>.Index))[eloc.Index]; ref3 = comp3;
        ...
        public ChunkTuple<T1, T2, T3> CreateMany<T1, T2, T3>(int count)
        {
            ...
            var chunks = new ChunkTuple<T1, T2, T3>()
            {
