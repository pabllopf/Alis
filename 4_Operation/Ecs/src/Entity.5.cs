...
namespace Alis.Core.Ecs;
    partial struct Entity
    {
        ...
        private static void InvokeComponentWorldEvents<T1, T2, T3, T4, T5>(ref Event<ComponentID> @event, Entity entity)
        {
        ...
        private static void InvokePerEntityEvents<T1, T2, T3, T4, T5>(Entity entity, bool hasGenericEvent, ref ComponentEvent events, ref T1 component1, ref T2 component2, ref T3 component3, ref T4 component4, ref T5 component5)
        {
        ...
        private static void InvokeTagWorldEvents<T1, T2, T3, T4, T5>(ref TagEvent @event, Entity entity)
        {
        ...
        private static void InvokePerEntityTagEvents<T1, T2, T3, T4, T5>(Entity entity, ref TagEvent events)
        {
        ...
        private struct NeighborCache<T1, T2, T3, T4, T5> : IArchetypeGraphEdge
        {
            public void ModifyTags(ref ImmutableArray<TagID> tags, bool add)
            {
                if (add)
                {
                    tags = MemoryHelpers.Concat(tags, [Core.Tag<T1>.ID, Core.Tag<T2>.ID, Core.Tag<T3>.ID, Core.Tag<T4>.ID, Core.Tag<T5>.ID]);
                }
                else
                {
                    tags = MemoryHelpers.Remove(tags, [Core.Tag<T1>.ID, Core.Tag<T2>.ID, Core.Tag<T3>.ID, Core.Tag<T4>.ID, Core.Tag<T5>.ID]);
                }
            }
