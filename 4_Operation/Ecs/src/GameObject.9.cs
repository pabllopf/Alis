...
namespace Alis.Core.Ecs
{
    ...
    partial struct GameObject
    {
        ...
        public void Add<T1, T2, T3, T4, T5, T6, T7, T8, T9>(in T1 c1, in T2 c2, in T3 c3, in T4 c4, in T5 c5, in T6 c6,
            in T7 c7, in T8 c8, in T9 c9)
        {
        ...
        private static void InvokeComponentWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref Event<ComponentId> @event,
        ...
        private static void InvokePerEntityEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(GameObject gameObject, bool hasGenericEvent,
            ref ComponentEvent events, ref T1 component1, ref T2 component2, ref T3 component3, ref T4 component4,
            ref T5 component5, ref T6 component6, ref T7 component7, ref T8 component8, ref T9 component9)
        {
        ...
        /// <param name="@event">The event</param>
        /// <param name="gameObject">The gameObject</param>
        private static void InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref TagEvent @event, GameObject gameObject)
        {
        ...
        /// <param name="gameObject">The gameObject</param>
        /// <param name="events">The events</param>
        private static void InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(GameObject gameObject, ref TagEvent events)
        {
        ...
        ///     The neighbor cache
        /// </summary>
        public struct NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9> : IArchetypeGraphEdge
        {
            /// <summary>
            ...
            public void ModifyTags(ref FastImmutableArray<TagId> tags, bool add)
            {
                if (add)
                    ...
                    [
                        ...
                        Core.Tag<T6>.Id, Core.Tag<T7>.Id, Core.Tag<T8>.Id, Core.Tag<T9>.Id
                    ]);
                else
            ...
            public void ModifyComponents(ref FastImmutableArray<ComponentId> components, bool add)
            {
                if (add)
                    ...
                    [
                        ...
                        Component<T6>.Id, Component<T7>.Id, Component<T8>.Id, Component<T9>.Id
                    ]);
                else
