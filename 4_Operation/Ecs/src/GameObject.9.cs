...
namespace Alis.Core.Ecs
{
    ...
    partial struct GameObject
    {
        ...
        /// <param name="@event">The event</param>
        /// <param name="gameObject">The gameObject</param>
        private static void InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref Event<TagId> @event, GameObject gameObject)
        {
        ...
        /// <param name="gameObject">The gameObject</param>
        /// <param name="events">The events</param>
        private static void InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(GameObject gameObject, ref Event<TagId> events)
        {
        ...
        public struct NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9> : IArchetypeGraphEdge
        {
            ...
            public void ModifyTags(ref FastImmutableArray<TagId> tags, bool add)
            {
                if (add)
                    ...
                    [
                        Kernel.Tag<T1>.Id, Kernel.Tag<T2>.Id, Kernel.Tag<T3>.Id, Kernel.Tag<T4>.Id, Kernel.Tag<T5>.Id, Kernel.Tag<T6>.Id, Kernel.Tag<T7>.Id, Kernel.Tag<T8>.Id, Kernel.Tag<T9>.Id
                    ]);
                else
