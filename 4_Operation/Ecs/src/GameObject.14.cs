...
namespace Alis.Core.Ecs
{
    ...
    partial struct GameObject
    {
        ...
        public void Add<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(in T1 c1, in T2 c2, in T3 c3, in T4 c4,
            in T5 c5, in T6 c6, in T7 c7, in T8 c8, in T9 c9, in T10 c10, in T11 c11, in T12 c12, in T13 c13, in T14 c14)
        {
            ...
            Archetype to =
                TraverseThroughCacheOrCreate<ComponentId,
                    NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>>(
                    world,
                    ref NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>.Add.Lookup,
                    ref thisLookup,
                    true);
                    ...
                    GameObjectFlags.AddComp | GameObjectFlags.AddGenericComp))
            {
                if (world.ComponentAddedEvent.HasListeners)
                    InvokeComponentWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(
        ...
        public void Remove<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>()
        {
            ref GameObjectLocation thisLookup = ref AssertIsAlive(out Scene world);
            ...
            Archetype to =
                TraverseThroughCacheOrCreate<ComponentId,
                    NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>>(
                    world,
                    ref NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>.Remove.Lookup,
                    ref thisLookup,
                    false);

            Span<ComponentHandle> runners = stackalloc ComponentHandle[14];
        ...
        /// </summary>
        /// <inheritdoc cref="Add{T}(in T)" />
        public void Tag<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>()
        {
            ref GameObjectLocation thisLookup = ref AssertIsAlive(out Scene world);
            ...
            Archetype to =
                TraverseThroughCacheOrCreate<TagId,
                    NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>>(
                    world,
                    ref NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>.Tag.Lookup,
                    ref thisLookup,
                    true);
            ...
            if (GameObjectLocation.HasEventFlag(flags, GameObjectFlags.Tagged))
            {
                if (world.Tagged.HasListeners)
                    InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(ref world.Tagged,
                        this);
                ...
                EventRecord events = world.EventLookup[EntityIdOnly];
                    ...
                    ref EventRecord events =
                        ref System.Runtime.InteropServices.CollectionsMarshal.GetValueRefOrNullRef(world.EventLookup, EntityIdOnly);
#endif
                    InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(this,
                        ref events.Tag);
                }
            }
        }
        ...
        /// </summary>
        /// <inheritdoc cref="Add{T}(in T)" />
        public void Detach<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>()
        {
            ref GameObjectLocation thisLookup = ref AssertIsAlive(out Scene world);
            ...
            Archetype to =
                TraverseThroughCacheOrCreate<TagId,
                    NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>>(
                    world,
                    ref NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>.Detach.Lookup,
                    ref thisLookup,
                    false);
            ...
            if (GameObjectLocation.HasEventFlag(flags, GameObjectFlags.Detach))
            {
                if (world.Detached.HasListeners)
                    InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(ref world.Detached,
                        this);
        ...
        private static void InvokeComponentWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(
        ...
        private static void InvokePerEntityEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(
            ...
            ref T13 component13, ref T14 component14)
        {
        ...
        /// <param name="@event">The event</param>
        /// <param name="gameObject">The gameObject</param>
        private static void InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(
        ...
        /// <param name="gameObject">The gameObject</param>
        /// <param name="events">The events</param>
        private static void InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(
        ...
        ///     The neighbor cache
        /// </summary>
        public struct NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> : IArchetypeGraphEdge
        {
            /// <summary>
            ...
            public void ModifyTags(ref FastImmutableArray<TagId> tags, bool add)
            {
                if (add)
                    ...
                    [
                        ...
                        Core.Tag<T11>.Id, Core.Tag<T12>.Id, Core.Tag<T13>.Id, Core.Tag<T14>.Id
                    ]);
                else
            ...
            public void ModifyComponents(ref FastImmutableArray<ComponentId> components, bool add)
            {
                if (add)
                    ...
                    [
                        ...
                        Component<T11>.Id, Component<T12>.Id, Component<T13>.Id, Component<T14>.Id
                    ]);
                else
