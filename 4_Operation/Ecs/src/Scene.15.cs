...
namespace Alis.Core.Ecs
{
    ...
    partial class Scene
    {
        ...
        public GameObject Create<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(in T1 comp1, in T2 comp2,
            in T3 comp3, in T4 comp4, in T5 comp5, in T6 comp6, in T7 comp7, in T8 comp8, in T9 comp9, in T10 comp10,
            in T11 comp11, in T12 comp12, in T13 comp13, in T14 comp14, in T15 comp15)
        {
            WorldArchetypeTableItem archetypes = Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>
            ...
            ref T1 ref1 = ref  Unsafe.As<ComponentStorage<T1>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T1>.Index))[eloc.Index];
            ref1 = comp1;
            ref T2 ref2 = ref  Unsafe.As<ComponentStorage<T2>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T2>.Index))[eloc.Index];
            ref2 = comp2;
            ref T3 ref3 = ref  Unsafe.As<ComponentStorage<T3>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T3>.Index))[eloc.Index];
            ref3 = comp3;
            ref T4 ref4 = ref  Unsafe.As<ComponentStorage<T4>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T4>.Index))[eloc.Index];
            ref4 = comp4;
            ref T5 ref5 = ref  Unsafe.As<ComponentStorage<T5>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T5>.Index))[eloc.Index];
            ref5 = comp5;
            ref T6 ref6 = ref  Unsafe.As<ComponentStorage<T6>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T6>.Index))[eloc.Index];
            ref6 = comp6;
            ref T7 ref7 = ref  Unsafe.As<ComponentStorage<T7>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T7>.Index))[eloc.Index];
            ref7 = comp7;
            ref T8 ref8 = ref  Unsafe.As<ComponentStorage<T8>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T8>.Index))[eloc.Index];
            ref8 = comp8;
            ref T9 ref9 = ref  Unsafe.As<ComponentStorage<T9>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T9>.Index))[eloc.Index];
            ref9 = comp9;
            ref T10 ref10 = ref  Unsafe.As<ComponentStorage<T10>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T10>.Index))[eloc.Index];
            ref10 = comp10;
            ref T11 ref11 = ref  Unsafe.As<ComponentStorage<T11>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T11>.Index))[eloc.Index];
            ref11 = comp11;
            ref T12 ref12 = ref  Unsafe.As<ComponentStorage<T12>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T12>.Index))[eloc.Index];
            ref12 = comp12;
            ref T13 ref13 = ref  Unsafe.As<ComponentStorage<T13>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T13>.Index))[eloc.Index];
            ref13 = comp13;
            ref T14 ref14 = ref  Unsafe.As<ComponentStorage<T14>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T14>.Index))[eloc.Index];
            ref14 = comp14;
            ref T15 ref15 = ref  Unsafe.As<ComponentStorage<T15>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.OfComponent<T15>.Index))[eloc.Index];
            ref15 = comp15;
        ...
        public ChunkTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> CreateMany<T1, T2, T3, T4, T5,
            T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(
            int count)
        {
            if ((uint)count == 0) throw new ArgumentOutOfRangeException(nameof(count));

            WorldArchetypeTableItem archetype = Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>
                .CreateNewOrGetExistingArchetypes(this);
