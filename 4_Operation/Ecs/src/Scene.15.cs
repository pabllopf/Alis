...
namespace Alis.Core.Ecs
{
    ...
    partial class Scene
    {
        ...
        [SkipLocalsInit]
        public GameObject Create<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(
            in T1 comp1,
            in T2 comp2,
            in T3 comp3,
            in T4 comp4,
            ...
            int count)
        {
            ...
            Archetype archetype = Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.CreateNewOrGetExistingArchetype(this);
