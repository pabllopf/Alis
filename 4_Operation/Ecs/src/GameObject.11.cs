...
namespace Alis.Core.Ecs
{
    partial struct GameObject
    {
        ...
        private static void InvokeComponentWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(ref Event<ComponentID> @event, Alis.Core.Ecs.GameObject gameObject)
        {
        ...
        private struct NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IArchetypeGraphEdge
        {
            public void ModifyTags(ref FastImmutableArray<TagId> tags, bool add)
            {
                if (add)
                {
                    tags = MemoryHelpers.Concat(tags, [Ecs.Tag<T1>.ID, Ecs.Tag<T2>.ID, Ecs.Tag<T3>.ID, Ecs.Tag<T4>.ID, Ecs.Tag<T5>.ID, Ecs.Tag<T6>.ID, Ecs.Tag<T7>.ID, Ecs.Tag<T8>.ID, Ecs.Tag<T9>.ID, Ecs.Tag<T10>.ID, Ecs.Tag<T11>.ID]);
                }
                else
                {
                    tags = MemoryHelpers.Remove(tags, [Ecs.Tag<T1>.ID, Ecs.Tag<T2>.ID, Ecs.Tag<T3>.ID, Ecs.Tag<T4>.ID, Ecs.Tag<T5>.ID, Ecs.Tag<T6>.ID, Ecs.Tag<T7>.ID, Ecs.Tag<T8>.ID, Ecs.Tag<T9>.ID, Ecs.Tag<T10>.ID, Ecs.Tag<T11>.ID]);
                }
            }
