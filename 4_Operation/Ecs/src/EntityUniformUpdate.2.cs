...
namespace Alis.Core.Ecs;
    internal class EntityUniformUpdate<TComp, TUniform, TArg1, TArg2>(int capacity) : ComponentStorage<TComp>(capacity)
        where TComp : IEntityUniformComponent<TUniform, TArg1, TArg2>
    {
        ...
        ref TArg2 arg2 = ref b.GetComponentDataReference<TArg2>();
            ...
            for (int i = b.EntityCount - 1; i >= 0; i--)
            {
                ...
                comp.Update(entity, uniform, ref arg1, ref arg2);
