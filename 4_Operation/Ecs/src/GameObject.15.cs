...
namespace Alis.Core.Ecs
{
    ...
    partial struct GameObject
    {
            ...
            in T14 c14, in T15 c15)
        {
            ...
            c12Ref = c12;
            ref T13 c13Ref =
                ref  Unsafe.As<ComponentStorage<T13>>(buff.XxUnsafeSpanIndex(12))[nextLocation.Index];
            c13Ref = c13;
            ref T14 c14Ref =
                ref  Unsafe.As<ComponentStorage<T14>>(buff.XxUnsafeSpanIndex(13))[nextLocation.Index];
            c14Ref = c14;
            ref T15 c15Ref =
                ref  Unsafe.As<ComponentStorage<T15>>(buff.XxUnsafeSpanIndex(14))[nextLocation.Index];
            c15Ref = c15;
