...
namespace Alis.Core.Ecs
{
    ...
    partial class Scene
    {
        ...
        [SkipLocalsInit]
        public GameObject Create<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(
            in T1 comp1,
            in T2 comp2,
            in T3 comp3,
            in T4 comp4,
            ...
            in T14 comp14)
        {
            ...
            initer13?.Invoke(gameObject, ref local14);

            ComponentDelegates<T14>.InitDelegate initer14 = Component<T14>.Initer;
            initer14?.Invoke(gameObject, ref local15);
    ...
    public ChunkTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> CreateMany<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(int count)
    {
        ...
        var archetype = Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>.CreateNewOrGetExistingArchetype(this);
        ...
        return new ChunkTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
        {
            ...
            Span13 = archetype.GetComponentSpan<T13>().Slice(entityCount, count),
            Span14 = archetype.GetComponentSpan<T14>().Slice(entityCount, count)
        };
    }
    }
}