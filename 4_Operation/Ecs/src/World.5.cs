...
//it just so happens Archetype and Create both end with "e"
    partial class World
    {
        ...
        [SkipLocalsInit]
        public Entity Create<T1, T2, T3, T4, T5>(in T1 comp1, in T2 comp2, in T3 comp3, in T4 comp4, in T5 comp5)
        {
            var archetypes = Archetype<T1, T2, T3, T4, T5>.CreateNewOrGetExistingArchetypes(this);
            ...
            ref T1 ref1 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T1>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5>.OfComponent<T1>.Index))[eloc.Index]; ref1 = comp1;
        ref T2 ref2 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T2>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5>.OfComponent<T2>.Index))[eloc.Index]; ref2 = comp2;
        ref T3 ref3 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T3>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5>.OfComponent<T3>.Index))[eloc.Index]; ref3 = comp3;
        ref T4 ref4 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T4>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5>.OfComponent<T4>.Index))[eloc.Index]; ref4 = comp4;
        ref T5 ref5 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T5>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5>.OfComponent<T5>.Index))[eloc.Index]; ref5 = comp5;
        ...
        public ChunkTuple<T1, T2, T3, T4, T5> CreateMany<T1, T2, T3, T4, T5>(int count)
        {
            ...
            var chunks = new ChunkTuple<T1, T2, T3, T4, T5>()
            {
