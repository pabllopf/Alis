...
namespace Alis.Core.Ecs;
    partial struct Entity
    {
        ...
        [SkipLocalsInit]
        public void Add<T1, T2, T3, T4, T5, T6, T7, T8>(in T1 c1, in T2 c2, in T3 c3, in T4 c4, in T5 c5, in T6 c6, in T7 c7, in T8 c8)
        {
        ...
        private static void InvokeComponentWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8>(ref Event<ComponentID> @event, Entity entity)
        {
        ...
        private static void InvokePerEntityEvents<T1, T2, T3, T4, T5, T6, T7, T8>(Entity entity, bool hasGenericEvent, ref ComponentEvent events, ref T1 component1, ref T2 component2, ref T3 component3, ref T4 component4, ref T5 component5, ref T6 component6, ref T7 component7, ref T8 component8)
        {
        ...
        private static void InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8>(ref TagEvent @event, Entity entity)
        {
        ...
        private static void InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8>(Entity entity, ref TagEvent events)
        {
        ...
        private struct NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8> : IArchetypeGraphEdge
        {
            public void ModifyTags(ref ImmutableArray<TagID> tags, bool add)
            {
                if (add)
                {
                    tags = MemoryHelpers.Concat(tags, [Core.Tag<T1>.ID, Core.Tag<T2>.ID, Core.Tag<T3>.ID, Core.Tag<T4>.ID, Core.Tag<T5>.ID, Core.Tag<T6>.ID, Core.Tag<T7>.ID, Core.Tag<T8>.ID]);
                }
                else
                {
                    tags = MemoryHelpers.Remove(tags, [Core.Tag<T1>.ID, Core.Tag<T2>.ID, Core.Tag<T3>.ID, Core.Tag<T4>.ID, Core.Tag<T5>.ID, Core.Tag<T6>.ID, Core.Tag<T7>.ID, Core.Tag<T8>.ID]);
                }
            }
            ...
            public void ModifyComponents(ref ImmutableArray<ComponentID> components, bool add)
            {
                if (add)
                {
                    components = MemoryHelpers.Concat(components, [Component<T1>.ID, Component<T2>.ID, Component<T3>.ID, Component<T4>.ID, Component<T5>.ID, Component<T6>.ID, Component<T7>.ID, Component<T8>.ID]);
                }
                else
                {
                    components = MemoryHelpers.Remove(components, [Component<T1>.ID, Component<T2>.ID, Component<T3>.ID, Component<T4>.ID, Component<T5>.ID, Component<T6>.ID, Component<T7>.ID, Component<T8>.ID]);
                }
            }
