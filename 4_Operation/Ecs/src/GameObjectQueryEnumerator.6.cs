...
namespace Alis.Core.Ecs
{
    ...
    public ref struct GameObjectQueryEnumerator<T1, T2, T3, T4, T5, T6>
    {
        ...
        /// </summary>
        public GameObjectRefTuple<T1, T2, T3, T4, T5, T6> Current => new()
        {
        ...
        public struct QueryEnumerable(Query query)
        {
            ...
            /// </summary>
            public GameObjectQueryEnumerator<T1, T2, T3, T4, T5, T6> GetEnumerator()
            {
                return new GameObjectQueryEnumerator<T1, T2, T3, T4, T5, T6>(query);
            }
        }
    }
}