...
namespace Alis.Core.Ecs;
    partial struct Entity
    {
        ...
        private static void InvokeComponentWorldEvents<T1, T2>(ref Event<ComponentID> @event, Entity entity)
        {
        ...
        private static void InvokePerEntityEvents<T1, T2>(Entity entity, bool hasGenericEvent, ref ComponentEvent events, ref T1 component1, ref T2 component2)
        {
        ...
        private static void InvokeTagWorldEvents<T1, T2>(ref TagEvent @event, Entity entity)
        {
        ...
        private static void InvokePerEntityTagEvents<T1, T2>(Entity entity, ref TagEvent events)
        {
