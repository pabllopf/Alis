...
namespace Alis.Core.Ecs;
    internal class EntityUniformUpdate<TComp, TUniform, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7>(int capacity) : ComponentStorage<TComp>(capacity)
        where TComp : IEntityUniformComponent<TUniform, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7>
    {
        ...
        ref TArg7 arg7 = ref b.GetComponentDataReference<TArg7>();
            ...
            for (int i = b.EntityCount - 1; i >= 0; i--)
            {
                ...
                comp.Update(entity, uniform, ref arg1, ref arg2, ref arg3, ref arg4, ref arg5, ref arg6, ref arg7);
