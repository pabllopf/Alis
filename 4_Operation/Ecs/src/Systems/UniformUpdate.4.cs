...
namespace Alis.Core.Ecs.Systems;
    internal class UniformUpdate<TComp, TUniform, TArg1, TArg2, TArg3, TArg4>(int capacity) : ComponentStorage<TComp>(capacity)
        where TComp : IUniformComponent<TUniform, TArg1, TArg2, TArg3, TArg4>
    {
        ...
        ref TArg4 arg4 = ref b.GetComponentDataReference<TArg4>();
            ...
            {
                comp.Update(uniform, ref arg1, ref arg2, ref arg3, ref arg4);
