...
namespace Alis.Core.Ecs.Systems
{
    ...
    public ref struct ChunkTuple<T1>
    {
        /// <summary>
    ...
    public ref struct ChunkTuple<T1, T2, T3, T4, T5, T6, T7>
    {
        ...
        /// </summary>
        public void Deconstruct(out Span<T1> comp1, out Span<T2> comp2, out Span<T3> comp3, out Span<T4> comp4,
            out Span<T5> comp5, out Span<T6> comp6, out Span<T7> comp7)
        {
            comp1 = Span1;
            comp2 = Span2;
            comp3 = Span3;
    ...
    public ref struct ChunkTuple<T1, T2, T3, T4, T5, T6, T7, T8>
    {
        ...
        /// </summary>
        public void Deconstruct(out Span<T1> comp1, out Span<T2> comp2, out Span<T3> comp3, out Span<T4> comp4,
            out Span<T5> comp5, out Span<T6> comp6, out Span<T7> comp7, out Span<T8> comp8)
        {
            comp1 = Span1;
            comp2 = Span2;
            comp3 = Span3;
