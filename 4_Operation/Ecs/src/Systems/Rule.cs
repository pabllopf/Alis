...
namespace Alis.Core.Ecs.Systems
{
    ...
    public struct Rule : IEquatable<Rule>
    {
        ...
        public static Rule Delegate(Func<GameObjectType, bool> rule) => new Rule
        {
        ...
        public static Rule HasComponent(ComponentId compId) => new Rule
        {
        ...
        public static Rule NotComponent(ComponentId compId) => new Rule
        {
