...
namespace Alis.Core.Ecs.Systems;
    internal class UniformUpdate<TComp, TUniform, TArg1, TArg2, TArg3>(int capacity) : ComponentStorage<TComp>(capacity)
        where TComp : IUniformComponent<TUniform, TArg1, TArg2, TArg3>
    {
        ...
        ref TArg3 arg3 = ref b.GetComponentDataReference<TArg3>();
            ...
            {
                comp.Update(uniform, ref arg1, ref arg2, ref arg3);
