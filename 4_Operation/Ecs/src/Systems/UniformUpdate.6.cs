...
namespace Alis.Core.Ecs.Systems;
    internal class UniformUpdate<TComp, TUniform, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>(int capacity) : ComponentStorage<TComp>(capacity)
        where TComp : IUniformComponent<TUniform, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>
    {
        ...
        ref TArg6 arg6 = ref b.GetComponentDataReference<TArg6>();
            ...
            {
                comp.Update(uniform, ref arg1, ref arg2, ref arg3, ref arg4, ref arg5, ref arg6);
