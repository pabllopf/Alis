...
namespace Alis.Core.Ecs.Systems;
    internal class UniformUpdate<TComp, TUniform, TArg1, TArg2, TArg3, TArg4, TArg5>(int capacity) : ComponentStorage<TComp>(capacity)
        where TComp : IUniformComponent<TUniform, TArg1, TArg2, TArg3, TArg4, TArg5>
    {
        ...
        ref TArg5 arg5 = ref b.GetComponentDataReference<TArg5>();
            ...
            {
                comp.Update(uniform, ref arg1, ref arg2, ref arg3, ref arg4, ref arg5);
