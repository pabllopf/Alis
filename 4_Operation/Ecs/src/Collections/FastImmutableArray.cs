...
namespace Alis.Core.Ecs.Collections
{
    ...
    public partial struct FastImmutableArray<T> : IEnumerable<T>, IEquatable<FastImmutableArray<T>>, IFastImmutableArray
    {
        ...
        internal FastImmutableArray(T[] items)
        {
            this.array = items;
        }
        ...
        public static bool operator ==(FastImmutableArray<T> left, FastImmutableArray<T> right)
        {
        ...
        /// </summary>
        Array IFastImmutableArray.Array
        {
        ...
        {
            return obj is IFastImmutableArray other && this.array == other.Array;
        }
        ...
        public bool Equals(FastImmutableArray<T> other)
        {
        ...
        /// </remarks>
        public static FastImmutableArray<
#nullable disable
            T
#nullable restore
            > CastUp<TDerived>(FastImmutableArray<TDerived> items)
...
#nullable restore
        ...
        {
            return new FastImmutableArray<TOther>((this.array as TOther[]));
        }
        ...
        private sealed class EnumeratorObject : IEnumerator<T>
        {
            ...
            private static readonly IEnumerator<T> s_EmptyEnumerator =
                new EnumeratorObject(FastImmutableArray<T>.Empty.array!);
