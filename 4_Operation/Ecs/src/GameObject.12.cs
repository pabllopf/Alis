...
namespace Alis.Core.Ecs
{
    ...
    partial struct GameObject
    {
        ...
        public void Add<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(in T1 c1, in T2 c2, in T3 c3, in T4 c4, in T5 c5,
            in T6 c6, in T7 c7, in T8 c8, in T9 c9, in T10 c10, in T11 c11, in T12 c12)
        {
            ...
            Archetype to =
                TraverseThroughCacheOrCreate<ComponentId, NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>(
                    world,
                    ...
                    GameObjectFlags.AddComp | GameObjectFlags.AddGenericComp))
            {
                if (world.ComponentAddedEvent.HasListeners)
                    InvokeComponentWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(
        ...
        /// </summary>
        /// <inheritdoc cref="Add{T}(in T)" />
        public void Tag<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>()
        {
            ref GameObjectLocation thisLookup = ref AssertIsAlive(out Scene world);
            ...
            Archetype to =
                TraverseThroughCacheOrCreate<TagId, NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>(
                    world,
                    ref NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.Tag.Lookup,
                    ref thisLookup,
                    true);
            ...
            if (GameObjectLocation.HasEventFlag(flags, GameObjectFlags.Tagged))
            {
                if (world.Tagged.HasListeners)
                    InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(ref world.Tagged, this);
                ...
                ref EventRecord events =
                    ref System.Runtime.InteropServices.CollectionsMarshal.GetValueRefOrNullRef(world.EventLookup, EntityIdOnly);
#endif
                    InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(this, ref events.Tag);
                }
            }
        }
        ...
        /// </summary>
        /// <inheritdoc cref="Add{T}(in T)" />
        public void Detach<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>()
        {
            ref GameObjectLocation thisLookup = ref AssertIsAlive(out Scene world);
            ...
            Archetype to =
                TraverseThroughCacheOrCreate<TagId, NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>(
                    world,
                    ref NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.Detach.Lookup,
                    ref thisLookup,
                    false);
            ...
            if (GameObjectLocation.HasEventFlag(flags, GameObjectFlags.Detach))
            {
                if (world.Detached.HasListeners)
                    InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(ref world.Detached, this);
                ...
                ref EventRecord events =
                    ref System.Runtime.InteropServices.CollectionsMarshal.GetValueRefOrNullRef(world.EventLookup, EntityIdOnly);
#endif
                    InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(this, ref events.Detach);
                }
            }
        }
        ...
        private static void InvokeComponentWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(
        ...
        private static void InvokePerEntityEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(GameObject gameObject,
            ...
            ref T9 component9, ref T10 component10, ref T11 component11, ref T12 component12)
        {
        ...
        /// <param name="@event">The event</param>
        /// <param name="gameObject">The gameObject</param>
        private static void InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(ref TagEvent @event,
        ...
        /// <param name="gameObject">The gameObject</param>
        /// <param name="events">The events</param>
        private static void InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(GameObject gameObject,
            ref TagEvent events)
        {
        ...
        ///     The neighbor cache
        /// </summary>
        public struct NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> : IArchetypeGraphEdge
        {
            /// <summary>
            ...
            public void ModifyTags(ref FastImmutableArray<TagId> tags, bool add)
            {
                if (add)
                    ...
                    [
                        ...
                        Core.Tag<T11>.Id, Core.Tag<T12>.Id
                    ]);
                else
            ...
            public void ModifyComponents(ref FastImmutableArray<ComponentId> components, bool add)
            {
                if (add)
                    ...
                    [
                        ...
                        Component<T11>.Id, Component<T12>.Id
                    ]);
                else
