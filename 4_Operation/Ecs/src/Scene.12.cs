    ...
    partial class Scene
    {
            ...
            in T12 comp12)
        {
            ...
            ref T1 ref1 = ref  Unsafe.As<ComponentStorage<T1>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T1>.Index))[eloc.Index];
            ref1 = comp1;
            ref T2 ref2 = ref  Unsafe.As<ComponentStorage<T2>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T2>.Index))[eloc.Index];
            ref2 = comp2;
            ref T3 ref3 = ref  Unsafe.As<ComponentStorage<T3>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T3>.Index))[eloc.Index];
            ref3 = comp3;
            ref T4 ref4 = ref  Unsafe.As<ComponentStorage<T4>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T4>.Index))[eloc.Index];
            ref4 = comp4;
            ref T5 ref5 = ref  Unsafe.As<ComponentStorage<T5>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T5>.Index))[eloc.Index];
            ref5 = comp5;
            ref T6 ref6 = ref  Unsafe.As<ComponentStorage<T6>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T6>.Index))[eloc.Index];
            ref6 = comp6;
            ref T7 ref7 = ref  Unsafe.As<ComponentStorage<T7>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T7>.Index))[eloc.Index];
            ref7 = comp7;
            ref T8 ref8 = ref  Unsafe.As<ComponentStorage<T8>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T8>.Index))[eloc.Index];
            ref8 = comp8;
            ref T9 ref9 = ref  Unsafe.As<ComponentStorage<T9>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T9>.Index))[eloc.Index];
            ref9 = comp9;
            ref T10 ref10 = ref  Unsafe.As<ComponentStorage<T10>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T10>.Index))[eloc.Index];
            ref10 = comp10;
            ref T11 ref11 = ref  Unsafe.As<ComponentStorage<T11>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T11>.Index))[eloc.Index];
            ref11 = comp11;
            ref T12 ref12 = ref  Unsafe.As<ComponentStorage<T12>>(
                Unsafe.Add(ref components[0], Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T12>.Index))[eloc.Index];
            ref12 = comp12;
