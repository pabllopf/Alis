...
namespace Alis.Core.Ecs
{
    ...
    partial class Scene
    {
        ...
        public GameObject Create<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(in T1 comp1, in T2 comp2, in T3 comp3,
            in T4 comp4, in T5 comp5, in T6 comp6, in T7 comp7, in T8 comp8, in T9 comp9, in T10 comp10, in T11 comp11,
            in T12 comp12)
        {
            WorldArchetypeTableItem archetypes =
                Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.CreateNewOrGetExistingArchetypes(this);
            ...
            ref T1 ref1 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T1>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T1>
                    .Index))[eloc.Index];
            ref1 = comp1;
            ref T2 ref2 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T2>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T2>
                    .Index))[eloc.Index];
            ref2 = comp2;
            ref T3 ref3 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T3>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T3>
                    .Index))[eloc.Index];
            ref3 = comp3;
            ref T4 ref4 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T4>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T4>
                    .Index))[eloc.Index];
            ref4 = comp4;
            ref T5 ref5 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T5>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T5>
                    .Index))[eloc.Index];
            ref5 = comp5;
            ref T6 ref6 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T6>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T6>
                    .Index))[eloc.Index];
            ref6 = comp6;
            ref T7 ref7 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T7>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T7>
                    .Index))[eloc.Index];
            ref7 = comp7;
            ref T8 ref8 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T8>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T8>
                    .Index))[eloc.Index];
            ref8 = comp8;
            ref T9 ref9 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T9>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T9>
                    .Index))[eloc.Index];
            ref9 = comp9;
            ref T10 ref10 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T10>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T10>
                    .Index))[eloc.Index];
            ref10 = comp10;
            ref T11 ref11 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T11>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T11>
                    .Index))[eloc.Index];
            ref11 = comp11;
            ref T12 ref12 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T12>>(
                components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.OfComponent<T12>
                    .Index))[eloc.Index];
            ref12 = comp12;
        ...
        /// <returns>A chunk tuple of t 1 and t 2 and t 3 and t 4 and t 5 and t 6 and t 7 and t 8 and t 9 and t 10 and t 11 and t 12</returns>
        public ChunkTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> CreateMany<T1, T2, T3, T4, T5, T6, T7, T8, T9,
            T10, T11, T12>(int count)
        {
