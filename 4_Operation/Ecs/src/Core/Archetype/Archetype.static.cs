...
namespace Alis.Core.Ecs.Core.Archetype
{
    ...
    partial class Archetype
    {
        ...
        /// <param name="scene">The scene</param>
        /// <returns>The archetype</returns>
        internal static Archetype CreateOrGetExistingArchetype(ArchetypeID id, Scene scene)
        {
        ...
        internal static ArchetypeID GetArchetypeId(ReadOnlySpan<ComponentId> types, ReadOnlySpan<TagId> tagTypes,
