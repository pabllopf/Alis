...
namespace Alis.Core.Ecs.Core.Archetype;
    ...
    {
        public static readonly ImmutableArray<ComponentID> ArchetypeComponentIDs = new ComponentID[] { Component<T1>.ID, Component<T2>.ID, Component<T3>.ID, Component<T4>.ID, Component<T5>.ID, Component<T6>.ID, Component<T7>.ID, Component<T8>.ID, Component<T9>.ID, Component<T10>.ID, Component<T11>.ID, Component<T12>.ID, Component<T13>.ID, Component<T14>.ID, Component<T15>.ID, Component<T16>.ID }.ToImmutableArray();
        ...
        internal static World.WorldArchetypeTableItem CreateNewOrGetExistingArchetypes(World world)
        {
            ...
            i = map.UnsafeArrayIndex(Component<T14>.ID.RawIndex) & GlobalWorldTables.IndexBits; runners[i] = Component<T14>.CreateInstance(1); tmpStorages[i] = Component<T14>.CreateInstance(0);
            i = map.UnsafeArrayIndex(Component<T15>.ID.RawIndex) & GlobalWorldTables.IndexBits; runners[i] = Component<T15>.CreateInstance(1); tmpStorages[i] = Component<T15>.CreateInstance(0);
            i = map.UnsafeArrayIndex(Component<T16>.ID.RawIndex) & GlobalWorldTables.IndexBits; runners[i] = Component<T16>.CreateInstance(1); tmpStorages[i] = Component<T16>.CreateInstance(0);
