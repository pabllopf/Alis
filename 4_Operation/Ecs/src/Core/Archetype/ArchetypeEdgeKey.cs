...
namespace Alis.Core.Ecs.Core.Archetype
{
    ...
    public struct ArchetypeEdgeKey : IEquatable<ArchetypeEdgeKey>
    {
        ...
        public static ArchetypeEdgeKey Component(ComponentId componentId, ArchetypeID from,
        ...
        /// <param name="archetypeEdgeType">The archetype edge type</param>
        /// <returns>The archetype edge key</returns>
        public static ArchetypeEdgeKey Tag(TagId tagId, ArchetypeID from, ArchetypeEdgeType archetypeEdgeType)
        {
            return new ArchetypeEdgeKey
            {
                TagID = tagId,
