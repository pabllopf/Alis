...
//it just so happens Archetype and Create both end with "e"
    partial class World
    {
        ...
        [SkipLocalsInit]
        public Entity Create<T1, T2, T3, T4, T5, T6, T7, T8>(in T1 comp1, in T2 comp2, in T3 comp3, in T4 comp4, in T5 comp5, in T6 comp6, in T7 comp7, in T8 comp8)
        {
            var archetypes = Archetype<T1, T2, T3, T4, T5, T6, T7, T8>.CreateNewOrGetExistingArchetypes(this);
            ...
            ref T1 ref1 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T1>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8>.OfComponent<T1>.Index))[eloc.Index]; ref1 = comp1;
        ref T2 ref2 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T2>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8>.OfComponent<T2>.Index))[eloc.Index]; ref2 = comp2;
        ref T3 ref3 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T3>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8>.OfComponent<T3>.Index))[eloc.Index]; ref3 = comp3;
        ref T4 ref4 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T4>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8>.OfComponent<T4>.Index))[eloc.Index]; ref4 = comp4;
        ref T5 ref5 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T5>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8>.OfComponent<T5>.Index))[eloc.Index]; ref5 = comp5;
        ref T6 ref6 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T6>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8>.OfComponent<T6>.Index))[eloc.Index]; ref6 = comp6;
        ref T7 ref7 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T7>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8>.OfComponent<T7>.Index))[eloc.Index]; ref7 = comp7;
        ref T8 ref8 = ref UnsafeExtensions.UnsafeCast<ComponentStorage<T8>>(components.UnsafeArrayIndex(Archetype<T1, T2, T3, T4, T5, T6, T7, T8>.OfComponent<T8>.Index))[eloc.Index]; ref8 = comp8;
        ...
        public ChunkTuple<T1, T2, T3, T4, T5, T6, T7, T8> CreateMany<T1, T2, T3, T4, T5, T6, T7, T8>(int count)
        {
            ...
            var chunks = new ChunkTuple<T1, T2, T3, T4, T5, T6, T7, T8>()
            {
