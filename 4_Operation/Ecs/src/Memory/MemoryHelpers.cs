    ...
    public static class MemoryHelpers
    {
            ...
            where T : ITypeID
        {
            ...
            for (int i = 0; i < sizeSpan; i++)
            {
                ...
                {
                    throw new InvalidOperationException($"This entity already has a component of type {t.Type.Name}");
                }
            ...
            where T : ITypeID
        {
            ...
            {
                throw new InvalidOperationException($"This entity already has a component of type {type.Type.Name}");
            }
            ...
            where T : ITypeID
        {
            ...
            if (index == -1)
            {
                throw new InvalidOperationException($"This entity does not have a component of type {type.Type.Name}");
            }
