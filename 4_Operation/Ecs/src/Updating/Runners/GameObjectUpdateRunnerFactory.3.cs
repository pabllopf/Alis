...
// 
//  --------------------------------------------------------------------------
//  File:GameObjectUpdateRunnerFactory.3.cs
// 
...
namespace Alis.Core.Ecs.Updating.Runners
{
        ...
        where TComp : IGameObjectComponent<TArg1, TArg2, TArg3>
    {
        ...
        ComponentStorageBase IComponentStorageBaseFactory.Create(int capacity) => new GameObjectUpdate<TComp, TArg1, TArg2, TArg3>(capacity);
        ...
        ComponentStorage<TComp> IComponentStorageBaseFactory<TComp>.CreateStronglyTyped(int capacity) => new GameObjectUpdate<TComp, TArg1, TArg2, TArg3>(capacity);
    }
}