...
// 
//  --------------------------------------------------------------------------
//  File:GameObjectUpdateRunnerFactory.2.cs
// 
...
namespace Alis.Core.Ecs.Updating.Runners
{
    ...
    public class GameObjectUpdateRunnerFactory<TComp, TArg1, TArg2> : IComponentStorageBaseFactory,
        ...
        where TComp : IGameObjectComponent<TArg1, TArg2>
    {
        ...
        ComponentStorageBase IComponentStorageBaseFactory.Create(int capacity) => new GameObjectUpdate<TComp, TArg1, TArg2>(capacity);
        ...
        ComponentStorage<TComp> IComponentStorageBaseFactory<TComp>.CreateStronglyTyped(int capacity) => new GameObjectUpdate<TComp, TArg1, TArg2>(capacity);
    }
}