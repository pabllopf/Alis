...
namespace Alis.Core.Ecs.Updating.Runners
{
    ...
    public class GameObjectUpdateRunnerFactory<TComp, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6> : IComponentStorageBaseFactory,
        IComponentStorageBaseFactory<TComp>
        where TComp : IGameObjectComponent<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>
    {
        /// <summary>
        ...
        {
            return new EntityUpdate<TComp, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>(capacity);
        }
