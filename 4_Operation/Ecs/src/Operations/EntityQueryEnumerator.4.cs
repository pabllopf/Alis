...
// 
//  --------------------------------------------------------------------------
//  File:EntityQueryEnumerator.4.cs
// 
...
{
    public ref struct EntityQueryEnumerator<T1, T2, T3, T4>
    {
        ...
        /// </summary>
        public EntityRefTuple<T1, T2, T3, T4> Current => new()
        {
        ...
        public struct QueryEnumerable(Query query)
        {
            ...
            /// </summary>
            public EntityQueryEnumerator<T1, T2, T3, T4> GetEnumerator() => new EntityQueryEnumerator<T1, T2, T3, T4>(query);
        }
    }
}