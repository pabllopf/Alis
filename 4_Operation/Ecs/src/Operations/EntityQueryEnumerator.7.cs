...
// 
//  --------------------------------------------------------------------------
//  File:EntityQueryEnumerator.7.cs
// 
...
{
    public ref struct EntityQueryEnumerator<T1, T2, T3, T4, T5, T6, T7>
    {
        ...
        /// </summary>
        public EntityRefTuple<T1, T2, T3, T4, T5, T6, T7> Current => new()
        {
        ...
        public struct QueryEnumerable(Query query)
        {
            ...
            /// </summary>
            public EntityQueryEnumerator<T1, T2, T3, T4, T5, T6, T7> GetEnumerator() => new EntityQueryEnumerator<T1, T2, T3, T4, T5, T6, T7>(query);
        }
    }
}