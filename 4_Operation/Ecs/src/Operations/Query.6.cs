...
namespace Alis.Core.Ecs.Operations
{
    ...
    partial class Query
    {
        ...
        /// </summary>
        public QueryEnumerator<T1, T2, T3, T4, T5, T6>.QueryEnumerable Enumerate<T1, T2, T3, T4, T5, T6>() => new(this);
        ...
        /// </summary>
        public EntityQueryEnumerator<T1, T2, T3, T4, T5, T6>.QueryEnumerable EnumerateWithEntities<T1, T2, T3, T4, T5, T6>() => new(this);
