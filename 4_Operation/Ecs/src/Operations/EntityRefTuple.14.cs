...
namespace Alis.Core.Ecs.Operations
{
    public ref struct EntityRefTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
    {
        ...
        /// </summary>
        public void Deconstruct(out Entity entity, out Ref<T1> @ref1, out Ref<T2> @ref2, out Ref<T3> @ref3, out Ref<T4> @ref4, out Ref<T5> @ref5, out Ref<T6> @ref6, out Ref<T7> @ref7, out Ref<T8> @ref8, out Ref<T9> @ref9, out Ref<T10> @ref10, out Ref<T11> @ref11, out Ref<T12> @ref12, out Ref<T13> @ref13, out Ref<T14> @ref14)
        {
            entity = Entity;
            @ref1 = Item1;
            @ref2 = Item2;
