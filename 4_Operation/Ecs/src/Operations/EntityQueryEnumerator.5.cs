...
// 
//  --------------------------------------------------------------------------
//  File:EntityQueryEnumerator.5.cs
// 
...
{
    public ref struct EntityQueryEnumerator<T1, T2, T3, T4, T5>
    {
        ...
        /// </summary>
        public EntityRefTuple<T1, T2, T3, T4, T5> Current => new()
        {
        ...
        public struct QueryEnumerable(Query query)
        {
            ...
            /// </summary>
            public EntityQueryEnumerator<T1, T2, T3, T4, T5> GetEnumerator() => new EntityQueryEnumerator<T1, T2, T3, T4, T5>(query);
        }
    }
}