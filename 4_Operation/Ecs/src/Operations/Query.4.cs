...
namespace Alis.Core.Ecs.Operations
{
    partial class Query
    {
        ...
        /// </summary>
        public QueryEnumerator<T1, T2, T3, T4>.QueryEnumerable Enumerate<T1, T2, T3, T4>() => new(this);
        /// <summary>
        ...
        /// </summary>
        public EntityQueryEnumerator<T1, T2, T3, T4>.QueryEnumerable EnumerateWithEntities<T1, T2, T3, T4>() => new(this);
        /// <summary>
