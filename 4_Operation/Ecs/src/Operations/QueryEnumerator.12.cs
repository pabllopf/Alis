...
{
    public ref struct QueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
    {
        ...
        /// </summary>
        public RefTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> Current => new()
        {
        ...
        public struct QueryEnumerable(Query query)
        {
            ...
            /// </summary>
            public QueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> GetEnumerator() => new QueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(query);
        }
    }
}