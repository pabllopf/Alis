...
// 
//  --------------------------------------------------------------------------
//  File:EntityQueryEnumerator.10.cs
// 
...
{
    public ref struct EntityQueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
    {
        ...
        /// </summary>
        public EntityRefTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Current => new()
        {
        ...
        public struct QueryEnumerable(Query query)
        {
            ...
            /// </summary>
            public EntityQueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> GetEnumerator() => new EntityQueryEnumerator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(query);
        }
    }
}