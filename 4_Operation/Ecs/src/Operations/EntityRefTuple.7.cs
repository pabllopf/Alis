...
namespace Alis.Core.Ecs.Operations
{
    public ref struct EntityRefTuple<T1, T2, T3, T4, T5, T6, T7>
    {
        ...
        /// </summary>
        public void Deconstruct(out Entity entity, out Ref<T1> @ref1, out Ref<T2> @ref2, out Ref<T3> @ref3, out Ref<T4> @ref4, out Ref<T5> @ref5, out Ref<T6> @ref6, out Ref<T7> @ref7)
        {
            entity = Entity;
            @ref1 = Item1;
            @ref2 = Item2;
