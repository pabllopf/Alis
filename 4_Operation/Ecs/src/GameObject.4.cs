...
namespace Alis.Core.Ecs
{
    partial struct GameObject
    {
        ...
        private static void InvokePerEntityEvents<T1, T2, T3, T4>(GameObject gameObject, bool hasGenericEvent, ref ComponentEvent events, ref T1 component1, ref T2 component2, ref T3 component3, ref T4 component4)
        {
