        ...
        public GameObject Create<T1, T2, T3>(in T1 comp1, in T2 comp2, in T3 comp3)
        {
            ...
            ref T1 ref1 =
                ref UnsafeExtensions.UnsafeCast<ComponentStorage<T1>>(
                    components.UnsafeArrayIndex(Archetype<T1, T2, T3>.OfComponent<T1>.Index))[eloc.Index];
            ref1 = comp1;
            ref T2 ref2 =
                ref UnsafeExtensions.UnsafeCast<ComponentStorage<T2>>(
                    components.UnsafeArrayIndex(Archetype<T1, T2, T3>.OfComponent<T2>.Index))[eloc.Index];
            ref2 = comp2;
            ref T3 ref3 =
                ref UnsafeExtensions.UnsafeCast<ComponentStorage<T3>>(
                    components.UnsafeArrayIndex(Archetype<T1, T2, T3>.OfComponent<T3>.Index))[eloc.Index];
            ref3 = comp3;
