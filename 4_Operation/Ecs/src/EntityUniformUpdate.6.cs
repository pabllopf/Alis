...
namespace Alis.Core.Ecs;
    internal class EntityUniformUpdate<TComp, TUniform, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>(int capacity) : ComponentStorage<TComp>(capacity)
        where TComp : IEntityUniformComponent<TUniform, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>
    {
        ...
        ref TArg6 arg6 = ref b.GetComponentDataReference<TArg6>();
            ...
            for (int i = b.EntityCount - 1; i >= 0; i--)
            {
                ...
                comp.Update(entity, uniform, ref arg1, ref arg2, ref arg3, ref arg4, ref arg5, ref arg6);
