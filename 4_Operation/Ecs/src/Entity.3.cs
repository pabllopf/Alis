...
namespace Alis.Core.Ecs
{
    partial struct Entity
    {
        ...
        private static void InvokeComponentWorldEvents<T1, T2, T3>(ref Event<ComponentID> @event, Alis.Core.Ecs.Entity entity)
        {
        ...
        private static void InvokePerEntityEvents<T1, T2, T3>(Alis.Core.Ecs.Entity entity, bool hasGenericEvent, ref ComponentEvent events, ref T1 component1, ref T2 component2, ref T3 component3)
        {
