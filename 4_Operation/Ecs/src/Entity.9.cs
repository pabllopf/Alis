...
namespace Alis.Core.Ecs;
    partial struct Entity
    {
        ...
        [SkipLocalsInit]
        public void Add<T1, T2, T3, T4, T5, T6, T7, T8, T9>(in T1 c1, in T2 c2, in T3 c3, in T4 c4, in T5 c5, in T6 c6, in T7 c7, in T8 c8, in T9 c9)
        {
            ...
            Archetype to = TraverseThroughCacheOrCreate<ComponentID, NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9>>(
                world,
                ref NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9>.Add.Lookup,
                ref thisLookup,
                true);

            Span<ComponentStorageBase> buff = [null!, null!, null!, null!, null!, null!, null!, null!, null!];
        ...
        Component<T9>.Initer?.Invoke(this, ref c9ref);
            ...
            if (EntityLocation.HasEventFlag(flags | world.WorldEventFlags, EntityFlags.AddComp | EntityFlags.AddGenericComp))
            {
                if (world.ComponentAddedEvent.HasListeners)
                    InvokeComponentWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref world.ComponentAddedEvent, this);
        ...
        public void Remove<T1, T2, T3, T4, T5, T6, T7, T8, T9>()
        {
            ...
            Archetype to = TraverseThroughCacheOrCreate<ComponentID, NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9>>(
                world,
                ref NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9>.Remove.Lookup,
                ref thisLookup,
                false);

            Span<ComponentHandle> runners = stackalloc ComponentHandle[9];
        ...
        /// <inheritdoc cref="Add{T}(in T)"/>
        [SkipLocalsInit]
        public void Tag<T1, T2, T3, T4, T5, T6, T7, T8, T9>()
        {
            ref EntityLocation thisLookup = ref AssertIsAlive(out World world);
            ...
            Archetype to = TraverseThroughCacheOrCreate<TagID, NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9>>(
                world,
                ref NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9>.Tag.Lookup,
                ref thisLookup,
                true);
            ...
            if (EntityLocation.HasEventFlag(flags, EntityFlags.Tagged))
            {
                if (world.Tagged.HasListeners)
                    InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref world.Tagged, this);
                ...
                EventRecord events = world.EventLookup[EntityIDOnly];
                    ...
                    ref EventRecord events = ref CollectionsMarshal.GetValueRefOrNullRef(world.EventLookup, EntityIDOnly);
#endif
                    InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(this, ref events.Tag);
                }
            }
        }
        ...
        /// <inheritdoc cref="Add{T}(in T)"/>
        [SkipLocalsInit]
        public void Detach<T1, T2, T3, T4, T5, T6, T7, T8, T9>()
        {
            ref EntityLocation thisLookup = ref AssertIsAlive(out World world);
            ...
            Archetype to = TraverseThroughCacheOrCreate<TagID, NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9>>(
                world,
                ref NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9>.Detach.Lookup,
                ref thisLookup,
                false);
            ...
            if (EntityLocation.HasEventFlag(flags, EntityFlags.Detach))
            {
                if (world.Detached.HasListeners)
                    InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref world.Detached, this);
                ...
                EventRecord events = world.EventLookup[EntityIDOnly];
                    ...
                    ref EventRecord events = ref CollectionsMarshal.GetValueRefOrNullRef(world.EventLookup, EntityIDOnly);
#endif
                    InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(this, ref events.Detach);
                }
            }
        }

        private static void InvokeComponentWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref Event<ComponentID> @event, Entity entity)
        {
        ...
        private static void InvokePerEntityEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(Entity entity, bool hasGenericEvent, ref ComponentEvent events, ref T1 component1, ref T2 component2, ref T3 component3, ref T4 component4, ref T5 component5, ref T6 component6, ref T7 component7, ref T8 component8, ref T9 component9)
        {
        ...
        private static void InvokeTagWorldEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref TagEvent @event, Entity entity)
        {
        ...
        private static void InvokePerEntityTagEvents<T1, T2, T3, T4, T5, T6, T7, T8, T9>(Entity entity, ref TagEvent events)
        {
        ...
        private struct NeighborCache<T1, T2, T3, T4, T5, T6, T7, T8, T9> : IArchetypeGraphEdge
        {
            public void ModifyTags(ref ImmutableArray<TagID> tags, bool add)
            {
                if (add)
                {
                    tags = MemoryHelpers.Concat(tags, [Core.Tag<T1>.ID, Core.Tag<T2>.ID, Core.Tag<T3>.ID, Core.Tag<T4>.ID, Core.Tag<T5>.ID, Core.Tag<T6>.ID, Core.Tag<T7>.ID, Core.Tag<T8>.ID, Core.Tag<T9>.ID]);
                }
                else
                {
                    tags = MemoryHelpers.Remove(tags, [Core.Tag<T1>.ID, Core.Tag<T2>.ID, Core.Tag<T3>.ID, Core.Tag<T4>.ID, Core.Tag<T5>.ID, Core.Tag<T6>.ID, Core.Tag<T7>.ID, Core.Tag<T8>.ID, Core.Tag<T9>.ID]);
                }
            }
            ...
            public void ModifyComponents(ref ImmutableArray<ComponentID> components, bool add)
            {
                if (add)
                {
                    components = MemoryHelpers.Concat(components, [Component<T1>.ID, Component<T2>.ID, Component<T3>.ID, Component<T4>.ID, Component<T5>.ID, Component<T6>.ID, Component<T7>.ID, Component<T8>.ID, Component<T9>.ID]);
                }
                else
                {
                    components = MemoryHelpers.Remove(components, [Component<T1>.ID, Component<T2>.ID, Component<T3>.ID, Component<T4>.ID, Component<T5>.ID, Component<T6>.ID, Component<T7>.ID, Component<T8>.ID, Component<T9>.ID]);
                }
            }
