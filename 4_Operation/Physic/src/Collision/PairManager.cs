...
namespace Alis.Core.Physic.Collision
{
	...
	public class PairManager
	{
		...
		public PairManager()
		{
			Debug.Assert(Common.Math.IsPowerOfTwo((uint)PairManager.TableCapacity) == true);
			Debug.Assert(PairManager.TableCapacity >= Settings.MaxPairs);
		...
		*/
		...
		{
			Debug.Assert(id1 != PairManager.NullProxy && id2 != PairManager.NullProxy);
		...
		private Pair AddPair(int proxyId1, int proxyId2)
		{
			...
			Debug.Assert(_pairCount < Settings.MaxPairs && _freePair != PairManager.NullPair);
