...
namespace Alis.Core.Physic.Test.Collisions
{
    ...
    public class IndexArrayTests
    {
        ...
        /// </summary>
        public IndexArrayTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the index array
        /// </summary>
        /// <returns>The index array</returns>
        private IndexArray CreateIndexArray() => new IndexArray();
        ...
        {
            // Arrange
            IndexArray indexArray = CreateIndexArray();
