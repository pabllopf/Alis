...
namespace Alis.Core.Physic.Test.Collisions
{
    ...
    public class SimplexVertexTests
    {
        ...
        /// </summary>
        public SimplexVertexTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the simplex vertex
        /// </summary>
        /// <returns>The simplex vertex</returns>
        private SimplexVertex CreateSimplexVertex() => new SimplexVertex();
        ...
        {
            // Arrange
            SimplexVertex simplexVertex = CreateSimplexVertex();
