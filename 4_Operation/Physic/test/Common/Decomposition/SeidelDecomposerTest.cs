...
namespace Alis.Core.Physic.Test.Common.Decomposition
{
    ...
    public class SeidelDecomposerTest
    {
        ...
        {
            Assert.NotNull(typeof(SeidelDecomposer));
        }
        ...
        public void ConvexPartition_WithTriangle_ShouldReturnSinglePart()
        {
            ...
            System.Collections.Generic.List<Vertices> result = SeidelDecomposer.ConvexPartition(vertices);
