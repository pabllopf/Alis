...
private Vector2 RotatePoint(Vector2 point, float angle)
        ...
        {
            Vector2[] sourceArray = {new Vector2(1, 1), new Vector2(2, 2), new Vector2(3, 3)};
        ...
        {
            Vector2[] sourceArray = {new Vector2(1, 1)};
            Vector2[] destinationArray = new Vector2[sourceArray.Length];
            Matrix4X4 transform = Matrix4X4.CreateRotationZ(MathF.PI / 2);
        ...
        /// <summary>
        ///     Tests that determine winding direction returns one when p 1 y is less than or equal to point y and p 2 y is greater
        ///     than point y
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     Tests that determine winding direction returns zero when p 1 y is less than or equal to point y and p 2 y is less
        ///     than or equal to point y
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     Tests that determine winding direction returns negative one when p 1 y is greater than point y and p 2 y is less
        ///     than or equal to point y
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     Tests that determine winding direction returns zero when p 1 y is greater than point y and p 2 y is greater than
        ///     point y
        /// </summary>
        [Fact]
