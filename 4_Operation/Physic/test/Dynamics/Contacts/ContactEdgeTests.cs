...
namespace Alis.Core.Physic.Test.Dynamics.Contacts
{
    ...
    public class ContactEdgeTests
    {
        ...
        /// </summary>
        public ContactEdgeTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the contact edge
        /// </summary>
        /// <returns>The contact edge</returns>
        private ContactEdge CreateContactEdge() => new ContactEdge();
        ...
        {
            // Arrange
            ContactEdge contactEdge = CreateContactEdge();
