...
// 
//  --------------------------------------------------------------------------
//  File:PrismaticJointRemainingCoverageTests.cs
// 
...
{
    /// <summary>
    ///     The prismatic joint remaining coverage tests class
    /// </summary>
    public class PrismaticJointRemainingCoverageTests
    {
        /// <summary>
        ...
        public void InitVelocityConstraints_WithoutWarmStarting_ZeroesImpulses()
        {
            Body bodyA = new Body();
            Body bodyB = new Body();
            PrismaticJoint joint = new PrismaticJoint(bodyA, bodyB, new Vector2F(0, 0), new Vector2F(1, 0), new Vector2F(1, 0));
        ...
        /// <summary>
        ///     Tests that init velocity constraints with motor disabled zeroes motor impulse
        /// </summary>
        [Fact]
        public void InitVelocityConstraints_WithMotorDisabled_ZeroesMotorImpulse()
        {
            Body bodyA = new Body();
            Body bodyB = new Body();
            PrismaticJoint joint = new PrismaticJoint(bodyA, bodyB, new Vector2F(0, 0), new Vector2F(1, 0), new Vector2F(1, 0));
            ...
            Assert.Equal(0.0f, joint.GetMotorForce(1.0f));
        }
    }
}
