...
namespace Alis.Core.Physic.Test.Dynamics.Joints
{
    ...
    public class PrismaticJointDefTests
    {
        ...
        /// </summary>
        public PrismaticJointDefTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the prismatic joint def
        /// </summary>
        /// <returns>The prismatic joint def</returns>
        private PrismaticJointDef CreatePrismaticJointDef() => new PrismaticJointDef();
