...
namespace Alis.Core.Physic.Test.Dynamics.Joints
{
    ...
    public class PulleyJointDefTests
    {
        ...
        /// </summary>
        public PulleyJointDefTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the pulley joint def
        /// </summary>
        /// <returns>The pulley joint def</returns>
        private PulleyJointDef CreatePulleyJointDef() => new PulleyJointDef();
