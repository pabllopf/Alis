...
namespace Alis.Core.Physic.Test.Dynamics.Joints
{
    ...
    public class JointDefTests
    {
        ...
        /// </summary>
        public JointDefTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the joint def
        /// </summary>
        /// <returns>The joint def</returns>
        private JointDef CreateJointDef() => new JointDef();
        ...
        {
            // Arrange
            JointDef jointDef = CreateJointDef();
