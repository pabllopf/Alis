...
namespace Alis.Core.Physic.Test.Dynamics.Controllers
{
    ...
    public class ConstantForceControllerDefTests
    {
        ...
        /// </summary>
        public ConstantForceControllerDefTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the constant force controller def
        /// </summary>
        /// <returns>The constant force controller def</returns>
        private ConstantForceControllerDef CreateConstantForceControllerDef() => new ConstantForceControllerDef();
        ...
        {
            // Arrange
            ConstantForceControllerDef constantForceControllerDef = CreateConstantForceControllerDef();
