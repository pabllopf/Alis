...
// 
//  --------------------------------------------------------------------------
//  File:BuoyancyControllerDefTests.cs
// 
...
namespace Alis.Core.Physic.Test.Dynamics.Controllers
{
    ...
    public class BuoyancyControllerDefTests
    {
        ...
        /// </summary>
        public BuoyancyControllerDefTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the buoyancy controller def
        /// </summary>
        /// <returns>The buoyancy controller def</returns>
        private BuoyancyControllerDef CreateBuoyancyControllerDef() => new BuoyancyControllerDef();
        ...
        {
            // Arrange
            BuoyancyControllerDef buoyancyControllerDef = CreateBuoyancyControllerDef();
