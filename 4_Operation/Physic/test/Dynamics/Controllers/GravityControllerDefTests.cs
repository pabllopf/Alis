...
// 
//  --------------------------------------------------------------------------
//  File:GravityControllerDefTests.cs
// 
...
namespace Alis.Core.Physic.Test.Dynamics.Controllers
{
    ...
    public class GravityControllerDefTests
    {
        ...
        /// </summary>
        public GravityControllerDefTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the gravity controller def
        /// </summary>
        /// <returns>The gravity controller def</returns>
        private GravityControllerDef CreateGravityControllerDef() => new GravityControllerDef();
        ...
        {
            // Arrange
            GravityControllerDef gravityControllerDef = CreateGravityControllerDef();
