...
namespace Alis.Core.Physic.Test.Dynamics.Controllers
{
    ...
    public class ControllerEdgeTests
    {
        ...
        /// </summary>
        public ControllerEdgeTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the controller edge
        /// </summary>
        /// <returns>The controller edge</returns>
        private ControllerEdge CreateControllerEdge() => new ControllerEdge();
        ...
        {
            // Arrange
            ControllerEdge controllerEdge = CreateControllerEdge();
