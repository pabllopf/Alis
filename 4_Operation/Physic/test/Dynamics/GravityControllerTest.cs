...
namespace Alis.Core.Physic.Test.Dynamics
{
    ...
    public class GravityControllerTest
    {
        ...
        /// <summary>
        ///     Tests that add body should add body to bodies list
        /// </summary>
        [Fact]
        public void AddBody_ShouldAddBodyToBodiesList()
        {
            GravityController controller = new GravityController(10.0f);
        ...
        /// <summary>
        ///     Tests that add point should add point to points list
        /// </summary>
        [Fact]
        public void AddPoint_ShouldAddPointToPointsList()
        {
            GravityController controller = new GravityController(10.0f);
        ...
        /// <summary>
        ///     Tests that update should handle world with bodies and points
        /// </summary>
        [Fact]
        public void Update_ShouldHandleWorldWithBodiesAndPoints()
        {
            GravityController controller = new GravityController(10.0f);
            WorldPhysic world = new WorldPhysic(new Vector2F(0, -10));
            controller.WorldPhysic = world;
