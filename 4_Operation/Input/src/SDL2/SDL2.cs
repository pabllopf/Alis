...
namespace Alis.Core.Input.SDL2
{
	...
	public static class Sdl
	{
		...
		/// <summary>
		/// The sdl hint render line method
		/// </summary>
		public const string SdlHintRenderLineMethod =
			"SDL_RENDER_LINE_METHOD";

		/* Only available in 2.0.22 or higher. */
		/// <summary>
		/// The sdl hint force raisewindow
		/// </summary>
		public const string SdlHintForceRaisewindow =
			"SDL_HINT_FORCE_RAISEWINDOW";
		/// <summary>
		/// The sdl hint ime support extended text
		/// </summary>
		public const string SdlHintImeSupportExtendedText =
			"SDL_IME_SUPPORT_EXTENDED_TEXT";
		/// <summary>
		/// The sdl hint joystick gamecube rumble brake
		/// </summary>
		public const string SdlHintJoystickGamecubeRumbleBrake =
			"SDL_JOYSTICK_GAMECUBE_RUMBLE_BRAKE";
		/// <summary>
		/// The sdl hint joystick rog chakram
		/// </summary>
		public const string SdlHintJoystickRogChakram =
			"SDL_JOYSTICK_ROG_CHAKRAM";
		/// <summary>
		/// The sdl hint mouse relative mode center
		/// </summary>
		public const string SdlHintMouseRelativeModeCenter =
			"SDL_MOUSE_RELATIVE_MODE_CENTER";
		/// <summary>
		/// The sdl hint mouse auto capture
		/// </summary>
		public const string SdlHintMouseAutoCapture =
			"SDL_MOUSE_AUTO_CAPTURE";
		/// <summary>
		/// The sdl hint vita touch mouse device
		/// </summary>
		public const string SdlHintVitaTouchMouseDevice =
			"SDL_HINT_VITA_TOUCH_MOUSE_DEVICE";
		/// <summary>
		/// The sdl hint video wayland prefer libdecor
		/// </summary>
		public const string SdlHintVideoWaylandPreferLibdecor =
			"SDL_VIDEO_WAYLAND_PREFER_LIBDECOR";
		/// <summary>
		/// The sdl hint video foreign window opengl
		/// </summary>
		public const string SdlHintVideoForeignWindowOpengl =
			"SDL_VIDEO_FOREIGN_WINDOW_OPENGL";
		/// <summary>
		/// The sdl hint video foreign window vulkan
		/// </summary>
		public const string SdlHintVideoForeignWindowVulkan =
			"SDL_VIDEO_FOREIGN_WINDOW_VULKAN";
		/// <summary>
		/// The sdl hint x11 window type
		/// </summary>
		public const string SdlHintX11WindowType =
			"SDL_X11_WINDOW_TYPE";
		/// <summary>
		/// The sdl hint quit on last window close
		/// </summary>
		public const string SdlHintQuitOnLastWindowClose =
		...
		/// The sdl patchlevel
		/// </summary>
		public const int SdlPatchlevel =	22;
		...
		public enum SdlEventType : uint
		{
			...
			SdlKeymapchanged,
			/// <summary>
			/// The sdl textediting ext sdl eventtype
			/// </summary>
			SdlTexteditingExt,
...
#pragma warning restore 0169
		...
		/// </summary>
		[StructLayout(LayoutKind.Sequential)]
		public unsafe struct SdlTextEditingExtEvent
		{
			/// <summary>
			/// The type
			/// </summary>
...
#pragma warning restore 0169
		...
		public enum SdlKeycode
		{
			...
			*/
			...
			/// </summary>
			SdlkCapslock = (int)SdlScancode.SdlScancodeCapslock | SdlkScancodeMask,

			/// <summary>
			/// The sdlk f1 sdl keycode
			/// </summary>
			SdlkF1 = (int)SdlScancode.SdlScancodeF1 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f2 sdl keycode
			/// </summary>
			SdlkF2 = (int)SdlScancode.SdlScancodeF2 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f3 sdl keycode
			/// </summary>
			SdlkF3 = (int)SdlScancode.SdlScancodeF3 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f4 sdl keycode
			/// </summary>
			SdlkF4 = (int)SdlScancode.SdlScancodeF4 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f5 sdl keycode
			/// </summary>
			SdlkF5 = (int)SdlScancode.SdlScancodeF5 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f6 sdl keycode
			/// </summary>
			SdlkF6 = (int)SdlScancode.SdlScancodeF6 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f7 sdl keycode
			/// </summary>
			SdlkF7 = (int)SdlScancode.SdlScancodeF7 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f8 sdl keycode
			/// </summary>
			SdlkF8 = (int)SdlScancode.SdlScancodeF8 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f9 sdl keycode
			/// </summary>
			SdlkF9 = (int)SdlScancode.SdlScancodeF9 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f10 sdl keycode
			/// </summary>
			SdlkF10 = (int)SdlScancode.SdlScancodeF10 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f11 sdl keycode
			/// </summary>
			SdlkF11 = (int)SdlScancode.SdlScancodeF11 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f12 sdl keycode
			/// </summary>
			SdlkF12 = (int)SdlScancode.SdlScancodeF12 | SdlkScancodeMask,

			/// <summary>
			/// The sdlk printscreen sdl keycode
			/// </summary>
			SdlkPrintscreen = (int)SdlScancode.SdlScancodePrintscreen | SdlkScancodeMask,
			/// <summary>
			/// The sdlk scrolllock sdl keycode
			/// </summary>
			SdlkScrolllock = (int)SdlScancode.SdlScancodeScrolllock | SdlkScancodeMask,
			/// <summary>
			/// The sdlk pause sdl keycode
			/// </summary>
			SdlkPause = (int)SdlScancode.SdlScancodePause | SdlkScancodeMask,
			/// <summary>
			/// The sdlk insert sdl keycode
			/// </summary>
			SdlkInsert = (int)SdlScancode.SdlScancodeInsert | SdlkScancodeMask,
			/// <summary>
			/// The sdlk home sdl keycode
			/// </summary>
			SdlkHome = (int)SdlScancode.SdlScancodeHome | SdlkScancodeMask,
			/// <summary>
			/// The sdlk pageup sdl keycode
			/// </summary>
			SdlkPageup = (int)SdlScancode.SdlScancodePageup | SdlkScancodeMask,
			/// <summary>
			...
			/// </summary>
			SdlkEnd = (int)SdlScancode.SdlScancodeEnd | SdlkScancodeMask,
			/// <summary>
			/// The sdlk pagedown sdl keycode
			/// </summary>
			SdlkPagedown = (int)SdlScancode.SdlScancodePagedown | SdlkScancodeMask,
			/// <summary>
			/// The sdlk right sdl keycode
			/// </summary>
			SdlkRight = (int)SdlScancode.SdlScancodeRight | SdlkScancodeMask,
			/// <summary>
			/// The sdlk left sdl keycode
			/// </summary>
			SdlkLeft = (int)SdlScancode.SdlScancodeLeft | SdlkScancodeMask,
			/// <summary>
			/// The sdlk down sdl keycode
			/// </summary>
			SdlkDown = (int)SdlScancode.SdlScancodeDown | SdlkScancodeMask,
			/// <summary>
			/// The sdlk up sdl keycode
			/// </summary>
			SdlkUp = (int)SdlScancode.SdlScancodeUp | SdlkScancodeMask,

			/// <summary>
			/// The sdlk numlockclear sdl keycode
			/// </summary>
			SdlkNumlockclear = (int)SdlScancode.SdlScancodeNumlockclear | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp divide sdl keycode
			/// </summary>
			SdlkKpDivide = (int)SdlScancode.SdlScancodeKpDivide | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp multiply sdl keycode
			/// </summary>
			SdlkKpMultiply = (int)SdlScancode.SdlScancodeKpMultiply | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp minus sdl keycode
			/// </summary>
			SdlkKpMinus = (int)SdlScancode.SdlScancodeKpMinus | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp plus sdl keycode
			/// </summary>
			SdlkKpPlus = (int)SdlScancode.SdlScancodeKpPlus | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp enter sdl keycode
			/// </summary>
			SdlkKpEnter = (int)SdlScancode.SdlScancodeKpEnter | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKp1 = (int)SdlScancode.SdlScancodeKp1 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKp2 = (int)SdlScancode.SdlScancodeKp2 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKp3 = (int)SdlScancode.SdlScancodeKp3 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKp4 = (int)SdlScancode.SdlScancodeKp4 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKp5 = (int)SdlScancode.SdlScancodeKp5 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKp6 = (int)SdlScancode.SdlScancodeKp6 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKp7 = (int)SdlScancode.SdlScancodeKp7 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKp8 = (int)SdlScancode.SdlScancodeKp8 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKp9 = (int)SdlScancode.SdlScancodeKp9 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKp0 = (int)SdlScancode.SdlScancodeKp0 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp period sdl keycode
			/// </summary>
			SdlkKpPeriod = (int)SdlScancode.SdlScancodeKpPeriod | SdlkScancodeMask,

			/// <summary>
			/// The sdlk application sdl keycode
			/// </summary>
			SdlkApplication = (int)SdlScancode.SdlScancodeApplication | SdlkScancodeMask,
			/// <summary>
			/// The sdlk power sdl keycode
			/// </summary>
			SdlkPower = (int)SdlScancode.SdlScancodePower | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp equals sdl keycode
			/// </summary>
			SdlkKpEquals = (int)SdlScancode.SdlScancodeKpEquals | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f13 sdl keycode
			/// </summary>
			SdlkF13 = (int)SdlScancode.SdlScancodeF13 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f14 sdl keycode
			/// </summary>
			SdlkF14 = (int)SdlScancode.SdlScancodeF14 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f15 sdl keycode
			/// </summary>
			SdlkF15 = (int)SdlScancode.SdlScancodeF15 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f16 sdl keycode
			/// </summary>
			SdlkF16 = (int)SdlScancode.SdlScancodeF16 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f17 sdl keycode
			/// </summary>
			SdlkF17 = (int)SdlScancode.SdlScancodeF17 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f18 sdl keycode
			/// </summary>
			SdlkF18 = (int)SdlScancode.SdlScancodeF18 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f19 sdl keycode
			/// </summary>
			SdlkF19 = (int)SdlScancode.SdlScancodeF19 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f20 sdl keycode
			/// </summary>
			SdlkF20 = (int)SdlScancode.SdlScancodeF20 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f21 sdl keycode
			/// </summary>
			SdlkF21 = (int)SdlScancode.SdlScancodeF21 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f22 sdl keycode
			/// </summary>
			SdlkF22 = (int)SdlScancode.SdlScancodeF22 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f23 sdl keycode
			/// </summary>
			SdlkF23 = (int)SdlScancode.SdlScancodeF23 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk f24 sdl keycode
			/// </summary>
			SdlkF24 = (int)SdlScancode.SdlScancodeF24 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk execute sdl keycode
			/// </summary>
			SdlkExecute = (int)SdlScancode.SdlScancodeExecute | SdlkScancodeMask,
			/// <summary>
			/// The sdlk help sdl keycode
			/// </summary>
			SdlkHelp = (int)SdlScancode.SdlScancodeHelp | SdlkScancodeMask,
			/// <summary>
			/// The sdlk menu sdl keycode
			/// </summary>
			SdlkMenu = (int)SdlScancode.SdlScancodeMenu | SdlkScancodeMask,
			/// <summary>
			/// The sdlk select sdl keycode
			/// </summary>
			SdlkSelect = (int)SdlScancode.SdlScancodeSelect | SdlkScancodeMask,
			/// <summary>
			/// The sdlk stop sdl keycode
			/// </summary>
			SdlkStop = (int)SdlScancode.SdlScancodeStop | SdlkScancodeMask,
			/// <summary>
			/// The sdlk again sdl keycode
			/// </summary>
			SdlkAgain = (int)SdlScancode.SdlScancodeAgain | SdlkScancodeMask,
			/// <summary>
			/// The sdlk undo sdl keycode
			/// </summary>
			SdlkUndo = (int)SdlScancode.SdlScancodeUndo | SdlkScancodeMask,
			/// <summary>
			/// The sdlk cut sdl keycode
			/// </summary>
			SdlkCut = (int)SdlScancode.SdlScancodeCut | SdlkScancodeMask,
			/// <summary>
			/// The sdlk copy sdl keycode
			/// </summary>
			SdlkCopy = (int)SdlScancode.SdlScancodeCopy | SdlkScancodeMask,
			/// <summary>
			/// The sdlk paste sdl keycode
			/// </summary>
			SdlkPaste = (int)SdlScancode.SdlScancodePaste | SdlkScancodeMask,
			/// <summary>
			/// The sdlk find sdl keycode
			/// </summary>
			SdlkFind = (int)SdlScancode.SdlScancodeFind | SdlkScancodeMask,
			/// <summary>
			/// The sdlk mute sdl keycode
			/// </summary>
			SdlkMute = (int)SdlScancode.SdlScancodeMute | SdlkScancodeMask,
			/// <summary>
			/// The sdlk volumeup sdl keycode
			/// </summary>
			SdlkVolumeup = (int)SdlScancode.SdlScancodeVolumeup | SdlkScancodeMask,
			/// <summary>
			/// The sdlk volumedown sdl keycode
			/// </summary>
			SdlkVolumedown = (int)SdlScancode.SdlScancodeVolumedown | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp comma sdl keycode
			/// </summary>
			SdlkKpComma = (int)SdlScancode.SdlScancodeKpComma | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp equalsas400 sdl keycode
			/// </summary>
			SdlkKpEqualsas400 =
			(int)SdlScancode.SdlScancodeKpEqualsas400 | SdlkScancodeMask,

			/// <summary>
			/// The sdlk alterase sdl keycode
			/// </summary>
			SdlkAlterase = (int)SdlScancode.SdlScancodeAlterase | SdlkScancodeMask,
			/// <summary>
			/// The sdlk sysreq sdl keycode
			/// </summary>
			SdlkSysreq = (int)SdlScancode.SdlScancodeSysreq | SdlkScancodeMask,
			/// <summary>
			/// The sdlk cancel sdl keycode
			/// </summary>
			SdlkCancel = (int)SdlScancode.SdlScancodeCancel | SdlkScancodeMask,
			/// <summary>
			/// The sdlk clear sdl keycode
			/// </summary>
			SdlkClear = (int)SdlScancode.SdlScancodeClear | SdlkScancodeMask,
			/// <summary>
			/// The sdlk prior sdl keycode
			/// </summary>
			SdlkPrior = (int)SdlScancode.SdlScancodePrior | SdlkScancodeMask,
			/// <summary>
			/// The sdlk return2 sdl keycode
			/// </summary>
			SdlkReturn2 = (int)SdlScancode.SdlScancodeReturn2 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk separator sdl keycode
			/// </summary>
			SdlkSeparator = (int)SdlScancode.SdlScancodeSeparator | SdlkScancodeMask,
			/// <summary>
			/// The sdlk out sdl keycode
			/// </summary>
			SdlkOut = (int)SdlScancode.SdlScancodeOut | SdlkScancodeMask,
			/// <summary>
			/// The sdlk oper sdl keycode
			/// </summary>
			SdlkOper = (int)SdlScancode.SdlScancodeOper | SdlkScancodeMask,
			/// <summary>
			/// The sdlk clearagain sdl keycode
			/// </summary>
			SdlkClearagain = (int)SdlScancode.SdlScancodeClearagain | SdlkScancodeMask,
			/// <summary>
			/// The sdlk crsel sdl keycode
			/// </summary>
			SdlkCrsel = (int)SdlScancode.SdlScancodeCrsel | SdlkScancodeMask,
			/// <summary>
			/// The sdlk exsel sdl keycode
			/// </summary>
			SdlkExsel = (int)SdlScancode.SdlScancodeExsel | SdlkScancodeMask,

			/// <summary>
			/// The sdlk kp 00 sdl keycode
			/// </summary>
			SdlkKp00 = (int)SdlScancode.SdlScancodeKp00 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp 000 sdl keycode
			/// </summary>
			SdlkKp000 = (int)SdlScancode.SdlScancodeKp000 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk thousandsseparator sdl keycode
			/// </summary>
			SdlkThousandsseparator =
			(int)SdlScancode.SdlScancodeThousandsseparator | SdlkScancodeMask,
			/// <summary>
			/// The sdlk decimalseparator sdl keycode
			/// </summary>
			SdlkDecimalseparator =
			(int)SdlScancode.SdlScancodeDecimalseparator | SdlkScancodeMask,
			/// <summary>
			/// The sdlk currencyunit sdl keycode
			/// </summary>
			SdlkCurrencyunit = (int)SdlScancode.SdlScancodeCurrencyunit | SdlkScancodeMask,
			/// <summary>
			/// The sdlk currencysubunit sdl keycode
			/// </summary>
			SdlkCurrencysubunit =
			(int)SdlScancode.SdlScancodeCurrencysubunit | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp leftparen sdl keycode
			/// </summary>
			SdlkKpLeftparen = (int)SdlScancode.SdlScancodeKpLeftparen | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp rightparen sdl keycode
			/// </summary>
			SdlkKpRightparen = (int)SdlScancode.SdlScancodeKpRightparen | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp leftbrace sdl keycode
			/// </summary>
			SdlkKpLeftbrace = (int)SdlScancode.SdlScancodeKpLeftbrace | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp rightbrace sdl keycode
			/// </summary>
			SdlkKpRightbrace = (int)SdlScancode.SdlScancodeKpRightbrace | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp tab sdl keycode
			/// </summary>
			SdlkKpTab = (int)SdlScancode.SdlScancodeKpTab | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp backspace sdl keycode
			/// </summary>
			SdlkKpBackspace = (int)SdlScancode.SdlScancodeKpBackspace | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKpA = (int)SdlScancode.SdlScancodeKpA | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKpB = (int)SdlScancode.SdlScancodeKpB | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKpC = (int)SdlScancode.SdlScancodeKpC | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKpD = (int)SdlScancode.SdlScancodeKpD | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKpE = (int)SdlScancode.SdlScancodeKpE | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp sdl keycode
			/// </summary>
			SdlkKpF = (int)SdlScancode.SdlScancodeKpF | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp xor sdl keycode
			/// </summary>
			SdlkKpXor = (int)SdlScancode.SdlScancodeKpXor | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp power sdl keycode
			/// </summary>
			SdlkKpPower = (int)SdlScancode.SdlScancodeKpPower | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp percent sdl keycode
			/// </summary>
			SdlkKpPercent = (int)SdlScancode.SdlScancodeKpPercent | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp less sdl keycode
			/// </summary>
			SdlkKpLess = (int)SdlScancode.SdlScancodeKpLess | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp greater sdl keycode
			/// </summary>
			SdlkKpGreater = (int)SdlScancode.SdlScancodeKpGreater | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp ampersand sdl keycode
			/// </summary>
			SdlkKpAmpersand = (int)SdlScancode.SdlScancodeKpAmpersand | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp dblampersand sdl keycode
			/// </summary>
			SdlkKpDblampersand =
			(int)SdlScancode.SdlScancodeKpDblampersand | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp verticalbar sdl keycode
			/// </summary>
			SdlkKpVerticalbar =
			(int)SdlScancode.SdlScancodeKpVerticalbar | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp dblverticalbar sdl keycode
			/// </summary>
			SdlkKpDblverticalbar =
			(int)SdlScancode.SdlScancodeKpDblverticalbar | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp colon sdl keycode
			/// </summary>
			SdlkKpColon = (int)SdlScancode.SdlScancodeKpColon | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp hash sdl keycode
			/// </summary>
			SdlkKpHash = (int)SdlScancode.SdlScancodeKpHash | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp space sdl keycode
			/// </summary>
			SdlkKpSpace = (int)SdlScancode.SdlScancodeKpSpace | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp at sdl keycode
			/// </summary>
			SdlkKpAt = (int)SdlScancode.SdlScancodeKpAt | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp exclam sdl keycode
			/// </summary>
			SdlkKpExclam = (int)SdlScancode.SdlScancodeKpExclam | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp memstore sdl keycode
			/// </summary>
			SdlkKpMemstore = (int)SdlScancode.SdlScancodeKpMemstore | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp memrecall sdl keycode
			/// </summary>
			SdlkKpMemrecall = (int)SdlScancode.SdlScancodeKpMemrecall | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp memclear sdl keycode
			/// </summary>
			SdlkKpMemclear = (int)SdlScancode.SdlScancodeKpMemclear | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp memadd sdl keycode
			/// </summary>
			SdlkKpMemadd = (int)SdlScancode.SdlScancodeKpMemadd | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp memsubtract sdl keycode
			/// </summary>
			SdlkKpMemsubtract =
			(int)SdlScancode.SdlScancodeKpMemsubtract | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp memmultiply sdl keycode
			/// </summary>
			SdlkKpMemmultiply =
			(int)SdlScancode.SdlScancodeKpMemmultiply | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp memdivide sdl keycode
			/// </summary>
			SdlkKpMemdivide = (int)SdlScancode.SdlScancodeKpMemdivide | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp plusminus sdl keycode
			/// </summary>
			SdlkKpPlusminus = (int)SdlScancode.SdlScancodeKpPlusminus | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp clear sdl keycode
			/// </summary>
			SdlkKpClear = (int)SdlScancode.SdlScancodeKpClear | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp clearentry sdl keycode
			/// </summary>
			SdlkKpClearentry = (int)SdlScancode.SdlScancodeKpClearentry | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp binary sdl keycode
			/// </summary>
			SdlkKpBinary = (int)SdlScancode.SdlScancodeKpBinary | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp octal sdl keycode
			/// </summary>
			SdlkKpOctal = (int)SdlScancode.SdlScancodeKpOctal | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp decimal sdl keycode
			/// </summary>
			SdlkKpDecimal = (int)SdlScancode.SdlScancodeKpDecimal | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kp hexadecimal sdl keycode
			/// </summary>
			SdlkKpHexadecimal =
			(int)SdlScancode.SdlScancodeKpHexadecimal | SdlkScancodeMask,

			/// <summary>
			/// The sdlk lctrl sdl keycode
			/// </summary>
			SdlkLctrl = (int)SdlScancode.SdlScancodeLctrl | SdlkScancodeMask,
			/// <summary>
			/// The sdlk lshift sdl keycode
			/// </summary>
			SdlkLshift = (int)SdlScancode.SdlScancodeLshift | SdlkScancodeMask,
			/// <summary>
			/// The sdlk lalt sdl keycode
			/// </summary>
			SdlkLalt = (int)SdlScancode.SdlScancodeLalt | SdlkScancodeMask,
			/// <summary>
			/// The sdlk lgui sdl keycode
			/// </summary>
			SdlkLgui = (int)SdlScancode.SdlScancodeLgui | SdlkScancodeMask,
			/// <summary>
			/// The sdlk rctrl sdl keycode
			/// </summary>
			SdlkRctrl = (int)SdlScancode.SdlScancodeRctrl | SdlkScancodeMask,
			/// <summary>
			/// The sdlk rshift sdl keycode
			/// </summary>
			SdlkRshift = (int)SdlScancode.SdlScancodeRshift | SdlkScancodeMask,
			/// <summary>
			/// The sdlk ralt sdl keycode
			/// </summary>
			SdlkRalt = (int)SdlScancode.SdlScancodeRalt | SdlkScancodeMask,
			/// <summary>
			/// The sdlk rgui sdl keycode
			/// </summary>
			SdlkRgui = (int)SdlScancode.SdlScancodeRgui | SdlkScancodeMask,

			/// <summary>
			/// The sdlk mode sdl keycode
			/// </summary>
			SdlkMode = (int)SdlScancode.SdlScancodeMode | SdlkScancodeMask,

			/// <summary>
			/// The sdlk audionext sdl keycode
			/// </summary>
			SdlkAudionext = (int)SdlScancode.SdlScancodeAudionext | SdlkScancodeMask,
			/// <summary>
			/// The sdlk audioprev sdl keycode
			/// </summary>
			SdlkAudioprev = (int)SdlScancode.SdlScancodeAudioprev | SdlkScancodeMask,
			/// <summary>
			/// The sdlk audiostop sdl keycode
			/// </summary>
			SdlkAudiostop = (int)SdlScancode.SdlScancodeAudiostop | SdlkScancodeMask,
			/// <summary>
			/// The sdlk audioplay sdl keycode
			/// </summary>
			SdlkAudioplay = (int)SdlScancode.SdlScancodeAudioplay | SdlkScancodeMask,
			/// <summary>
			/// The sdlk audiomute sdl keycode
			/// </summary>
			SdlkAudiomute = (int)SdlScancode.SdlScancodeAudiomute | SdlkScancodeMask,
			/// <summary>
			/// The sdlk mediaselect sdl keycode
			/// </summary>
			SdlkMediaselect = (int)SdlScancode.SdlScancodeMediaselect | SdlkScancodeMask,
			/// <summary>
			/// The sdlk www sdl keycode
			/// </summary>
			SdlkWww = (int)SdlScancode.SdlScancodeWww | SdlkScancodeMask,
			/// <summary>
			/// The sdlk mail sdl keycode
			/// </summary>
			SdlkMail = (int)SdlScancode.SdlScancodeMail | SdlkScancodeMask,
			/// <summary>
			/// The sdlk calculator sdl keycode
			/// </summary>
			SdlkCalculator = (int)SdlScancode.SdlScancodeCalculator | SdlkScancodeMask,
			/// <summary>
			/// The sdlk computer sdl keycode
			/// </summary>
			SdlkComputer = (int)SdlScancode.SdlScancodeComputer | SdlkScancodeMask,
			/// <summary>
			/// The sdlk ac search sdl keycode
			/// </summary>
			SdlkAcSearch = (int)SdlScancode.SdlScancodeAcSearch | SdlkScancodeMask,
			/// <summary>
			/// The sdlk ac home sdl keycode
			/// </summary>
			SdlkAcHome = (int)SdlScancode.SdlScancodeAcHome | SdlkScancodeMask,
			/// <summary>
			/// The sdlk ac back sdl keycode
			/// </summary>
			SdlkAcBack = (int)SdlScancode.SdlScancodeAcBack | SdlkScancodeMask,
			/// <summary>
			/// The sdlk ac forward sdl keycode
			/// </summary>
			SdlkAcForward = (int)SdlScancode.SdlScancodeAcForward | SdlkScancodeMask,
			/// <summary>
			/// The sdlk ac stop sdl keycode
			/// </summary>
			SdlkAcStop = (int)SdlScancode.SdlScancodeAcStop | SdlkScancodeMask,
			/// <summary>
			/// The sdlk ac refresh sdl keycode
			/// </summary>
			SdlkAcRefresh = (int)SdlScancode.SdlScancodeAcRefresh | SdlkScancodeMask,
			/// <summary>
			/// The sdlk ac bookmarks sdl keycode
			/// </summary>
			SdlkAcBookmarks = (int)SdlScancode.SdlScancodeAcBookmarks | SdlkScancodeMask,

			/// <summary>
			/// The sdlk brightnessdown sdl keycode
			/// </summary>
			SdlkBrightnessdown =
			(int)SdlScancode.SdlScancodeBrightnessdown | SdlkScancodeMask,
			/// <summary>
			/// The sdlk brightnessup sdl keycode
			/// </summary>
			SdlkBrightnessup = (int)SdlScancode.SdlScancodeBrightnessup | SdlkScancodeMask,
			/// <summary>
			/// The sdlk displayswitch sdl keycode
			/// </summary>
			SdlkDisplayswitch = (int)SdlScancode.SdlScancodeDisplayswitch | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kbdillumtoggle sdl keycode
			/// </summary>
			SdlkKbdillumtoggle =
			(int)SdlScancode.SdlScancodeKbdillumtoggle | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kbdillumdown sdl keycode
			/// </summary>
			SdlkKbdillumdown = (int)SdlScancode.SdlScancodeKbdillumdown | SdlkScancodeMask,
			/// <summary>
			/// The sdlk kbdillumup sdl keycode
			/// </summary>
			SdlkKbdillumup = (int)SdlScancode.SdlScancodeKbdillumup | SdlkScancodeMask,
			/// <summary>
			/// The sdlk eject sdl keycode
			/// </summary>
			SdlkEject = (int)SdlScancode.SdlScancodeEject | SdlkScancodeMask,
			/// <summary>
			/// The sdlk sleep sdl keycode
			/// </summary>
			SdlkSleep = (int)SdlScancode.SdlScancodeSleep | SdlkScancodeMask,
			/// <summary>
			/// The sdlk app1 sdl keycode
			/// </summary>
			SdlkApp1 = (int)SdlScancode.SdlScancodeApp1 | SdlkScancodeMask,
			/// <summary>
			/// The sdlk app2 sdl keycode
			/// </summary>
			SdlkApp2 = (int)SdlScancode.SdlScancodeApp2 | SdlkScancodeMask,

			/// <summary>
			/// The sdlk audiorewind sdl keycode
			/// </summary>
			SdlkAudiorewind = (int)SdlScancode.SdlScancodeAudiorewind | SdlkScancodeMask,
			/// <summary>
			/// The sdlk audiofastforward sdl keycode
			/// </summary>
			SdlkAudiofastforward = (int)SdlScancode.SdlScancodeAudiofastforward | SdlkScancodeMask
		}
		...
		/// <summary>
		/// Sdls the clear composition
		/// </summary>
		[DllImport(NativeLibName, CallingConvention = CallingConvention.Cdecl)]
		public static extern void SDL_ClearComposition();

		/// <summary>
		/// Sdls the is text input shown
		/// </summary>
		/// <returns>The sdl bool</returns>
		[DllImport(NativeLibName, CallingConvention = CallingConvention.Cdecl)]
		public static extern SdlBool SDL_IsTextInputShown();
		...
		/// </summary>
		public const ushort SdlHapticConstant0 =	(1 << 0);
		/// <summary>
		/// The sdl haptic sine
		/// </summary>
		...
		/// </summary>
		public const ushort SdlHapticCustom1 =		(1 << 11);
		/// <summary>
		/// The sdl haptic gain
		/// </summary>
		...
		private static unsafe extern SdlBool INTERNAL_SDL_AndroidRequestPermission(
			byte* permission
		);
		/// <summary>
		...
		public struct InternalSysWmDriverUnion
		{
			...
			/// </summary>
			[FieldOffset(0)]
			public InternalKmsdrmWminfo ksmdrm;
			// private int dummy;
		}
