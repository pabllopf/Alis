...
{
    /// <summary>
    /// The gl safe external tests class
    /// </summary>
    ...
    public class GlSafeExternalTests : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GlSafeExternalTests"/> class
        /// </summary>
        ...
        /// <summary>
        /// Tests that get command throws invalid op not inited
        /// </summary>
