...
namespace Alis.Core.Graphic.Test.Constructs
{
    internal static class GlMock
    {
        ...
        internal static void Initialize()
        {
            ...
            Register("glEnable", Marshal.GetFunctionPointerForDelegate((Enable)MockEnable));
            Register("glDisable", Marshal.GetFunctionPointerForDelegate((Disable)MockDisable));
            Register("glBlendFunc", Marshal.GetFunctionPointerForDelegate((BlendFunc)MockBlendFunc));
            Register("glDrawElements", Marshal.GetFunctionPointerForDelegate((DrawElements)MockDrawElements));
        ...
        private static void MockEnable(EnableCap cap) { }
        private static void MockDisable(EnableCap cap) { }
        private static void MockBlendFunc(BlendingFactorSrc sfactor, BlendingFactorDest dfactor) { }
        private static void MockDrawElements(PrimitiveType mode, int count, DrawElementsType type, IntPtr indices) { }
    }
}
