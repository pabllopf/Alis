...
// 
//  --------------------------------------------------------------------------
//  File:FontManagerExecutionTests.cs
// 
...
{
    /// <summary>
    ///     Executes the <see cref="FontManager" /> render text overloads against a registered
    ///     assets pack and fake OpenGL function pointers so that the managed bodies complete.
    /// </summary>
    public class FontManagerExecutionTests : IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="FontManagerExecutionTests"/> class
        /// </summary>
        public FontManagerExecutionTests()
        {
            _previousActiveAssembly = SaveActiveAssembly();
            _registeredAssemblyName = "FontManagerTest_" + Guid.NewGuid().ToString("N");
        ...
        /// <summary>
        ///     Tests that render text with colors completes the default font pipeline.
        /// </summary>
        [Fact]
        public void RenderText_WithColors_Completes()
        {
        ...
        /// <summary>
        ///     Tests that render text with default colors completes the default font pipeline.
        /// </summary>
        [Fact]
        public void RenderText_WithDefaultColors_Completes()
        {
            Gl.Initialize(FakeProcAddress);
