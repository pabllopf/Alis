...
{
    /// <summary>
    /// The format helpers class
    /// </summary>
    internal static class FormatHelpers
    {
        /// <summary>
        /// Gets the element count using the specified format
        /// </summary>
        ...
        /// <summary>
        /// Gets the sample count u int 32 using the specified sample count
        /// </summary>
        ...
        /// <summary>
        /// Describes whether is stencil format
        /// </summary>
        /// <param name="format">The format</param>
        ...
        /// <summary>
        /// Describes whether is depth stencil format
        /// </summary>
        /// <param name="format">The format</param>
        /// <returns>The bool</returns>
        ...
        /// <summary>
        /// Describes whether is compressed format
        /// </summary>
        /// <param name="format">The format</param>
        /// <returns>The bool</returns>
        ...
        /// <summary>
        /// Gets the row pitch using the specified width
        /// </summary>
        ...
        /// <summary>
        /// Gets the block size in bytes using the specified format
        /// </summary>
        /// <param name="format">The format</param>
        /// <returns>The uint</returns>
        ...
        /// <summary>
        /// Describes whether is format view compatible
        /// </summary>
        /// <param name="viewFormat">The view format</param>
        /// <param name="realFormat">The real format</param>
        /// <returns>The bool</returns>
        ...
        /// <summary>
        /// Describes whether is srgb counterpart
        /// </summary>
        /// <param name="viewFormat">The view format</param>
        /// <param name="realFormat">The real format</param>
        ...
        /// <summary>
        /// Gets the num rows using the specified height
        /// </summary>
        ...
        /// <summary>
        /// Gets the depth pitch using the specified row pitch
        /// </summary>
        ...
        /// <summary>
        /// Gets the region size using the specified width
        /// </summary>
        /// <param name="width">The width</param>
        /// <param name="height">The height</param>
        ...
        /// <summary>
        /// Gets the sample count using the specified samples
        /// </summary>
        ...
        /// <summary>
        /// Gets the view family format using the specified format
        /// </summary>
        /// <param name="format">The format</param>
