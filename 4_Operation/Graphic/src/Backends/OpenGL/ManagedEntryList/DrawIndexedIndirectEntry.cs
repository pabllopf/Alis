...
{
    /// <summary>
    /// The draw indexed indirect entry class
    /// </summary>
    ...
    internal class DrawIndexedIndirectEntry : OpenGLCommandEntry
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DrawIndexedIndirectEntry"/> class
        /// </summary>
        ...
        /// <param name="drawCount">The draw count</param>
        /// <param name="stride">The stride</param>
        /// <returns>The draw indexed indirect entry</returns>
