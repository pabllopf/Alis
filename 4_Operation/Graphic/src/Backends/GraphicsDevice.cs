...
namespace Veldrid
{
    ...
    public abstract class GraphicsDevice : IDisposable
    {
        ...
        /// <summary>
        /// Validates the update texture parameters using the specified texture
        /// </summary>
        /// <param name="texture">The texture</param>
        /// <param name="sizeInBytes">The size in bytes</param>
        /// <param name="x">The </param>
        ...
        /// <param name="mipLevel">The mip level</param>
        /// <param name="arrayLayer">The array layer</param>
        /// <exception cref="VeldridException">The data size is less than expected for the given update region. At least {expectedSize} bytes must be provided, but only {sizeInBytes} were.</exception>
        /// <exception cref="VeldridException">The given region does not fit into the Texture.</exception>
        /// <exception cref="VeldridException">Updates to block-compressed textures must use a region that is block-size aligned and sized.</exception>
        /// <exception cref="VeldridException">{nameof(arrayLayer)} ({arrayLayer}) must be less than the Texture's effective array layer count ({effectiveArrayLayers}).</exception>
        /// <exception cref="VeldridException">{nameof(mipLevel)} ({mipLevel}) must be less than the Texture's mip level count ({texture.MipLevels}).</exception>
        ...
        /// <summary>
        /// Flushes the deferred disposals
        /// </summary>
