namespace Alis.Core.Graphic.Backends
{
    ...
    public class GraphicsDeviceFeatures
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphicsDeviceFeatures"/> class
        /// </summary>
        /// <param name="computeShader">The compute shader</param>
        /// <param name="geometryShader">The geometry shader</param>
        /// <param name="tessellationShaders">The tessellation shaders</param>
        /// <param name="multipleViewports">The multiple viewports</param>
        /// <param name="samplerLodBias">The sampler lod bias</param>
        /// <param name="drawBaseVertex">The draw base vertex</param>
        /// <param name="drawBaseInstance">The draw base instance</param>
        /// <param name="drawIndirect">The draw indirect</param>
        /// <param name="drawIndirectBaseInstance">The draw indirect base instance</param>
        /// <param name="fillModeWireframe">The fill mode wireframe</param>
        /// <param name="samplerAnisotropy">The sampler anisotropy</param>
        /// <param name="depthClipDisable">The depth clip disable</param>
        /// <param name="texture1D">The texture</param>
        /// <param name="independentBlend">The independent blend</param>
        /// <param name="structuredBuffer">The structured buffer</param>
        /// <param name="subsetTextureView">The subset texture view</param>
        /// <param name="commandListDebugMarkers">The command list debug markers</param>
        /// <param name="bufferRangeBinding">The buffer range binding</param>
        /// <param name="shaderFloat64">The shader float 64</param>
