...
namespace Veldrid
{
    ...
    public abstract class Pipeline : DeviceResource, IDisposable
    {
        ...
        /// </summary>
        /// <param name="graphicsDescription">The graphics description</param>
        ...
        /// Initializes a new instance of the <see cref="Pipeline"/> class
        /// </summary>
        /// <param name="computeDescription">The compute description</param>
        ...
        /// Initializes a new instance of the <see cref="Pipeline"/> class
        /// </summary>
        /// <param name="resourceLayouts">The resource layouts</param>
