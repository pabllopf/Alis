...
namespace Veldrid.Vk
{
    ...
    {
        /// <summary>
        /// Vds the to vk pixel format using the specified format
        /// </summary>
        /// <param name="format">The format</param>
        /// <param name="toDepthFormat">The to depth format</param>
        /// <exception cref="VeldridException">Invalid {nameof(PixelFormat)}: {format}</exception>
