...
namespace Alis.Core.Graphic.Backends
{
    ...
    public abstract class Framebuffer : DeviceResource, IDisposable
    {
        ...
        /// <summary>
        /// Gets an <see cref="Backends.OutputDescription"/> which describes the number and formats of the depth and color targets
        /// in this instance.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="Framebuffer"/> class
        /// </summary>
        /// <param name="depthTargetDesc">The depth target desc</param>
        /// <param name="colorTargetDescs">The color target descs</param>
        internal Framebuffer(
