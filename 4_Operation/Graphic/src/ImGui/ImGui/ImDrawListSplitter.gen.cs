...
namespace Alis.Core.Graphic.ImGui.ImGui
{
    ...
    public unsafe partial struct ImDrawListSplitterPtr
    {
        ...
        public void Merge(Graphic.ImGui.ImGui.ImDrawListPtr draw_list)
        {
        ...
        public void SetCurrentChannel(Graphic.ImGui.ImGui.ImDrawListPtr draw_list, int channel_idx)
        {
            ImDrawList* native_draw_list = draw_list.NativePtr;
        ...
        public void Split(Graphic.ImGui.ImGui.ImDrawListPtr draw_list, int count)
        {
            ImDrawList* native_draw_list = draw_list.NativePtr;
