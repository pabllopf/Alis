...
namespace Alis.Core.Graphic.Platforms.Win.Native
{
    ...
    public enum WindowExStyles : uint
    {
        ...
        Left = 0x00000000,
        /// <summary>
        /// If the shell language is Hebrew, Arabic, or another language that supports reading order alignment, the window text is displayed using right-to-left reading order.
        /// </summary>
