...
{
    /// <summary>
    ///     Advanced dialog manager with state machine, events, and conditions support
    /// </summary>
    public class DialogManagerAdvanced
    {
        /// <summary>
        ...
        public Dialog GetDialog(string id)
        {
            ...
            return _dialogs.TryGetValue(id, out Dialog dialog) ? dialog : null;
        }
