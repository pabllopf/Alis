...
namespace Alis.Extension.Math.PathGenerator.Triangulation.Delaunay.Delaunay.Sweep
{
    /// <summary>
    ...
    internal class DtSweepConstraint : TriangulationConstraint
    {
        ...
        public DtSweepConstraint(TriangulationPoint p1, TriangulationPoint p2)
        {
            ...
            else if (System.Math.Abs(p1.Y - p2.Y) < 0.01f)
            {
                if (p1.X > p2.X)
                {
                    Q = p1;
                ...
                else if (System.Math.Abs(p1.X - p2.X) < 0.01f)
                {
