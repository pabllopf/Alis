...
namespace Alis.Extension.Graphic.ImGui.Sample
{
    class ImGuiController : IDisposable
    {
        ...
        public ImGuiController(Window window, int width, int height)
        {
            _window = window;
            _windowWidth = width;
            _windowHeight = height;

            Context = Native.ImGui.CreateContext();
            Native.ImGui.SetCurrentContext(Context);

            ImGuiIoPtr io = Native.ImGui.GetIo();
        ...
        public void Render()
        {
            ...
            Native.ImGui.Render();
            RenderImDrawData(Native.ImGui.GetDrawData());
            _frameBegun = false;
        }
