...
{
    /// <summary>
    ///     Executes the view reset against the real native CSFML library.
    /// </summary>
    public class ViewExecutionTests
    {
        /// <summary>
        ...
        public void Reset_WithFloatRect_Executes()
        {
            ...
            Assert.Throws<EntryPointNotFoundException>(() => view.Reset(new FloatRect(10f, 20f, 800f, 600f)));
        }
    }
}
