...
namespace Alis.Extension.Graphic.Sfml.Test.Attributes
{
    ...
    public class RequireCSfmlWindowsFactAttribute : FactAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiresSfmlFactAttribute"/> class
        /// </summary>
        public RequireCSfmlWindowsFactAttribute()
        {
        ...
        private static bool TryLoadSfmlLibrary(string name)
        {
            ...
            string assemblyDir = Path.GetDirectoryName(typeof(RequireCSfmlSystemFactAttribute).Assembly.Location);
            if (assemblyDir == null)
                return false;
