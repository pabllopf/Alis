...
// 
//  --------------------------------------------------------------------------
//  File:SystemsLoadingFailedExceptionCoverageTests.cs
// 
...
{
    /// <summary>
    ///     Tests for the systems LoadingFailedException.
    /// </summary>
    public class SystemsLoadingFailedExceptionCoverageTests
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that the exception inherits from exception
        /// </summary>
        [Fact]
        public void LoadingFailedException_InheritsFromException()
        {
            LoadingFailedException ex = new LoadingFailedException();
