...
// 
//  --------------------------------------------------------------------------
//  File:MouseMoveEventArgsRemainingCoverageTests.cs
// 
...
{
    /// <summary>
    ///     The mouse move event args remaining coverage tests class
    /// </summary>
    public class MouseMoveEventArgsRemainingCoverageTests
    {
        /// <summary>
        ...
        public void Constructor_AssignsValuesFromEvent()
        {
            ...
            MouseMoveEventArgs args = new MouseMoveEventArgs(moveEvent);
        ...
        public void ToString_ReturnsExpectedFormat()
        {
            ...
            Assert.Contains("[MouseMoveEventArgs]", str);
