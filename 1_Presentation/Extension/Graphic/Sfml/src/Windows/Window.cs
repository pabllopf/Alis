    ...
    public class Window : ObjectBase
    {
            ...
            base(IntPtr.Zero)
        {
            ...
            try
            {
                ...
                CPointer = sfWindow_createUnicode(mode, titlePtr, style, ref settings);
            }
            finally
            {
                handle.Free();
        ...
        public virtual void SetTitle(string title)
        {
            ...
            {
                IntPtr titlePtr = handle.AddrOfPinnedObject();
                sfWindow_setUnicodeTitle(CPointer, titlePtr);
            }
            finally
            {
                handle.Free();
     ...
     public virtual void SetIcon(uint width, uint height, byte[] pixels)
     {
        ...
        ////////////////////////////////////////////////////////////
        public virtual Vector2F InternalGetMousePosition()
        {
        ...
        ////////////////////////////////////////////////////////////
        public virtual void InternalSetMousePosition(Vector2F position)
        {
        ...
        ////////////////////////////////////////////////////////////
        public virtual Vector2F InternalGetTouchPosition(uint finger)
        {
        ...
        /// <summary>
        /// Sfs the window is open using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        ...
        /// <summary>
        /// Sfs the window poll event using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        ...
        /// <summary>
        /// Sfs the window wait event using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        /// <param name="evt">The evt</param>
        /// <returns>The bool</returns>
        ...
        [DllImport(Csfml.Window, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern Vector2F sfWindow_getPosition(IntPtr cPointer);
        ...
        [DllImport(Csfml.Window, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern void sfWindow_setPosition(IntPtr cPointer, Vector2F position);
        ...
        [DllImport(Csfml.Window, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern Vector2F sfWindow_getSize(IntPtr cPointer);
        ...
        [DllImport(Csfml.Window, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern void sfWindow_setSize(IntPtr cPointer, Vector2F size);
        ...
        [DllImport(Csfml.Window, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern void sfWindow_setIcon(IntPtr cPointer, uint width, uint height, IntPtr pixels);
        ...
        /// <summary>
        /// Sfs the window set active using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        ...
        /// <summary>
        /// Sfs the window has focus using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        /// <returns>The bool</returns>
        [DllImport(Csfml.Window, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        /// <returns>The vector 2i</returns>
        [DllImport(Csfml.Window, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern Vector2F sfMouse_getPosition(IntPtr cPointer);
        ...
        /// <param name="cPointer">The pointer</param>
        [DllImport(Csfml.Window, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern void sfMouse_setPosition(Vector2F position, IntPtr cPointer);
