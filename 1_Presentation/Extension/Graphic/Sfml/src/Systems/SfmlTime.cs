...
namespace Alis.Extension.Graphic.Sfml.Systems
{
    ...
    public struct SfmlTime : IEquatable<SfmlTime>
    {
        ...
        public static SfmlTime FromMilliseconds(int milliseconds) => sfMilliseconds(milliseconds);
        ...
        public static SfmlTime FromMicroseconds(long microseconds) => sfMicroseconds(microseconds);
        ...
        public static bool operator ==(SfmlTime left, SfmlTime right) => left.Equals(right);
        ...
        public override bool Equals(object obj) => obj is SfmlTime && Equals((SfmlTime) obj);
        ...
        /// <returns>times are equal</returns>
        public bool Equals(SfmlTime other) => microseconds == other.microseconds;
        ...
        public static bool operator <(SfmlTime left, SfmlTime right) => left.AsMicroseconds() < right.AsMicroseconds();
        ...
        ////////////////////////////////////////////////////////////
        public static SfmlTime operator -(SfmlTime left, SfmlTime right) => FromMicroseconds(left.AsMicroseconds() - right.AsMicroseconds());
        ...
        ////////////////////////////////////////////////////////////
        public static SfmlTime operator *(SfmlTime left, float right) => FromSeconds(left.AsSeconds() * right);
        ...
        /// <returns>left multiplied by the right</returns>
        ////////////////////////////////////////////////////////////
        public static SfmlTime operator *(SfmlTime left, long right) => FromMicroseconds(left.AsMicroseconds() * right);
        ...
        /// <returns>left multiplied by the right</returns>
        ////////////////////////////////////////////////////////////
        public static SfmlTime operator *(float left, SfmlTime right) => FromSeconds(left * right.AsSeconds());
        ...
        /// <returns>left multiplied by the right</returns>
        ////////////////////////////////////////////////////////////
        public static SfmlTime operator *(long left, SfmlTime right) => FromMicroseconds(left * right.AsMicroseconds());
