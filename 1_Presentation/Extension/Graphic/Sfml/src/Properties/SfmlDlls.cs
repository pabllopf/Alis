...
namespace Alis.Extension.Graphic.Sfml.Properties
{
    /// <summary>
    ...
    public static class SfmlDlls
    {
        ...
        ///     The resource path
        /// </summary>
        private static readonly string ResourcePath = "Alis.Extension.Graphic.Sfml.resources";
        ...
        ///     The osx arm64 sdl2
        /// </summary>
        internal static readonly Dictionary<PlatformInfo, string> SfmlDllBytes = new Dictionary<PlatformInfo, string>
        {
            {WinX86, $"{ResourcePath}.win_x86.win-x86_sfml.zip"},
            {WinX64, $"{ResourcePath}.win_x64.win-x64_sfml.zip"},
            {WinArm, $"{ResourcePath}.win_arm.win-arm_sfml.zip"},
            {WinArm64, $"{ResourcePath}.win_arm64.win-arm64_sfml.zip"},

            {LinuxX86, $"{ResourcePath}.linux_x86.linux-x86_sfml.zip"},
            {LinuxX64, $"{ResourcePath}.linux_x64.linux-x64_sfml.zip"},
            {LinuxArm, $"{ResourcePath}.linux_arm.linux-arm_sfml.zip"},
            {LinuxArm64, $"{ResourcePath}.linux_arm64.linux-arm64_sfml.zip"},

            {OsxX86, $"{ResourcePath}.osx_x86.osx-x86_sfml.zip"},
            {OsxX64, $"{ResourcePath}.osx_x64.osx-x64_sfml.zip"},
            {OsxArm64, $"{ResourcePath}.osx_arm64.osx-arm64_sfml.zip"},
            {OsxArm, $"{ResourcePath}.osx_arm.osx-arm_sfml.zip"}
        };
    }
}