...
namespace Alis.Extension.Graphic.Sfml.Render
{
    ...
    public class VertexArray : ObjectBase, IDrawable
    {
        ...
        public void Draw(IRenderTarget target, RenderStates states)
        {
            ...
            switch (target)
            {
                case RenderWindow rw:
                    sfRenderWindow_drawVertexArray(rw.CPointer, CPointer, ref marshaledStates);
                    break;
                case RenderTexture rt:
                    sfRenderTexture_drawVertexArray(rt.CPointer, CPointer, ref marshaledStates);
                    break;
            }
        }
        ...
        /// <param name="index">The index</param>
        /// <returns>The int ptr</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl, EntryPoint = "sfVertexArray_getVertex"), SuppressUnmanagedCodeSecurity, ExcludeFromCodeCoverage]
        private static extern IntPtr sfVertexArray_getVertex_v2(IntPtr cPointer, uint index);
