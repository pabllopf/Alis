...
namespace Alis.Extension.Graphic.Sfml.Render
{
    ...
    public class RenderTexture : ObjectBase, IRenderTarget
    {
        ...
        public Vector2F Size => sfRenderTexture_getSize(CPointer);
        ...
        /// <returns>The converted point, in "world" coordinates</returns>
        public Vector2F MapPixelToCoords(Vector2F point, View view) => sfRenderTexture_mapPixelToCoords(CPointer, point, view != null ? view.CPointer : IntPtr.Zero);
        ...
        /// <param name="view">The view to use for converting the point</param>
        /// <returns>The converted point, in target coordinates (pixels)</returns>
        public Vector2F MapCoordsToPixel(Vector2F point, View view) => sfRenderTexture_mapCoordsToPixel(CPointer, point, view != null ? view.CPointer : IntPtr.Zero);
        ...
        public void Draw(Vertex[] vertices, uint start, uint count, PrimitiveType type, RenderStates states)
        {
            ...
            try
            {
                ...
                sfRenderTexture_drawPrimitives(CPointer, vertexPtr, count, type, ref marshaledStates);
            }
            finally
            {
                handle.Free();
        ...
        /// <returns>The int ptr</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern IntPtr sfRenderTexture_createWithSettings(uint width, uint height, ContextSettings settings);
        ...
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern Vector2F sfRenderTexture_getSize(IntPtr cPointer);

        /// <summary>
        ///     Sfs the render texture set active using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        ...
        /// <summary>
        ///     Sfs the render texture save gl states using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        /// <returns>The bool</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        /// <summary>
        ///     Sfs the render texture restore gl states using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        /// <returns>The bool</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        /// <summary>
        ///     Sfs the render texture display using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        /// <returns>The bool</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern Vector2F sfRenderTexture_mapCoordsToPixel(IntPtr cPointer, Vector2F point, IntPtr view);
        ...
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern Vector2F sfRenderTexture_mapPixelToCoords(IntPtr cPointer, Vector2F point, IntPtr view);
        ...
        /// <summary>
        ///     Sfs the render texture is smooth using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        /// <returns>The bool</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        /// <summary>
        ///     Sfs the render texture is repeated using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        /// <returns>The bool</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        /// <summary>
        ///     Sfs the render texture generate mipmap using the specified c pointer
        /// </summary>
        /// <param name="cPointer">The pointer</param>
        /// <returns>The bool</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern void sfRenderTexture_drawPrimitives(IntPtr cPointer, Vertex vertexPtr, uint vertexCount, PrimitiveType type, ref RenderStates.MarshalData renderStates);
        ...
        /// <param name="renderStates">The render states</param>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern void sfRenderTexture_drawPrimitives(IntPtr cPointer, IntPtr vertexPtr, uint vertexCount, PrimitiveType type, ref RenderStates.MarshalData renderStates);
