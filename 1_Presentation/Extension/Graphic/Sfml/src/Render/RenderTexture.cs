...
namespace Alis.Extension.Graphic.Sfml.Render
{
    ...
    public class RenderTexture : ObjectBase, IRenderTarget
    {
        ...
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern Vector2F sfRenderTexture_getSize(IntPtr cPointer);
        ...
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern Vector2F sfRenderTexture_mapCoordsToPixel(IntPtr cPointer, Vector2F point, IntPtr view);
        ...
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern Vector2F sfRenderTexture_mapPixelToCoords(IntPtr cPointer, Vector2F point, IntPtr view);
        ...
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern void sfRenderTexture_drawPrimitives(IntPtr cPointer, Vertex vertexPtr, uint vertexCount, PrimitiveType type, ref RenderStates.MarshalData renderStates);
        ...
        /// <param name="renderStates">The render states</param>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern void sfRenderTexture_drawPrimitives(IntPtr cPointer, IntPtr vertexPtr, uint vertexCount, PrimitiveType type, ref RenderStates.MarshalData renderStates);
