...
namespace Alis.Extension.Graphic.Sfml.Render
{
    ...
    public class Texture : ObjectBase
    {
        ...
        /// </summary>
        ////////////////////////////////////////////////////////////
        public Vector2F Size => sfTexture_getSize(CPointer);
        ...
        public void Update(byte[] pixels, float width, float height, uint x, uint y)
        {
        ...
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern Vector2F sfTexture_getSize(IntPtr texture);
        ...
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern void sfTexture_updateFromPixels(IntPtr texture, byte[] pixels, float width, float height, uint x, uint y);
        ...
        /// <param name="y">The </param>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern void sfTexture_updateFromPixels(IntPtr texture, IntPtr pixels, float width, float height, uint x, uint y);
        ...
        /// <summary>
        ///     Sfs the texture is smooth using the specified texture
        /// </summary>
        /// <param name="texture">The texture</param>
        ...
        /// <summary>
        ///     Sfs the texture is srgb using the specified texture
        /// </summary>
        /// <param name="texture">The texture</param>
        /// <returns>The bool</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        /// <summary>
        ///     Sfs the texture is repeated using the specified texture
        /// </summary>
        /// <param name="texture">The texture</param>
        /// <returns>The bool</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        /// <summary>
        ///     Sfs the texture generate mipmap using the specified texture
        /// </summary>
        /// <param name="texture">The texture</param>
        /// <returns>The bool</returns>
        [DllImport(Csfml.Graphics, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
