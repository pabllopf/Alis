...
namespace Alis.Extension.Graphic.Ui.Test.Native
{
    ...
    public class ImGuiTest
    {
        ...
        {
            int currentItem = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.Combo("label", ref currentItem, "item1\0item2\0item3\0"));
        }
        ...
        {
            int currentItem = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.Combo("label", ref currentItem, "item1\0item2\0item3\0", 10));
        }
        ...
        public void Test_CreateContext_WithSharedFontAtlas()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.CreateContext(sharedFontAtlas));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.DebugCheckVersionAndDataLayout("1.0.0", 1, 1, 1, 1, 1, 1));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.DebugTextEncoding("test"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.DockSpace(1));
        }
        ...
        public void Test_DockSpace_WithIdAndSize()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.DockSpace(1, size));
        }
        ...
        {
            Vector2F size = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DockSpace(1, size, 0));
        }
        ...
        public void Test_DockSpace_WithIdAndSizeAndFlagsAndWindowClass()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.DockSpace(1, size, 0, windowClass));
        }
        ...
        public void Test_DockSpaceOverViewport_WithViewport()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.DockSpaceOverViewport(viewport));
        }
        ...
        {
            ImGuiViewportPtr viewport = new ImGuiViewportPtr();
            Assert.Throws<DllNotFoundException>(() => ImGui.DockSpaceOverViewport(viewport, 0));
        }
        ...
        public void Test_DockSpaceOverViewport_WithViewportAndFlagsAndWindowClass()
        {
            ImGuiViewportPtr viewport = new ImGuiViewportPtr();
            ImGuiWindowClass windowClass = new ImGuiWindowClass();
            Assert.Throws<DllNotFoundException>(() => ImGui.DockSpaceOverViewport(viewport, 0, windowClass));
        }
        ...
        {
            float v = 0.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat("label", ref v, 1.0f));
        }
        ...
        {
            float v = 0.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat("label", ref v, 1.0f, 0.0f));
        }
        ...
        {
            float v = 0.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat("label", ref v, 1.0f, 0.0f, 1.0f));
        }
        ...
        {
            float v = 0.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat("label", ref v, 1.0f, 0.0f, 1.0f, "%.3f"));
        }
        ...
        {
            float v = 0.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat("label", ref v, 1.0f, 0.0f, 1.0f, "%.3f", 0));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat2("label", ref v, 1.0f));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat2("label", ref v, 1.0f, 0.0f));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat2("label", ref v, 1.0f, 0.0f, 1.0f));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat2("label", ref v, 1.0f, 0.0f, 1.0f, "%.3f"));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat2("label", ref v, 1.0f, 0.0f, 1.0f, "%.3f", 0));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat3("label", ref v, 1.0f));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat3("label", ref v, 1.0f, 0.0f));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat3("label", ref v, 1.0f, 0.0f, 1.0f));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat3("label", ref v, 1.0f, 0.0f, 1.0f, "%.3f"));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat3("label", ref v, 1.0f, 0.0f, 1.0f, "%.3f", 0));
        }
        ...
        {
            Vector4F v = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat4("label", ref v, 1.0f));
        }
        ...
        {
            Vector4F v = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat4("label", ref v, 1.0f, 0.0f));
        }
        ...
        {
            Vector4F v = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat4("label", ref v, 1.0f, 0.0f, 1.0f));
        }
        ...
        {
            Vector4F v = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat4("label", ref v, 1.0f, 0.0f, 1.0f, "%.3f"));
        }
        ...
        {
            Vector4F v = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat4("label", ref v, 1.0f, 0.0f, 1.0f, "%.3f", 0));
        }
        ...
        public void Test_DragFloatRange2_WithLabelAndVCurrentMinAndVCurrentMaxAndVSpeed()
        {
            float vCurrentMin = 0.0f;
            float vCurrentMax = 1.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloatRange2("label", ref vCurrentMin, ref vCurrentMax, 1.0f));
        }
        ...
        public void Test_DragFloatRange2_WithLabelAndVCurrentMinAndVCurrentMaxAndVSpeedAndVMin()
        {
            float vCurrentMin = 0.0f;
            float vCurrentMax = 1.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloatRange2("label", ref vCurrentMin, ref vCurrentMax, 1.0f, 0.0f));
        }
        ...
        public void Test_DragFloatRange2_WithLabelAndVCurrentMinAndVCurrentMaxAndVSpeedAndVMinAndVMax()
        {
            float vCurrentMin = 0.0f;
            float vCurrentMax = 1.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloatRange2("label", ref vCurrentMin, ref vCurrentMax, 1.0f, 0.0f, 1.0f));
        }
        ...
        public void Test_DragFloatRange2_WithLabelAndVCurrentMinAndVCurrentMaxAndVSpeedAndVMinAndVMaxAndFormat()
        {
            float vCurrentMin = 0.0f;
            float vCurrentMax = 1.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloatRange2("label", ref vCurrentMin, ref vCurrentMax, 1.0f, 0.0f, 1.0f, "%.3f"));
        }
        ...
        public void Test_DragFloatRange2_WithLabelAndVCurrentMinAndVCurrentMaxAndVSpeedAndVMinAndVMaxAndFormatAndFormatMax()
        {
            float vCurrentMin = 0.0f;
            float vCurrentMax = 1.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloatRange2("label", ref vCurrentMin, ref vCurrentMax, 1.0f, 0.0f, 1.0f, "%.3f", "%.3f"));
        }
        ...
        public void Test_DragFloatRange2_WithLabelAndVCurrentMinAndVCurrentMaxAndVSpeedAndVMinAndVMaxAndFormatAndFormatMaxAndFlags()
        {
            float vCurrentMin = 0.0f;
            float vCurrentMax = 1.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloatRange2("label", ref vCurrentMin, ref vCurrentMax, 1.0f, 0.0f, 1.0f, "%.3f", "%.3f", 0));
        }
        ...
        {
            Vector4F v = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat4("label", ref v, 0.0f, 1.0f, "%.3f", 0));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt("label", ref v, 0, 100));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt("label", ref v, 0, 100, "%d"));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt("label", ref v, 0, 100, "%d", 0));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt2("label", ref v, 0, 100));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt2("label", ref v, 0, 100, "%d"));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt2("label", ref v, 0, 100, "%d", 0));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt3("label", ref v, 0, 100));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt3("label", ref v, 0, 100, "%d"));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt3("label", ref v, 0, 100, "%d", 0));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt4("label", ref v, 0, 100));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt4("label", ref v, 0, 100, "%d"));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderInt4("label", ref v, 0, 100, "%d", 0));
        }
        ...
        public void Test_SliderScalar_WithLabelAndDataTypeAndPDataAndPMinAndPMax()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderScalar("label", ImGuiDataType.Float, pData, pMin, pMax));
        }
        ...
        public void Test_SliderScalar_WithLabelAndDataTypeAndPDataAndPMinAndPMaxAndFormat()
        {
            ...
            IntPtr pMin = IntPtr.Zero;
            IntPtr pMax = IntPtr.Zero;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderScalar("label", ImGuiDataType.Float, pData, pMin, pMax, "%.3f"));
        }
        ...
        public void Test_SliderScalar_WithLabelAndDataTypeAndPDataAndPMinAndPMaxAndFormatAndFlags()
        {
            ...
            IntPtr pMin = IntPtr.Zero;
            IntPtr pMax = IntPtr.Zero;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderScalar("label", ImGuiDataType.Float, pData, pMin, pMax, "%.3f", 0));
        }
        ...
        public void Test_SliderScalarN_WithLabelAndDataTypeAndPDataAndComponentsAndPMinAndPMax()
        {
            ...
            IntPtr pMin = IntPtr.Zero;
            IntPtr pMax = IntPtr.Zero;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderScalarN("label", ImGuiDataType.Float, pData, 4, pMin, pMax));
        }
        ...
        public void Test_SliderScalarN_WithLabelAndDataTypeAndPDataAndComponentsAndPMinAndPMaxAndFormat()
        {
            ...
            IntPtr pMin = IntPtr.Zero;
            IntPtr pMax = IntPtr.Zero;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderScalarN("label", ImGuiDataType.Float, pData, 4, pMin, pMax, "%.3f"));
        }
        ...
        public void Test_SliderScalarN_WithLabelAndDataTypeAndPDataAndComponentsAndPMinAndPMaxAndFormatAndFlags()
        {
            ...
            IntPtr pMin = IntPtr.Zero;
            IntPtr pMax = IntPtr.Zero;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderScalarN("label", ImGuiDataType.Float, pData, 4, pMin, pMax, "%.3f", 0));
        }
        ...
        public void Test_StyleColorsClassic_WithDst()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.StyleColorsClassic(dst));
        }
        ...
        {
            ImGuiStyle dst = new ImGuiStyle();
            Assert.Throws<DllNotFoundException>(() => ImGui.StyleColorsDark(dst));
        }
        ...
        {
            ImGuiStyle dst = new ImGuiStyle();
            Assert.Throws<DllNotFoundException>(() => ImGui.StyleColorsLight(dst));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.TableNextRow(0, 0.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.TableSetColumnEnabled(0, true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.MenuItem("label", true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.TableNextRow(ImGuiTableRowFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.TableNextRow(ImGuiTableRowFlags.None, 0.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.TableSetBgColor(ImGuiTableBgTarget.RowBg0, 0));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.TableSetBgColor(ImGuiTableBgTarget.RowBg0, 0, 0));
        }
