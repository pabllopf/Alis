...
namespace Alis.Extension.Graphic.Ui.Test.Native
{
    ...
    public class ImGuiTestP7
    {
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PopStyleColor(1));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PopStyleVar(1));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ProgressBar(0.5f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ProgressBar(0.5f, new Vector2F(100, 20)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ProgressBar(0.5f, new Vector2F(100, 20), "Overlay"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushAllowKeyboardFocus(true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushButtonRepeat(true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushClipRect(new Vector2F(0, 0), new Vector2F(100, 100), true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushFont(new ImFontPtr(IntPtr.Zero)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushId("test"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushId(1));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushItemWidth(100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushStyleColor(ImGuiCol.Text, 0xFFFFFFFF));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushStyleColor(ImGuiCol.Text, new Vector4F(1, 1, 1, 1)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushStyleVar(ImGuiStyleVar.Alpha, 1.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushStyleVar(ImGuiStyleVar.WindowPadding, new Vector2F(1, 1)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.PushTextWrapPos(100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.RadioButton("label", true));
        }
        ...
        {
            int v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.RadioButton("label", ref v, 1));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ResetMouseDragDelta(ImGuiMouseButton.Left));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SameLine(100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SameLine(100.0f, 10.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SaveIniSettingsToDisk("test.ini"));
        }
        ...
        {
            Assert.Throws<MarshalDirectiveException>(() => ImGui.SaveIniSettingsToMemory(out uint _));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Selectable("label", true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Selectable("label", true, ImGuiSelectableFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Selectable("label", true, ImGuiSelectableFlags.None, new Vector2F(100, 20)));
        }
        ...
        {
            bool selected = true;
            Assert.Throws<DllNotFoundException>(() => ImGui.Selectable("label", ref selected));
        }
        ...
        {
            bool selected = true;
            Assert.Throws<DllNotFoundException>(() => ImGui.Selectable("label", ref selected, ImGuiSelectableFlags.None));
        }
        ...
        {
            bool selected = true;
            Assert.Throws<DllNotFoundException>(() => ImGui.Selectable("label", ref selected, ImGuiSelectableFlags.None, new Vector2F(100, 20)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetClipboardText("text"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetColorEditOptions(ImGuiColorEditFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetColumnOffset(0, 100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetColumnWidth(0, 100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetCursorPos(new Vector2F(100, 100)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetCursorPosX(100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetCursorPosY(100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetCursorScreenPos(new Vector2F(100, 100)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetDragDropPayload("type", IntPtr.Zero, 0));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetDragDropPayload("type", IntPtr.Zero, 0, ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetMouseCursor(ImGuiMouseCursor.Arrow));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextFrameWantCaptureKeyboard(true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextFrameWantCaptureMouse(true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextItemOpen(true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextItemOpen(true, ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextItemWidth(100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowBgAlpha(1.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowClass(new ImGuiWindowClass()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowCollapsed(true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowCollapsed(true, ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowContentSize(new Vector2F(100, 100)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowDockId(1));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowDockId(1, ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowPos(new Vector2F(100, 100)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowPos(new Vector2F(100, 100), ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowPos(new Vector2F(100, 100), ImGuiCond.None, new Vector2F(0.5f, 0.5f)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowScroll(new Vector2F(100, 100)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowSize(new Vector2F(100, 100)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowSize(new Vector2F(100, 100), ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowSizeConstraints(new Vector2F(100, 100), new Vector2F(200, 200)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowSizeConstraints(new Vector2F(100, 100), new Vector2F(200, 200), null));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowSizeConstraints(new Vector2F(100, 100), new Vector2F(200, 200), null, IntPtr.Zero));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetNextWindowViewport(1));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetScrollFromPosX(100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetScrollFromPosX(100.0f, 0.5f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetScrollFromPosY(100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetScrollFromPosY(100.0f, 0.5f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetScrollHereX(0.5f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetScrollHereY(0.5f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetScrollX(100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetScrollY(100.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetStateStorage(new ImGuiStorage()));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => ImGui.SetTabItemClosed(null));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => ImGui.SetTooltip(null));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetWindowCollapsed(true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetWindowCollapsed(true, ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => ImGui.SetWindowCollapsed(null, true));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => ImGui.SetWindowCollapsed(null, true, ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => ImGui.SetWindowFocus(null));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetWindowFontScale(1.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetWindowPos(new Vector2F()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetWindowPos(new Vector2F(), ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => ImGui.SetWindowPos(null, new Vector2F()));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => ImGui.SetWindowPos(null, new Vector2F(), ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetWindowSize(new Vector2F()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.SetWindowSize(new Vector2F(), ImGuiCond.None));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => ImGui.SetWindowSize(null, new Vector2F()));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => ImGui.SetWindowSize(null, new Vector2F(), ImGuiCond.None));
        }
        ...
        {
            bool selected = false;
            Assert.Throws<DllNotFoundException>(() => ImGui.MenuItem("label", "shortcut", ref selected, true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.OpenPopup("strId"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.OpenPopup("strId", ImGuiPopupFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.OpenPopup(1u));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.OpenPopup(1u, ImGuiPopupFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.OpenPopupOnItemClick("strId"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.OpenPopupOnItemClick("strId", ImGuiPopupFlags.None));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotHistogram("label", ref values, 1));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotHistogram("label", ref values, 1, 0));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotHistogram("label", ref values, 1, 0, "overlay"));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotHistogram("label", ref values, 1, 0, "overlay", 0.0f));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotHistogram("label", ref values, 1, 0, "overlay", 0.0f, 1.0f));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotHistogram("label", ref values, 1, 0, "overlay", 0.0f, 1.0f, new Vector2F()));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotHistogram("label", ref values, 1, 0, "overlay", 0.0f, 1.0f, new Vector2F(), 4));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotLines("label", ref values, 1));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotLines("label", ref values, 1, 0));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotLines("label", ref values, 1, 0, "overlay"));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotLines("label", ref values, 1, 0, "overlay", 0.0f));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotLines("label", ref values, 1, 0, "overlay", 0.0f, 1.0f));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotLines("label", ref values, 1, 0, "overlay", 0.0f, 1.0f, new Vector2F()));
        }
        ...
        {
            float values = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.PlotLines("label", ref values, 1, 0, "overlay", 0.0f, 1.0f, new Vector2F(), 4));
        }
