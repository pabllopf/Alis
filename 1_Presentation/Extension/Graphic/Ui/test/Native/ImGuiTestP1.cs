...
namespace Alis.Extension.Graphic.Ui.Test.Native
{
    ...
    public class ImGuiTestP1
    {
        ...
        {
            int currentItem = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.Combo("label", ref currentItem, "items"));
        }
        ...
        {
            int currentItem = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.Combo("label", ref currentItem, "items", 10));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.DebugCheckVersionAndDataLayout("version", 1, 1, 1, 1, 1, 1));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.DebugTextEncoding("text"));
        }
        ...
        {
            float v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat("label", ref v, 1.0f, 0.0f, 1.0f, "format"));
        }
        ...
        {
            float v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat("label", ref v, 1.0f, 0.0f, 1.0f, "format", 0));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat2("label", ref v, 1.0f, 0.0f, 1.0f, "format"));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat2("label", ref v, 1.0f, 0.0f, 1.0f, "format", 0));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat3("label", ref v, 1.0f, 0.0f, 1.0f, "format"));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat3("label", ref v, 1.0f, 0.0f, 1.0f, "format", 0));
        }
        ...
        {
            Vector4F v = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat4("label", ref v, 1.0f, 0.0f, 1.0f, "format"));
        }
        ...
        {
            Vector4F v = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloat4("label", ref v, 1.0f, 0.0f, 1.0f, "format", 0));
        }
        ...
        public void DragFloatRange2_ShouldThrowDllNotFoundException_v5()
        {
            float vCurrentMin = 0;
            float vCurrentMax = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloatRange2("label", ref vCurrentMin, ref vCurrentMax, 1.0f, 0.0f, 1.0f, "format"));
        }
        ...
        public void DragFloatRange2_ShouldThrowDllNotFoundException_v6()
        {
            float vCurrentMin = 0;
            float vCurrentMax = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragFloatRange2("label", ref vCurrentMin, ref vCurrentMax, 1.0f, 0.0f, 1.0f, "format", "formatMax"));
        }
