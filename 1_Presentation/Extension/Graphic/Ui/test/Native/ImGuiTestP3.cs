...
namespace Alis.Extension.Graphic.Ui.Test.Native
{
    ...
    public class ImGuiTestP3
    {
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.FindViewportById(1));
        }
        ...
        public void GetBackgroundDrawList_WithViewport_ThrowsDllNotFoundException()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.GetBackgroundDrawList(viewport));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetColorU32(ImGuiCol.Text));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetColorU32(ImGuiCol.Text, 1.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetColorU32(new Vector4F(1, 1, 1, 1)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetColorU32(0xFFFFFFFF));
        }
        ...
        {
            ImGuiViewportPtr viewport = new ImGuiViewportPtr(IntPtr.Zero);
            Assert.Throws<DllNotFoundException>(() => ImGui.GetForegroundDrawList(viewport));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetId("test"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetKeyIndex(ImGuiKey.Tab));
        }
        ...
        {
            Assert.Throws<MarshalDirectiveException>(() => ImGui.GetKeyName(ImGuiKey.Tab));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetKeyPressedAmount(ImGuiKey.Tab, 0.0f, 0.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetMouseClickedCount(ImGuiMouseButton.Left));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetMouseDragDelta(ImGuiMouseButton.Left));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetMouseDragDelta(ImGuiMouseButton.Left, 0.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetStyle());
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.GetStyleColorVec4(ImGuiCol.Text));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Image(IntPtr.Zero, new Vector2F(1, 1)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Image(IntPtr.Zero, new Vector2F(1, 1), new Vector2F(0, 0)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Image(IntPtr.Zero, new Vector2F(1, 1), new Vector2F(0, 0), new Vector2F(1, 1)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Image(IntPtr.Zero, new Vector2F(1, 1), new Vector2F(0, 0), new Vector2F(1, 1), new Vector4F(1, 1, 1, 1)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Image(IntPtr.Zero, new Vector2F(1, 1), new Vector2F(0, 0), new Vector2F(1, 1), new Vector4F(1, 1, 1, 1), new Vector4F(0, 0, 0, 0)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ImageButton("test", IntPtr.Zero, new Vector2F(1, 1)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ImageButton("test", IntPtr.Zero, new Vector2F(1, 1), new Vector2F(0, 0)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ImageButton("test", IntPtr.Zero, new Vector2F(1, 1), new Vector2F(0, 0), new Vector2F(1, 1)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ImageButton("test", IntPtr.Zero, new Vector2F(1, 1), new Vector2F(0, 0), new Vector2F(1, 1), new Vector4F(0, 0, 0, 0)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ImageButton("test", IntPtr.Zero, new Vector2F(1, 1), new Vector2F(0, 0), new Vector2F(1, 1), new Vector4F(0, 0, 0, 0), new Vector4F(1, 1, 1, 1)));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Indent(1.0f));
        }
        ...
        {
            double v = 0.0;
            Assert.Throws<DllNotFoundException>(() => ImGui.InputDouble("test", ref v));
        }
        ...
        {
            double v = 0.0;
            Assert.Throws<DllNotFoundException>(() => ImGui.InputDouble("test", ref v, 1.0));
        }
        ...
        {
            double v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.InputDouble("label", ref v, 1.0, 1.0));
        }
        ...
        {
            double v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.InputDouble("label", ref v, 1.0, 1.0, "%f"));
        }
        ...
        {
            double v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.InputDouble("label", ref v, 1.0, 1.0, "%f", ImGuiInputTextFlags.None));
        }
        ...
        {
            float v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.InputFloat("label", ref v, 1.0f));
        }
        ...
        {
            float v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.InputFloat("label", ref v, 1.0f, 1.0f));
        }
        ...
        {
            float v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.InputFloat("label", ref v, 1.0f, 1.0f, "%f"));
        }
        ...
        {
            float v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.InputFloat("label", ref v, 1.0f, 1.0f, "%f", ImGuiInputTextFlags.None));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.InputFloat2("label", ref v, "%f"));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.InputFloat2("label", ref v, "%f", ImGuiInputTextFlags.None));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.InputFloat3("label", ref v, "%f"));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.InputFloat3("label", ref v, "%f", ImGuiInputTextFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.DragScalarN("label", ImGuiDataType.Float, IntPtr.Zero, 1, 1.0f, IntPtr.Zero, IntPtr.Zero));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.DragScalarN("label", ImGuiDataType.Float, IntPtr.Zero, 1, 1.0f, IntPtr.Zero, IntPtr.Zero, "format"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.DragScalarN("label", ImGuiDataType.Float, IntPtr.Zero, 1, 1.0f, IntPtr.Zero, IntPtr.Zero, "format", ImGuiSliderFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Dummy(new Vector2F(1.0f, 1.0f)));
        }
        ...
        {
            int vMin = 0, vMax = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragIntRange2("label", ref vMin, ref vMax));
        }
        ...
        {
            int vMin = 0, vMax = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragIntRange2("label", ref vMin, ref vMax, 1.0f));
        }
        ...
        {
            int vMin = 0, vMax = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragIntRange2("label", ref vMin, ref vMax, 1.0f, 0));
        }
        ...
        {
            int vMin = 0, vMax = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragIntRange2("label", ref vMin, ref vMax, 1.0f, 0, 100));
        }
        ...
        {
            int vMin = 0, vMax = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragIntRange2("label", ref vMin, ref vMax, 1.0f, 0, 100, "%d"));
        }
        ...
        {
            int vMin = 0, vMax = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.DragIntRange2("label", ref vMin, ref vMax, 1.0f, 0, 100, "%d", "%d", ImGuiSliderFlags.None));
        }
    }
}