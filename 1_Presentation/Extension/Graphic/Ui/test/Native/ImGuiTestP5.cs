...
namespace Alis.Extension.Graphic.Ui.Test.Native
{
    ...
    public class ImGuiTestP5
    {
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.AcceptDragDropPayload("type"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.AcceptDragDropPayload("type", ImGuiDragDropFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ArrowButton("strId", ImGuiDir.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Begin("name"));
        }
        ...
        {
            bool pOpen = true;
            Assert.Throws<DllNotFoundException>(() => ImGui.Begin("name", ref pOpen));
        }
        ...
        {
            bool pOpen = true;
            Assert.Throws<DllNotFoundException>(() => ImGui.Begin("name", ref pOpen, ImGuiWindowFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginChild("strId"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginChild("strId", new Vector2F()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginChild("strId", new Vector2F(), true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginChild("strId", new Vector2F(), true, ImGuiWindowFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginChild(1u));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginChild(1u, new Vector2F()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginChild(1u, new Vector2F(), true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginChild(1u, new Vector2F(), true, ImGuiWindowFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginChildFrame(1u, new Vector2F()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginChildFrame(1u, new Vector2F(), ImGuiWindowFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginCombo("label", "previewValue"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginCombo("label", "previewValue", ImGuiComboFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginDisabled(true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginDragDropSource(ImGuiDragDropFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginListBox("label", new Vector2F()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginMenu("label", true));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopup("strId"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopup("strId", ImGuiWindowFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopupContextItem("strId"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopupContextItem("strId", ImGuiPopupFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopupContextVoid("strId"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopupContextVoid("strId", ImGuiPopupFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopupContextWindow("strId"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopupContextWindow("strId", ImGuiPopupFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopupModal("name"));
        }
        ...
        {
            bool pOpen = true;
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopupModal("name", ref pOpen));
        }
        ...
        {
            bool pOpen = true;
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginPopupModal("name", ref pOpen, ImGuiWindowFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginTabBar("strId"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginTabBar("strId", ImGuiTabBarFlags.None));
        }
        ...
        {
            bool pOpen = true;
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginTabItem("label", ref pOpen, ImGuiTabItemFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginTable("strId", 1));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginTable("strId", 1, ImGuiTableFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginTable("strId", 1, ImGuiTableFlags.None, new Vector2F()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BeginTable("strId", 1, ImGuiTableFlags.None, new Vector2F(), 0.0f));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.BulletText("fmt"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Button("label", new Vector2F()));
        }
        ...
        {
            int flags = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.CheckboxFlags("label", ref flags, 1));
        }
        ...
        {
            uint flags = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.CheckboxFlags("label", ref flags, 1u));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.CollapsingHeader("label", ImGuiTreeNodeFlags.None));
        }
        ...
        {
            bool pVisible = true;
            Assert.Throws<DllNotFoundException>(() => ImGui.CollapsingHeader("label", ref pVisible, ImGuiTreeNodeFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorButton("descId", new Vector4F()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorButton("descId", new Vector4F(), ImGuiColorEditFlags.None));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorButton("descId", new Vector4F(), ImGuiColorEditFlags.None, new Vector2F()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorConvertFloat4ToU32(new Vector4F()));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorConvertHsVtoRgb(0.0f, 0.0f, 0.0f, out float outR, out float outG, out float outB));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorConvertRgBtoHsv(0.0f, 0.0f, 0.0f, out float outH, out float outS, out float outV));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorConvertU32ToFloat4(0u));
        }
        ...
        {
            Vector3F col = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorEdit3("label", ref col, ImGuiColorEditFlags.None));
        }
        ...
        public void ColorEdit4_WithLabelAndRefVector4_ThrowsDllNotFoundException()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorEdit4(Marshal.StringToHGlobalAnsi("label"), ref col));
        }
        ...
        {
            Vector4F col = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorEdit4(Marshal.StringToHGlobalAnsi("label"), ref col, ImGuiColorEditFlags.None));
        }
        ...
        {
            Vector3F col = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorPicker3("label", ref col, ImGuiColorEditFlags.None));
        }
        ...
        {
            Vector4F col = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorPicker4("label", ref col, ImGuiColorEditFlags.None));
        }
        ...
        public void ColorPicker4_WithLabelRefVector4FlagsAndRefCol_ThrowsDllNotFoundException()
        {
            Vector4F col = new Vector4F();
            float refCol = 0.0f;
            Assert.Throws<DllNotFoundException>(() => ImGui.ColorPicker4("label", ref col, ImGuiColorEditFlags.None, ref refCol));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Columns(1));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Columns(1, "id"));
        }
        ...
        {
            Assert.Throws<DllNotFoundException>(() => ImGui.Columns(1, "id", true));
        }
        ...
        public void Combo_ThrowsDllNotFoundException()
        {
            Assert.Throws<MarshalDirectiveException>(() =>
            {
                ...
                return ImGui.Combo("label", ref currentItem, new[] {"item1", "item2"}, 2);
            });
        }
        ...
        public void Combo_WithPopupMaxHeightInItems_ThrowsDllNotFoundException()
        {
            ...
            {
                int currentItem = int.MinValue;
                return ImGui.Combo("label", ref currentItem, new[] {"item1", "item2"}, 2, 10);
            });
        }
    }
}