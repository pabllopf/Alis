...
namespace Alis.Extension.Graphic.Ui.Test.Native
{
    ...
    public class ImGuiTestP8
    {
        ...
        public void ShowStyleEditor_ShouldThrowDllNotFoundException_v2()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.ShowStyleEditor(style));
        }
        ...
        {
            float vRad = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderAngle("label", ref vRad, -360.0f));
        }
        ...
        {
            float vRad = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderAngle("label", ref vRad, -360.0f, 360.0f));
        }
        ...
        {
            float vRad = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderAngle("label", ref vRad, -360.0f, 360.0f, "%.0f deg"));
        }
        ...
        {
            float vRad = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderAngle("label", ref vRad, -360.0f, 360.0f, "%.0f deg", 0));
        }
        ...
        {
            float v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat("label", ref v, 0.0f, 1.0f));
        }
        ...
        {
            float v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat("label", ref v, 0.0f, 1.0f, "%.3f"));
        }
        ...
        {
            float v = 0;
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat("label", ref v, 0.0f, 1.0f, "%.3f", 0));
        }
        ...
        public void SliderFloat2_ShouldThrowDllNotFoundException_v1()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat2("label", ref v, 0.0f, 1.0f));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat2("label", ref v, 0.0f, 1.0f, "%.3f"));
        }
        ...
        {
            Vector2F v = new Vector2F();
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat2("label", ref v, 0.0f, 1.0f, "%.3f", 0));
        }
        ...
        public void SliderFloat3_ShouldThrowDllNotFoundException_v1()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat3("label", ref v, 0.0f, 1.0f));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat3("label", ref v, 0.0f, 1.0f, "%.3f"));
        }
        ...
        {
            Vector3F v = new Vector3F();
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat3("label", ref v, 0.0f, 1.0f, "%.3f", 0));
        }
        ...
        public void SliderFloat4_ShouldThrowDllNotFoundException_v1()
        {
            ...
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat4("label", ref v, 0.0f, 1.0f));
        }
        ...
        {
            Vector4F v = new Vector4F();
            Assert.Throws<DllNotFoundException>(() => ImGui.SliderFloat4("label", ref v, 0.0f, 1.0f, "%.3f"));
        }
    }
}