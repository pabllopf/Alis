...
// 
//  --------------------------------------------------------------------------
//  File:NullTerminatedStringCoreTests.cs
// 
...
{
    /// <summary>
    ///     The null terminated string core tests class
    /// </summary>
    public class NullTerminatedStringCoreTests
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that constructor with byte array should allocate copy and terminate
        /// </summary>
        [Fact]
        public void Constructor_WithByteArray_ShouldAllocateCopyAndTerminate()
        {
        ...
        /// <summary>
        ///     Tests that constructor with empty byte array should allocate only terminator
        /// </summary>
        [Fact]
        public void Constructor_WithEmptyByteArray_ShouldAllocateOnlyTerminator()
        {
        ...
        /// <summary>
        ///     Tests that to string with immediate terminator returns empty string
        /// </summary>
        [Fact]
        public void ToString_WithImmediateTerminator_ReturnsEmptyString()
        {
        ...
        /// <summary>
        ///     Tests that to string with valid null terminated data returns expected string
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     Tests that to string with unicode data returns expected string
        /// </summary>
        [Fact]
