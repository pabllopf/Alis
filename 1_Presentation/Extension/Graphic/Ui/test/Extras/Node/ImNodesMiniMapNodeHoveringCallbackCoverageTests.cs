...
//
//  --------------------------------------------------------------------------
//  File:ImNodesMiniMapNodeHoveringCallbackCoverageTests.cs
//
...
{
    /// <summary>
    ///     Provides additional coverage for <see cref="ImNodesMiniMapNodeHoveringCallback" /> class.
    /// </summary>
    public class ImNodesMiniMapNodeHoveringCallbackCoverageTests
    {
        /// <summary>
        ...
        {
            ImNodesMiniMapNodeHoveringCallback first = new ImNodesMiniMapNodeHoveringCallback();
            ImNodesMiniMapNodeHoveringCallback second = new ImNodesMiniMapNodeHoveringCallback();
