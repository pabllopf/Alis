...
namespace Alis.Extension.Graphic.Ui.Test.Extras.Plot
{
    ...
    public class ImPlotInputMapTest
    {
        ...
        {
            ImPlotInputMap inputMap = new ImPlotInputMap();
            Ui.Extras.Plot.ImGuiModFlags value = Ui.Extras.Plot.ImGuiModFlags.Ctrl;
        ...
        {
            ImPlotInputMap inputMap = new ImPlotInputMap();
            Ui.Extras.Plot.ImGuiModFlags value = Ui.Extras.Plot.ImGuiModFlags.Shift;
        ...
        {
            ImPlotInputMap inputMap = new ImPlotInputMap();
            Ui.Extras.Plot.ImGuiModFlags value = Ui.Extras.Plot.ImGuiModFlags.Alt;
