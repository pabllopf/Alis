    ...
    public class CubeSample
    {
        ...
        public void Run()
        {
            ...
            try
            {
                ...
                Gl.GlBufferData(BufferTarget.ArrayBuffer, new IntPtr(vertices.Length * sizeof(float)), vPointer, BufferUsageHint.StaticDraw);
            }
            finally
            {
            ...
            try
            {
                ...
                Gl.GlBufferData(BufferTarget.ElementArrayBuffer, new IntPtr(indices.Length * sizeof(uint)), iPointer, BufferUsageHint.StaticDraw);
            }
            finally
            {
