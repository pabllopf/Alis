...
namespace Alis.Extension.Graphic.Glfw.Test
{
    ...
    public class NativeWindowTests : IDisposable
    {
        ...
        /// <summary>
        ///     Natives the window size get returns size
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_Size_Get_ReturnsSize()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
        ...
        /// <summary>
        ///     Natives the window size set updates size
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_Size_Set_UpdatesSize()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
        ...
        /// <summary>
        ///     Natives the window bind callbacks does not throw
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_BindCallbacks_DoesNotThrow()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
        ...
        /// <summary>
        ///     Natives the window on file drop with count zero does not throw
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_OnFileDrop_WithCountZero_DoesNotThrow()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");

            window.OnFileDrop(0, IntPtr.Zero);

            Assert.NotNull(window);
        }

        /// <summary>
        ///     Natives the window on file drop with count one does not throw
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_OnFileDrop_WithCountOne_DoesNotThrow()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
            IntPtr strPtr = Marshal.StringToCoTaskMemUTF8("test.txt");
            IntPtr arrayPtr = Marshal.AllocCoTaskMem(IntPtr.Size);
            Marshal.WriteIntPtr(arrayPtr, strPtr);

            window.OnFileDrop(1, arrayPtr);
        ...
        /// <summary>
        ///     Natives the window on file drop triggers file drop event
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_OnFileDrop_TriggersFileDropEvent()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
            bool fired = false;
            window.FileDrop += (_, _) => fired = true;
            IntPtr strPtr = Marshal.StringToCoTaskMemUTF8("test.txt");
            IntPtr arrayPtr = Marshal.AllocCoTaskMem(IntPtr.Size);
            Marshal.WriteIntPtr(arrayPtr, strPtr);
        ...
        /// <summary>
        ///     Natives the window set monitor with refresh rate does not throw
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_SetMonitor_WithRefreshRate_DoesNotThrow()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");

            window.SetMonitor(Monitor.None, 0, 0, 800, 600, 60);

            Assert.NotNull(window);
        }

        /// <summary>
        ///     Natives the window multiple dispose does not throw
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_MultipleDispose_DoesNotThrow()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
        ...
        /// <summary>
        ///     Natives the window equals with different window returns false
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_Equals_WithDifferentWindow_ReturnsFalse()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
            using NativeWindow other = new NativeWindow(800, 600, "Other");

            bool result = window.Equals(other);

            Assert.False(result);
        }

        /// <summary>
        ///     Natives the window size changed event fires on client size change
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_SizeChanged_EventFiresOnClientSizeChange()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
            bool fired = false;
            window.SizeChanged += (_, _) => fired = true;
        ...
        /// <summary>
        ///     Natives the window maximize changed event fires on maximize
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_MaximizeChanged_EventFiresOnMaximize()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
            bool fired = false;
            window.MaximizeChanged += (_, _) => fired = true;
        ...
        /// <summary>
        ///     Natives the window position changed event fires on position set
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_PositionChanged_EventFiresOnPositionSet()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
            bool fired = false;
            window.PositionChanged += (_, _) => fired = true;
        ...
        /// <summary>
        ///     Natives the window center on screen when maximized does not change position
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_CenterOnScreen_WhenMaximized_DoesNotChangePosition()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
            window.Maximized = true;
            Point posBefore = window.Position;

            window.CenterOnScreen();

            Point posAfter = window.Position;
            Assert.Equal(posBefore, posAfter);
        }

        /// <summary>
        ///     Natives the window closing event can cancel prevents is closing
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_Closing_Event_CanCancel_PreventsIsClosing()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
        ...
        /// <summary>
        ///     Natives the window release handle returns true for valid window
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_ReleaseHandle_ReturnsTrue()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
            window.Close();
        ...
        /// <summary>
        ///     Natives the window focus changed event fires on focus
        /// </summary>
        [RequiresDisplay]
        public void NativeWindow_FocusChanged_EventFiresOnFocus()
        {
            GlfwNative.WindowHint(Hint.Visible, false);
            window = new NativeWindow(800, 600, "Test");
            bool fired = false;
            window.FocusChanged += (_, _) => fired = true;
