...
namespace Alis.Extension.Graphic.Sdl2Image.Properties
{
    /// <summary>
    ///     The im gui dlls class
    /// </summary>
    public static class Sdl2ImageDlls
    {
        /// <summary>
        ///     The resource path
        /// </summary>
        ...
        ///     The resource path
        /// </summary>
        internal static readonly Dictionary<PlatformInfo, string> GlSdlImageDllBytes = new Dictionary<PlatformInfo, string>
        {
            {WinX86, $"{ResourcePath}.win_x86.win-x86_sdl2_image.zip"},
            {WinX64, $"{ResourcePath}.win_x64.win-x64_sdl2_image.zip"},
            {WinArm64, $"{ResourcePath}.win_arm.win-arm_sdl2_image.zip"},
            {WinArm, $"{ResourcePath}.win_arm64.win-arm64_sdl2_image.zip"},

            {LinuxX86, $"{ResourcePath}.linux_x86.linux-x86_sdl2_image.zip"},
            {LinuxX64, $"{ResourcePath}.linux_x64.linux-x64_sdl2_image.zip"},
            {LinuxArm, $"{ResourcePath}.linux_arm.linux-arm_sdl2_image.zip"},
            {LinuxArm64, $"{ResourcePath}.linux_arm64.linux-arm64_sdl2_image.zip"},

            {OsxX86, $"{ResourcePath}.osx_x86.osx-x86_sdl2_image.zip"},
            {OsxX64, $"{ResourcePath}.osx_x64.osx-x64_sdl2_image.zip"},
            {OsxArm, $"{ResourcePath}.osx_arm.osx-arm_sdl2_image.zip"},
            {OsxArm64, $"{ResourcePath}.osx_arm64.osx-arm64_sdl2_image.zip"}
        };
    }
}