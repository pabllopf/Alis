...
// 
//  --------------------------------------------------------------------------
//  File:InternalX11WmInfoCoverageTests.cs
// 
...
{
    /// <summary>
    ///     The internal x11 wm info coverage tests class
    /// </summary>
    public class InternalX11WmInfoCoverageTests
    {
        /// <summary>
        ...
        {
            InternalX11WmInfo info = default(InternalX11WmInfo);
        ...
        {
            InternalX11WmInfo original = new InternalX11WmInfo { Display = new IntPtr(100) };
