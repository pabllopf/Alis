...
// 
//  --------------------------------------------------------------------------
//  File:InternalAndroidWmInfoCoverageTests.cs
// 
...
{
    /// <summary>
    ///     The internal android wm info coverage tests class
    /// </summary>
    public class InternalAndroidWmInfoCoverageTests
    {
        /// <summary>
        ...
        {
            InternalAndroidWmInfo info = default(InternalAndroidWmInfo);
