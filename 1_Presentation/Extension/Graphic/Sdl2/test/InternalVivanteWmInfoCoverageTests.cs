...
// 
//  --------------------------------------------------------------------------
//  File:InternalVivanteWmInfoCoverageTests.cs
// 
...
{
    /// <summary>
    ///     The internal vivante wm info coverage tests class
    /// </summary>
    public class InternalVivanteWmInfoCoverageTests
    {
        /// <summary>
        ...
        {
            InternalVivanteWmInfo info = default(InternalVivanteWmInfo);
        ...
        {
            InternalVivanteWmInfo original = new InternalVivanteWmInfo { Display = new IntPtr(100) };
