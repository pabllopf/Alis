...
// 
//  --------------------------------------------------------------------------
//  File:InternalWaylandWmInfoRemainingCoverageTests.cs
// 
...
{
    /// <summary>
    ///     The internal wayland wm info remaining coverage tests class
    /// </summary>
    public class InternalWaylandWmInfoRemainingCoverageTests
    {
        /// <summary>
        ...
        {
            InternalWaylandWmInfo info = default(InternalWaylandWmInfo);
        ...
        /// <summary>
        ///     Tests that is value type copy is independent
        /// </summary>
        [Fact]
