...
// 
//  --------------------------------------------------------------------------
//  File:VideoPlayerNoFfmpegCoverageTests.cs
// 
...
{
    /// <summary>
    ///     Coverage tests for VideoPlayer that do not require FFmpeg/ffplay.
    /// </summary>
    public class VideoPlayerNoFfmpegCoverageTests : IDisposable
    {
        /// <summary>
        ///     The player
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="VideoPlayerNoFfmpegCoverageTests"/> class
        /// </summary>
        public VideoPlayerNoFfmpegCoverageTests()
        {
        ...
        /// <summary>
        ///     Tests that constructor with custom executable sets fields
        /// </summary>
        [Fact]
        public void Constructor_WithCustomExecutable_SetsFields()
        {
            VideoPlayer player = new VideoPlayer("test.mp4", "custom-ffplay");
            Assert.Equal("test.mp4", player.Filename);
        ...
        /// <summary>
        ///     Tests that Dispose with exited process completes safely
        /// </summary>
        [Fact]
        public void Dispose_ProcessExited_CompletesSafely()
        {
            VideoPlayer player = new VideoPlayer("test.mp4");
        ...
        {
            VideoPlayer player = new VideoPlayer(null, "my-ffplay");
            FieldInfo ffplayField = typeof(VideoPlayer).GetField("ffplay",
                BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        /// <summary>
        ///     Tests that Filename is null for default constructor
        /// </summary>
        [Fact]
        public void Filename_Default_IsNull()
        {
            VideoPlayer player = new VideoPlayer();
            Assert.Null(player.Filename);
            player.Dispose();
        ...
        /// <summary>
        ///     Tests that Filename is set for constructor with input
        /// </summary>
        [Fact]
        public void Filename_WithInput_IsSet()
        {
            VideoPlayer player = new VideoPlayer("video.avi");
            Assert.Equal("video.avi", player.Filename);
            player.Dispose();
        }

        /// <summary>
        ///     Tests that InputDataStream is null initially
        /// </summary>
        [Fact]
        public void InputDataStream_Default_IsNull()
        {
            VideoPlayer player = new VideoPlayer();
