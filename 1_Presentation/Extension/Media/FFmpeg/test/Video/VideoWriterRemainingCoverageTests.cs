...
namespace Alis.Extension.Media.FFmpeg.Test.Video
{
    ...
    public class VideoWriterRemainingCoverageTests : IDisposable
    {
        ...
        public void Dispose_WhenOpenedForWriting_ShouldCallCloseWrite()
        {
            ...
            // Set up internal state via reflection so Dispose sees OpenedForWriting = true
            ...
            // Create a process that has already exited so CloseWrite doesn't hang
        ...
        #region OpenWrite Guard Coverage
        ...
        public void OpenWrite_AlreadyOpened_ShouldThrowInvalidOperationException()
        {
            ...
            Assert.Contains("already opened", exception.Message, StringComparison.OrdinalIgnoreCase);

            // Reset state before dispose to avoid CloseWrite throwing
