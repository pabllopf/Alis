...
{
    /// <summary>
    ///     The events order probe test class
    /// </summary>
    public class EventsOrderProbeTest
    {
        /// <summary>
        ///     The listener class
        /// </summary>
        private sealed class OrderListener : EventListener
        {
            /// <summary>
            ///     The event count
            /// </summary>
        ...
        /// <summary>
        ///     Tests that the source created before the listener still gets enabled
        /// </summary>
        [Fact]
        public void SourceCreatedFirst_ListenerEnablesIt()
        {
            Events log = Events.Log;
            using OrderListener listener = new OrderListener();
