...
using Alis.Extension.Network.Sample.Client.Complex;
using Alis.Extension.Network.Sample.Client.Simple;
using Alis.Extension.Network.Sample.Server;

namespace Alis.Extension.Network.Sample
{
    /// <summary>
    ///     The program class
    /// </summary>
