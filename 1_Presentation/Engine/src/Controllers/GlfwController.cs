...
namespace Alis.App.Engine.Controllers
{
    ...
    public class GlfwController : IControllerUi
    {
        ...
        ///     The windows default
        /// </summary>
        private readonly int _windowsDefault;

        /// <summary>
        ///     The title main window
        /// </summary>
        private readonly string TitleMainWindow;
        ...
        public void OnInit()
        {
            ...
            Logger.Info($"Setting GLFW to scale to monitor = {(ScaleToMonitor ? "Yes" : "No")}");
            ...
            Logger.Info($"Setting GLFW window decorated = {(DecoratedWindow ? "Yes" : "No")}");
            ...
            Logger.Info($"Setting GLFW window focused on init = {(FocusedOnInit ? "Yes" : "No")}");
        ...
        /// </summary>
        /// <returns>The bool</returns>
        public bool CheckIfWindowShouldClose() => Glfw.WindowShouldClose(_window);
    }
}