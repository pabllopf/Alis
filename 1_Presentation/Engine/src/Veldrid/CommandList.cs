...
namespace Veldrid
{
    ...
    public abstract class CommandList : DeviceResource, IDisposable
    {
        ...
        /// <summary>
        /// The uniform buffer alignment
        /// </summary>
        private readonly uint _uniformBufferAlignment;
        /// <summary>
        /// The structured buffer alignment
        /// </summary>
        ...
        /// <param name="uniformAlignment">The uniform alignment</param>
        /// <param name="structuredAlignment">The structured alignment</param>
        ...
        /// <summary>
        /// Validates the indirect offset using the specified offset
        /// </summary>
        /// <param name="offset">The offset</param>
        /// <exception cref="VeldridException">{nameof(offset)} must be a multiple of 4.</exception>
        ...
        /// <summary>
        /// Validates the draw indirect support
        /// </summary>
        /// <exception cref="VeldridException">Indirect drawing is not supported by this device.</exception>
        [Conditional("VALIDATE_USAGE")]
        ...
        /// <summary>
        /// Validates the indirect buffer using the specified indirect buffer
        /// </summary>
        /// <param name="indirectBuffer">The indirect buffer</param>
        /// <exception cref="VeldridException">{nameof(indirectBuffer)} parameter must have been created with BufferUsage.IndirectBuffer. Instead, it was {indirectBuffer.Usage}.</exception>
        [Conditional("VALIDATE_USAGE")]
        ...
        /// <summary>
        /// Validates the indirect stride using the specified stride
        /// </summary>
        /// <param name="stride">The stride</param>
        /// <param name="argumentSize">The argument size</param>
        /// <exception cref="VeldridException">{nameof(stride)} parameter must be a multiple of 4, and must be larger than the size of the corresponding argument structure.</exception>
        [Conditional("VALIDATE_USAGE")]
        ...
        /// <summary>
        /// Validates the index buffer using the specified index count
        /// </summary>
        /// <param name="indexCount">The index count</param>
        [Conditional("VALIDATE_USAGE")]
