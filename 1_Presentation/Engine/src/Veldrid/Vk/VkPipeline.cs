...
namespace Veldrid.Vk
{
    ...
    internal unsafe class VkPipeline : Pipeline
    {
        ...
        /// <summary>
        /// Gets the value of the device pipeline
        /// </summary>
        public Vulkan.VkPipeline DevicePipeline => _devicePipeline;

        /// <summary>
        /// Gets the value of the pipeline layout
        /// </summary>
        public VkPipelineLayout PipelineLayout => _pipelineLayout;

        /// <summary>
        /// Gets the value of the resource set count
        /// </summary>
        public uint ResourceSetCount { get; }
        /// <summary>
        /// Gets the value of the dynamic offsets count
        /// </summary>
