...
namespace Veldrid.Vk
{
    ...
    internal unsafe class VkDeviceMemoryManager : IDisposable
    {
        ...
        /// <param name="bufferImageGranularity">The buffer image granularity</param>
        /// <param name="getBufferMemoryRequirements2">The get buffer memory requirements</param>
        /// <param name="getImageMemoryRequirements2">The get image memory requirements</param>
        ...
        /// <summary>
        /// Allocates the mem properties
        /// </summary>
        /// <param name="memProperties">The mem properties</param>
        /// <param name="memoryTypeBits">The memory type bits</param>
        /// <param name="flags">The flags</param>
        /// <param name="persistentMapped">The persistent mapped</param>
        /// <param name="size">The size</param>
        /// <param name="alignment">The alignment</param>
        /// <returns>The vk memory block</returns>
        ...
        /// <param name="size">The size</param>
        /// <param name="alignment">The alignment</param>
        /// <param name="dedicated">The dedicated</param>
        /// <param name="dedicatedImage">The dedicated image</param>
        /// <param name="dedicatedBuffer">The dedicated buffer</param>
        /// <exception cref="VeldridException">No suitable memory type.</exception>
        /// <exception cref="VeldridException">Unable to allocate sufficient Vulkan memory.</exception>
        /// <exception cref="VeldridException">Unable to allocate sufficient Vulkan memory.</exception>
        /// <exception cref="VeldridException">Unable to map newly-allocated Vulkan memory.</exception>
        /// <returns>The vk memory block</returns>
        public VkMemoryBlock Allocate(
            VkPhysicalDeviceMemoryProperties memProperties,
            uint memoryTypeBits,
        ...
        /// <summary>
        /// Gets the allocator using the specified memory type index
        /// </summary>
    ...
    internal unsafe struct VkMemoryBlock : IEquatable<VkMemoryBlock>
    {
        ...
        /// <summary>
        /// Gets the value of the block mapped pointer
        /// </summary>
        public void* BlockMappedPointer => ((byte*)BaseMappedPointer) + Offset;
        /// <summary>
        /// Gets the value of the is persistent mapped
        /// </summary>
        ...
        /// <param name="size">The size</param>
        /// <param name="memoryTypeIndex">The memory type index</param>
        /// <param name="mappedPtr">The mapped ptr</param>
        /// <param name="dedicatedAllocation">The dedicated allocation</param>
