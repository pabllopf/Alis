...
{
    /// <summary>
    /// The validation helpers class
    /// </summary>
    internal static class ValidationHelpers
    {
        /// <summary>
        /// Validates the resource set using the specified gd
        /// </summary>
        ...
        /// <summary>
        /// Validates the resource kind using the specified kind
        /// </summary>
        ...
        /// <exception cref="VeldridException"></exception>
        /// <exception cref="VeldridException"></exception>
        /// <exception cref="VeldridException">Resource in slot {slot} does not match {nameof(ResourceKind)} specified in the {nameof(ResourceLayout)}. It must be a {nameof(DeviceBuffer)} with {nameof(BufferUsage)}.{nameof(BufferUsage.StructuredBufferReadWrite)}.</exception>
        /// <exception cref="VeldridException">Resource in slot {slot} does not match {nameof(ResourceKind)}.{kind} specified in the {nameof(ResourceLayout)}. It must be a {nameof(DeviceBuffer)} with {nameof(BufferUsage)}.{nameof(BufferUsage.StructuredBufferReadOnly)}.</exception>
        /// <exception cref="VeldridException">Resource in slot {slot} does not match {nameof(ResourceKind)}.{kind} specified in the {nameof(ResourceLayout)}. It must be a {nameof(Sampler)}.</exception>
        [Conditional("VALIDATE_USAGE")]
