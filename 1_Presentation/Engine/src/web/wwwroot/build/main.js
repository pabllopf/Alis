System.register(["imgui-js", "./imgui_impl.js", "./imgui_demo.js", "./imgui_memory_editor.js"], function (exports_1, context_1) {
    ...
    function _loop(time) {
        ...
        /*
        ImGui.Begin("Ventana desde TS");

        if (ImGui.Button("Decir Hello desde C#")) {
            DotNet.invokeMethodAsync("ImGuiWasmDemo", "HelloFromCSharp")
                .then(() => console.log("C# respondió"))
                .catch(console.error);
        }

        ImGui.End();*/

        // Llamar a C# para construir la UI en este frame
        DotNet.invokeMethodAsync("Alis.App.Engine.Web", "RenderUI")
            .catch(console.error);
