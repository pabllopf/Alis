...
{
    /// <summary>
    /// The jetbrain font test class
    /// </summary>
    public class JetbrainFontTest
    {
        /// <summary>
        ...
        {
            JetbrainFont font = new JetbrainFont();
        ...
        {
            Assert.True(typeof(JetbrainFont).IsSealed);
        }
    }
}
