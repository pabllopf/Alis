...
### Main Solution
| File | Path | Scope | Projects |
|------|------|-------|----------|
| `alis.slnx` | Root | All projects | 142 csproj |
| `alis.apps.slnx` | Root | Application projects | ~12 csproj |
| `alis.benchmark.slnx` | Root | Benchmark projects | ~1 csproj |
| `alis.core.slnx` | Root | Core library projects | ~15 csproj |
| `alis.extensions.slnx` | Root | Extension projects | ~40 csproj |
| `alis.samples.slnx` | Root | Sample projects | ~40 csproj |
| `alis.test.slnx` | Root | Test projects | ~25 csproj |
...
| `/2_Application/Alis/samples/alis.sample.asteroid/` | Web, Desktop |
