...
## Overview
Quick reference cards for common tasks, lookups, and navigation in the Alis solution. Designed for fast access without reading multiple files.
...
### All 13 Sample Games
| Game | Desktop Path | Web Path | Complexity |
|------|-------------|----------|------------|
| **Asteroid** | `samples/alis.sample.asteroid/desktop` | `samples/alis.sample.asteroid/web` | Medium |
| **Dino** | `samples/alis.sample.dino/desktop` | `samples/alis.sample.dino/web` | Simple |
| **Egg** | `samples/alis.sample.egg/desktop` | `samples/alis.sample.egg/web` | Simple |
| **Empty** | `samples/alis.sample.empty/desktop` | `samples/alis.sample.empty/web` | Minimal |
| **Flappy.Bird** | `samples/alis.sample.flappy.bird/desktop` | `samples/alis.sample.flappy.bird/web` | Simple |
| **Inefable** | `samples/alis.sample.inefable/desktop` | `samples/alis.sample.inefable/web` | Medium |
| **King.Platform** | `samples/alis.sample.king.platform/desktop` | `samples/alis.sample.king.platform/web` | Medium |
| **Pong** | `samples/alis.sample.pong/desktop` | `samples/alis.sample.pong/web` | Simple |
| **Rogue** | `samples/alis.sample.rogue/desktop` | `samples/alis.sample.rogue/web` | Complex |
| **RuinsOfTartarus** | `samples/alis.sample.ruinsoftartarus/desktop` | `samples/alis.sample.ruinsoftartarus/web` | Complex |
| **Snake** | `samples/alis.sample.snake/desktop` | `samples/alis.sample.snake/web` | Simple |
| **Space.Simulator** | `samples/alis.sample.space.simulator/desktop` | `samples/alis.sample.space.simulator/web` | Complex |
| **SplitCamera** | `samples/alis.sample.splitcamera/desktop` | `samples/alis.sample.splitcamera/web` | Medium |
...
### Core Components (in `2_Application/Alis/src/Core/Ecs/Components/`)
| Component | Purpose |
|-----------|---------|
