...
namespace Alis.Core.Audio.Mathematics.Matrix
{
    ...
    public struct Matrix4x3 : IEquatable<Matrix4x3>
    {
        ...
        [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "SA1117",
        ...
        [Pure]
        public static Matrix3x4 Transpose(Matrix4x3 mat) => new Matrix3x4(mat.Column0, mat.Column1, mat.Column2);
        ...
        [Pure]
        public override bool Equals(object obj) => obj is Matrix4x3 && Equals((Matrix4x3) obj);
