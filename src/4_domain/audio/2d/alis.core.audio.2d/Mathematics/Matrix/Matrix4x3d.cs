...
namespace Alis.Core.Audio.Mathematics.Matrix
{
    ...
    public struct Matrix4x3d : IEquatable<Matrix4x3d>
    {
        ...
        [Pure]
        public static Matrix3x4d Transpose(Matrix4x3d mat) => new Matrix3x4d(mat.Column0, mat.Column1, mat.Column2);
        ...
        [Pure]
        public override bool Equals(object obj) => obj is Matrix4x3d && Equals((Matrix4x3d) obj);
