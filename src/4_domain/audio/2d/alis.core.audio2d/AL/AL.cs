...
namespace Alis.Core.Audio2D.AL
{
    /// <summary>
    ...
    public class AL : ALBase
    {
        ...
        */
        ...
        /// <param name="sinDataLength"></param>
        /// <param name="freq">The frequency of the audio buffer.</param>
        /// FIXME: Should "size" be changed to "elements"?
        public static unsafe void BufferData<TBuffer>(int bid, ALFormat format, TBuffer[] buffer, int sinDataLength,
            int freq)
