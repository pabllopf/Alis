...
namespace Alis.Core.Systems.Audio.Extensions.EXT.Double
{
    public class EXTDouble : ALBase
    {
        ...
        {
            return AL.AL.IsExtensionPresent(ExtensionName);
        }
        ...
        [DllImport(AL.AL.Lib, EntryPoint = "alBufferData", ExactSpelling = true, CallingConvention = AL.AL.ALCallingConvention)]
