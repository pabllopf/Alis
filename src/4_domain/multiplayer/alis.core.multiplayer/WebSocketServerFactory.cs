...
using Alis.Core.Multiplayer.Exceptions;
using Alis.Core.Multiplayer.Internal;
...
namespace Alis.Core.Multiplayer
{
    ...
    public class WebSocketServerFactory : IWebSocketServerFactory
    {
        ...
        ///     Used to get a memory stream. Feel free to implement your own buffer pool. MemoryStreams will
