    ...
    public class World
    {
        ...
        public Body CreateBody(BodyDef def)
        {
            ...
            if (m_locked)
            {
                throw new
                    Box2DException(
                        "Cannot create bodies in the middle of Step. Has this been spawned from an event such as a ContactListener callback?");
            }
        ...
        public void DestroyBody(Body b)
        {
            ...
            if (m_locked)
            {
                throw new
                    Box2DException(
                        "Cannot destroy bodies in the middle of Step. Has this been spawned from an event such as a ContactListener callback?");
            }
        ...
        public Joint CreateJoint(JointDef def)
        {
            ...
            if (m_locked)
            {
                throw new
                    Box2DException(
                        "Cannot create joints in the middle of Step. Has this been spawned from an event such as a ContactListener callback?");
            }
        ...
        public void DestroyJoint(Joint j)
        {
            ...
            if (m_locked)
            {
                throw new
                    Box2DException(
                        "Cannot destroy joints in the middle of Step. Has this been spawned from an event such as a ContactListener callback?");
            }
        ...
        /// <param name="aabb">The aabb</param>
        /// <param name="maxFixtures">The max fixtures</param>
        /// <returns>The </returns>
        ...
        private void DrawShape(Fixture fixture, in Transform xf, in Color color)
        {
            switch (fixture.Shape)
            {
                case CircleShape circle:
                {
                    ...
                    float radius = circle.m_radius;
                    Vec2 axis = Vector2.Transform(new Vector2(1.0f, 0.0f),
                        xf.q); // Math.Mul(xf.q, new Vector2(1.0f, 0.0f));
