...
| 6_Ideation | Alis.Core.Math | 🔄 Pending | - | Medium |
| 6_Ideation | Alis.Core.Memory | 🔄 Pending | - | Medium |
| 6_Ideation | Alis.Core.Time | 🔄 Pending | - | Medium |
...
- **Fluent**: Fluent interfaces - Focus: builder patterns, fluent APIs
- **Logging**: Logging infrastructure - Focus: log providers, formatters, sinks
- **Math**: Mathematical operations - Focus: vectors, matrices, quaternions
- **Memory**: Memory management - Focus: allocators, pools, memory pools
- **Time**: Time management - Focus: timers, schedulers, time scales
...
- Markdown-only files inside `.memory/projects/`
- Use Obsidian wiki-links for cross-references
- Auto-commit changes to git
- Focus on one project at a time
- Preserve existing documentation structure
- Document all source files with complete architecture
