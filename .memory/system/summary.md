...
File:
pabllopf-official_alis:1_Presentation/Extension/Graphic/Ui/src/ImGuiTableColumnSortSpecs.cs

CoverageBefore:
0.0% (SonarCloud; 4 uncovered lines)

CoverageAfter:
100.0% (8/8, local coverlet, ImGuiTableColumnSortSpecs-filtered run)

TestsAdded:
3 (ImGuiTableColumnSortSpecsCoverageTests.cs, plain [Fact])

Commit:
test: coverage ImGuiTableColumnSortSpecs.cs
...
CoverageAfter:
100.0% (4/4, local coverlet, ImPlotRect-filtered run)

TestsAdded:
3 (ImPlotRectCoverageTests.cs, plain [Fact])

Commit:
test: coverage ImPlotRect.cs
...
File:
pabllopf-official_alis:1_Presentation/Extension/Graphic/Sdl2/src/Structs/KeyboardEvent.cs

CoverageBefore:
0.0% (SonarCloud; 1 uncovered lines)

CoverageAfter:
100.0% (2/2, local coverlet, KeyboardEvent-filtered run)

TestsAdded:
2 (KeyboardEventCoverageTests.cs, plain [Fact])

Commit:
test: coverage KeyboardEvent.cs
...
File:
pabllopf-official_alis:1_Presentation/Extension/Graphic/Sdl2/src/Structs/InternalCocoaWmInfo.cs
...
TestsAdded:
4 (InternalCocoaWmInfoCoverageTests.cs: Window round-trip/overwrite/default + copy independence)

Commit:
test: coverage InternalCocoaWmInfo.cs
