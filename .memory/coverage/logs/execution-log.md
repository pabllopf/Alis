...
| (pending) | 2026-07-07 | DTSweep.cs | PointSet (FinalizationConvexHull), ConstrainedPointSet (edge events), L-Shape polygon | 5 new tests (50 total in namespace) | In Progress |
