...
- Read all 8 .slnx files (alis.slnx, alis.core.slnx, alis.apps.slnx, alis.extensions.slnx, alis.test.slnx, alis.samples.slnx, alis.core.aspect.slnx, alis.benchmark.slnx)
