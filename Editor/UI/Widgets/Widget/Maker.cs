...
// <copyright file="Maker.cs" company="Pabllopf">GNU General Public License v3.0</copyright>
//----------------------------------------------------------------------------------------------------
namespace Alis.Editor.UI.Widgets
{
    ...
    public class Maker : Widget
    {
        ...
        public static Maker Current { get => current; set => current = value; }
