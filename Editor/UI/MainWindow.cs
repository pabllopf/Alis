...
namespace Alis.Editor.UI
{
    ...
    public class MainWindow
    {
        ...
        private System.Numerics.Vector4 dark = new System.Numerics.Vector4(0.06f, 0.06f, 0.06f, 0.94f);

        private System.Numerics.Vector4 clasic = new System.Numerics.Vector4(0.00f, 0.00f, 0.00f, 0.7f);

        private System.Numerics.Vector4 light = new System.Numerics.Vector4(0.94f, 0.94f, 0.94f, 1.00f);
        ...
        private int Update()
        {
            ...
            while (window.Exists)
            {
                ...
                if (dark.Equals(colors[(int)ImGuiCol.WindowBg]))
                {
                    LoadDarkStyle();
                }

                if (clasic.Equals(colors[(int)ImGuiCol.WindowBg]))
                {
                    LoadClasicStyle();
                }


                if (light.Equals(colors[(int)ImGuiCol.WindowBg]))
                {
                    LoadLightStyle();
                }
        ...
        private void LoadClasicStyle()
        {
            ...
            colors[(int)ImGuiCol.Text] = new System.Numerics.Vector4(1.00f, 1.00f, 1.00f, 1.00f);
            colors[(int)ImGuiCol.TextDisabled] = new System.Numerics.Vector4(1.00f, 1.00f, 1.00f, 0.58f);
            colors[(int)ImGuiCol.WindowBg] = new System.Numerics.Vector4(0.16f, 0.23f, 0.30f, 1.00f);
            colors[(int)ImGuiCol.PopupBg] = new System.Numerics.Vector4(0.13f, 0.18f, 0.24f, 0.92f);
            colors[(int)ImGuiCol.Border] = new System.Numerics.Vector4(0.00f, 0.00f, 0.00f, 1.00f);
            colors[(int)ImGuiCol.BorderShadow] = new System.Numerics.Vector4(0.17f, 0.24f, 0.31f, 0.00f);
            colors[(int)ImGuiCol.FrameBg] = new System.Numerics.Vector4(0.22f, 0.31f, 0.41f, 1.00f);
            colors[(int)ImGuiCol.FrameBgHovered] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 0.78f);
            colors[(int)ImGuiCol.FrameBgActive] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 1.00f);
            colors[(int)ImGuiCol.TitleBg] = new System.Numerics.Vector4(0.22f, 0.31f, 0.41f, 1.00f);
            colors[(int)ImGuiCol.TitleBgActive] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 1.00f);
            colors[(int)ImGuiCol.TitleBgCollapsed] = new System.Numerics.Vector4(0.22f, 0.31f, 0.41f, 0.75f);
            colors[(int)ImGuiCol.MenuBarBg] = new System.Numerics.Vector4(0.22f, 0.31f, 0.41f, 0.47f);
            colors[(int)ImGuiCol.CheckMark] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 0.80f);
            colors[(int)ImGuiCol.SliderGrab] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 0.50f);
            colors[(int)ImGuiCol.SliderGrabActive] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 1.00f);
            colors[(int)ImGuiCol.Button] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 0.50f);
            colors[(int)ImGuiCol.ButtonHovered] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 0.86f);
            colors[(int)ImGuiCol.ButtonActive] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 1.00f);
            colors[(int)ImGuiCol.Header] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 0.76f);
            colors[(int)ImGuiCol.HeaderHovered] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 0.86f);
            colors[(int)ImGuiCol.HeaderActive] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 1.00f);
            colors[(int)ImGuiCol.ResizeGrip] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 0.15f);
            colors[(int)ImGuiCol.ResizeGripHovered] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 0.78f);
            colors[(int)ImGuiCol.ResizeGripActive] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 1.00f);
            colors[(int)ImGuiCol.Tab] = new System.Numerics.Vector4(0.16f, 0.16f, 0.52f, 0.79f);
            colors[(int)ImGuiCol.TabHovered] = new System.Numerics.Vector4(0.26f, 0.26f, 0.63f, 0.80f);
            colors[(int)ImGuiCol.TabActive] = new System.Numerics.Vector4(0.30f, 0.30f, 0.65f, 0.84f);
            colors[(int)ImGuiCol.TabUnfocused] = new System.Numerics.Vector4(0.19f, 0.19f, 0.45f, 0.82f);
            colors[(int)ImGuiCol.TabUnfocusedActive] = new System.Numerics.Vector4(0.11f, 0.11f, 0.31f, 0.84f);
            colors[(int)ImGuiCol.PlotLines] = new System.Numerics.Vector4(0.93f, 0.94f, 0.95f, 0.63f);
            colors[(int)ImGuiCol.PlotLinesHovered] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 1.00f);
            colors[(int)ImGuiCol.PlotHistogram] = new System.Numerics.Vector4(0.93f, 0.94f, 0.95f, 0.63f);
            colors[(int)ImGuiCol.PlotHistogramHovered] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 1.00f);
            colors[(int)ImGuiCol.TextSelectedBg] = new System.Numerics.Vector4(0.16f, 0.50f, 0.73f, 0.43f);


        }

        private void LoadLightStyle()
        {
            ImGuiStylePtr style = ImGui.GetStyle();
            ...
            colors[(int)ImGuiCol.TextDisabled] = new System.Numerics.Vector4(0.36f, 0.42f, 0.47f, 1.00f);
            colors[(int)ImGuiCol.WindowBg] = new System.Numerics.Vector4(1.00f, 1.00f, 1.00f, 1.00f);
            colors[(int)ImGuiCol.ChildBg] = new System.Numerics.Vector4(1.00f, 1.00f, 1.00f, 0.70f);
            colors[(int)ImGuiCol.PopupBg] = new System.Numerics.Vector4(0.68f, 0.68f, 0.68f, 1.00f);
            colors[(int)ImGuiCol.Border] = new System.Numerics.Vector4(0.51f, 0.51f, 0.51f, 0.50f);
            colors[(int)ImGuiCol.BorderShadow] = new System.Numerics.Vector4(0.60f, 0.60f, 0.60f, 0.00f);
            colors[(int)ImGuiCol.FrameBg] = new System.Numerics.Vector4(0.69f, 0.69f, 0.69f, 1.00f);
            colors[(int)ImGuiCol.FrameBgHovered] = new System.Numerics.Vector4(0.25f, 0.38f, 0.52f, 1.00f);
            colors[(int)ImGuiCol.FrameBgActive] = new System.Numerics.Vector4(0.90f, 0.90f, 0.90f, 1.00f);
            colors[(int)ImGuiCol.TitleBg] = new System.Numerics.Vector4(0.63f, 0.63f, 0.63f, 1.00f);
            colors[(int)ImGuiCol.TitleBgActive] = new System.Numerics.Vector4(0.60f, 0.60f, 0.60f, 1.00f);
            colors[(int)ImGuiCol.TitleBgCollapsed] = new System.Numerics.Vector4(0.75f, 0.75f, 0.75f, 0.51f);
            colors[(int)ImGuiCol.MenuBarBg] = new System.Numerics.Vector4(0.87f, 0.87f, 0.87f, 1.00f);
            colors[(int)ImGuiCol.ScrollbarBg] = new System.Numerics.Vector4(0.50f, 0.50f, 0.50f, 0.53f);
            colors[(int)ImGuiCol.ScrollbarGrab] = new System.Numerics.Vector4(0.20f, 0.25f, 0.29f, 1.00f);
            colors[(int)ImGuiCol.ScrollbarGrabHovered] = new System.Numerics.Vector4(0.37f, 0.48f, 0.56f, 1.00f);
            colors[(int)ImGuiCol.ScrollbarGrabActive] = new System.Numerics.Vector4(0.23f, 0.39f, 0.53f, 1.00f);
            colors[(int)ImGuiCol.CheckMark] = new System.Numerics.Vector4(0.28f, 0.56f, 1.00f, 1.00f);
            colors[(int)ImGuiCol.Button] = new System.Numerics.Vector4(0.82f, 0.82f, 0.82f, 1.00f);
            colors[(int)ImGuiCol.ButtonHovered] = new System.Numerics.Vector4(0.42f, 0.57f, 0.80f, 1.00f);
            colors[(int)ImGuiCol.HeaderHovered] = new System.Numerics.Vector4(0.44f, 0.68f, 0.97f, 0.80f);
            colors[(int)ImGuiCol.Separator] = new System.Numerics.Vector4(0.05f, 0.05f, 0.28f, 0.50f);
            colors[(int)ImGuiCol.SeparatorHovered] = new System.Numerics.Vector4(0.15f, 0.40f, 0.65f, 1.00f);
            colors[(int)ImGuiCol.SeparatorActive] = new System.Numerics.Vector4(0.00f, 0.00f, 0.00f, 1.00f);
            colors[(int)ImGuiCol.ResizeGrip] = new System.Numerics.Vector4(0.23f, 0.49f, 0.81f, 0.25f);
            colors[(int)ImGuiCol.ResizeGripHovered] = new System.Numerics.Vector4(0.20f, 0.45f, 0.74f, 0.67f);
            colors[(int)ImGuiCol.ResizeGripActive] = new System.Numerics.Vector4(0.17f, 0.43f, 0.73f, 0.95f);
            colors[(int)ImGuiCol.Tab] = new System.Numerics.Vector4(0.99f, 0.99f, 0.99f, 1.00f);
            colors[(int)ImGuiCol.TabHovered] = new System.Numerics.Vector4(0.69f, 0.69f, 0.69f, 0.80f);
            colors[(int)ImGuiCol.TabActive] = new System.Numerics.Vector4(0.63f, 0.83f, 0.96f, 1.00f);
            colors[(int)ImGuiCol.TabUnfocused] = new System.Numerics.Vector4(0.90f, 0.90f, 0.90f, 1.00f);
            colors[(int)ImGuiCol.TabUnfocusedActive] = new System.Numerics.Vector4(1.00f, 1.00f, 1.00f, 1.00f);
            colors[(int)ImGuiCol.DockingPreview] = new System.Numerics.Vector4(0.21f, 0.44f, 0.72f, 0.70f);
