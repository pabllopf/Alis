...
namespace Alis.Editor.Utils
{
    ...
    public class Icon
    {
        /// <summary>The font icon file name </summary>
        public const string FONTICONFILENAMEFA = "Icon.tff";

        /// <summary>The font icon file name </summary>    
        public const ushort ICONMINFA = 0xf000;

        /// <summary>The icon maximum </summary>
        public const ushort ICONMAXFA = 0xf2e0;
