...
namespace Alis.Core.Aspect.Data.Test.Json.Deserialization
{
    ...
    public class JsonDeserializerAdvancedTest
    {
        ...
        /// <param name="jsonValue">The json value</param>
        /// <param name="expected">The expected</param>
        [Theory, InlineData("0.0", 0.0), InlineData("1.5", 1.5), InlineData("-3.14", -3.14), InlineData("99.99", 99.99)]
        ...
        /// <param name="jsonValue">The json value</param>
        /// <param name="expected">The expected</param>
        [Theory, InlineData("0", 0), InlineData("1", 1), InlineData("-1", -1), InlineData("100", 100), InlineData("2147483647", int.MaxValue)]
        ...
        [Theory, InlineData(""), InlineData("simple"), InlineData("with spaces"), InlineData("special!@#$%")]
        ...
        private class TestDynamicObject : IJsonSerializable, IJsonDesSerializable<TestDynamicObject>
        {
            ...
            public TestDynamicObject CreateFromProperties(Dictionary<string, string> properties) => new TestDynamicObject(properties.Count);
