...
namespace Alis.Core.Aspect.Data.Test.Json.Parsing
{
    ...
    public class JsonParserUnitTest
    {
        ...
        [Theory, InlineData(3), InlineData(5), InlineData(10), InlineData(50)]
        ...
        [Theory, InlineData("!"), InlineData("@"), InlineData("#"), InlineData("$"), InlineData("%"), InlineData("&"), InlineData("*")]
        ...
        [Theory, InlineData("こんにちは"), InlineData("你好"), InlineData("Привет"), InlineData("مرحبا"), InlineData("שלום")]
        // Japanese
        // Chinese
        // Russian
        // Arabic
        ...
        [Theory, InlineData("😀"), InlineData("❤️"), InlineData("🚀"), InlineData("🎉")]
        // Grinning face
        // Heart
        // Rocket
        // Party popper
        ...
        [Theory, InlineData("a"), InlineData("simple"), InlineData("camelCase"), InlineData("PascalCase"), InlineData("snake_case"), InlineData("kebab-case")]
        ...
        /// </summary>
        /// <param name="value">The value</param>
        [Theory, InlineData("0.0"), InlineData("3.14"), InlineData("-2.5"), InlineData("1.23456789")]
