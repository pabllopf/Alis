...
namespace Alis.Core.Aspect.Math.Figures.D2.Rectangle
{
    ...
    public struct RectangleF : IEquatable<RectangleF>
    {
        ...
        {
            float minX = System.Math.Min(Left, Left + Width);
            float maxX = System.Math.Max(Left, Left + Width);
        ...
        public bool Intersects(RectangleF rect, out RectangleF overlap)
        {
            ...
            float r1MinX = System.Math.Min(Left, Left + Width);
            float r1MaxX = System.Math.Max(Left, Left + Width);
            float r1MinY = System.Math.Min(Top, Top + Height);
            float r1MaxY = System.Math.Max(Top, Top + Height);

            // Compute the min and max of the second rectangle on both axes
            float r2MinX = System.Math.Min(rect.Left, rect.Left + rect.Width);
            float r2MaxX = System.Math.Max(rect.Left, rect.Left + rect.Width);
            float r2MinY = System.Math.Min(rect.Top, rect.Top + rect.Height);
            float r2MaxY = System.Math.Max(rect.Top, rect.Top + rect.Height);

            // Compute the intersection boundaries
            float interLeft = System.Math.Max(r1MinX, r2MinX);
            float interTop = System.Math.Max(r1MinY, r2MinY);
            float interRight = System.Math.Min(r1MaxX, r2MaxX);
        ...
        ////////////////////////////////////////////////////////////
        public override string ToString() => "[RectangleF]" +
                                             " Left(" + Left + ")" +
                                             " Top(" + Top + ")" +
                                             " Width(" + Width + ")" +
                                             " Height(" + Height + ")";
        ...
        ////////////////////////////////////////////////////////////
        public static explicit operator RectangleI(RectangleF r) => new RectangleI((int) r.Left,
            (int) r.Top,
            (int) r.Width,
            (int) r.Height);
