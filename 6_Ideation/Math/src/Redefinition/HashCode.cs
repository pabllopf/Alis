...
namespace System
{
     public struct HashCode
    {
        ...
        /// </remarks>
        public void AddBytes(Span<byte> value)
        {
            ...
            ref byte blockEnd = ref Unsafe.Subtract(ref end, (int)(Unsafe.ByteOffset(ref pos, ref end).ToInt64() % (sizeof(int) * 4)));
        ...
        Small:
            ...
            while (Unsafe.ByteOffset(ref pos, ref end).ToInt64() >= sizeof(int))
            {
                Add(Unsafe.ReadUnaligned<int>(ref pos));
                pos = ref Unsafe.Add(ref pos, sizeof(int));
            }
