...
{
    /// <summary>
    ///     Provides commonly used mathematical constants such as pi, e, epsilon, and logarithmic base values for single-precision floating-point arithmetic.
    /// </summary>
    public static class Constant
    {
        /// <summary>
        ///     Represents the smallest positive single-precision floating-point value greater than zero (1.192092896e-07f).
        /// </summary>
        public const float Epsilon = 1.192092896e-07f;

        /// <summary>
        ///     Represents Euler's number (2.7182818284590452354).
        /// </summary>
        ...
        /// <summary>Represents the value of pi times two (6.28318548). This is an alias of <see cref="TwoPi" />.</summary>
