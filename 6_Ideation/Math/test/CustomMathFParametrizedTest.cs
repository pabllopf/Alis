...
namespace Alis.Core.Aspect.Math.Test
{
    ...
    public class CustomMathFParametrizedTest
    {
        ...
        [Theory, MemberData(nameof(GetSqrtTestCases))]
        ...
        /// </summary>
        /// <param name="input">The input</param>
        [Theory, InlineData(-1f), InlineData(-10f), InlineData(-100f), InlineData(-0.5f)]
        ...
        /// <param name="input">The input</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GetAbsTestCases))]
        ...
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GetClampTestCases))]
        ...
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GetMaxIntTestCases))]
        ...
        /// <param name="b">The </param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GetMinIntTestCases))]
        ...
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GetTrigonometricTestCases))]
