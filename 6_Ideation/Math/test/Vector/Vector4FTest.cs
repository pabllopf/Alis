...
namespace Alis.Core.Aspect.Math.Test.Vector
{
    ...
    public class Vector4FTest
    {
        ...
        public void Get_ShouldReturnCorrectValue()
        {
            ...
            // Act & Assert
            Assert.Equal(1, Vector4F.Get(vector, 0));
            Assert.Equal(2, Vector4F.Get(vector, 1));
            Assert.Equal(3, Vector4F.Get(vector, 2));
            Assert.Equal(4, Vector4F.Get(vector, 3));
        }
        ...
        public void Get_WithInvalidIndex_ShouldReturnZero()
        {
            ...
            // Act & Assert
            Assert.Equal(0, Vector4F.Get(vector, 4));
        }
    }
}