...
namespace Alis.Core.Aspect.Memory.Generator
{
    ...
    public class ResourceAccessorGenerator : IIncrementalGenerator
    {
        ...
        /// <summary>
        ///     The AOT resources category
        /// </summary>
        private const string CategoryAotResources = "AOT Resources";
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            context.RegisterSourceOutput(combinedProvider, (spc, combined) =>
            {
                    ...
                    (compilation.Options.OutputKind != OutputKind.WindowsApplication))
                {
                    ...
                    DiagnosticDescriptor descInfo = new DiagnosticDescriptor("ALIS0013", "Proyecto no ejecutable", "El generador no se ejecuta en proyectos de tipo {0}", CategoryAotResources, DiagnosticSeverity.Info, true);
                    spc.ReportDiagnostic(Diagnostic.Create(descInfo, Location.None, compilation.Options.OutputKind.ToString()));
#endif
#if NETSTANDARD2_0
                    DiagnosticDescriptor descInfoNetStandard = new DiagnosticDescriptor("ALIS0013", "Proyecto no ejecutable", "El generador no se ejecuta en proyectos de tipo {0}", CategoryAotResources, DiagnosticSeverity.Info, true);
                ...
                {
#if NET8_0_OR_GREATER
                    DiagnosticDescriptor descWarning = new DiagnosticDescriptor("ALIS0011", "Archivo no encontrado", "El archivo assets.pack no fue encontrado. Asegúrate de generarlo antes de compilar.", CategoryAotResources, DiagnosticSeverity.Warning, true);
                    spc.ReportDiagnostic(Diagnostic.Create(descWarning, Location.None));
#endif
#if NETSTANDARD2_0
                    DiagnosticDescriptor descWarningNetStandard = new DiagnosticDescriptor("ALIS0011", "Archivo no encontrado", "El archivo assets.pack no fue encontrado. Asegúrate de generarlo antes de compilar.", CategoryAotResources, DiagnosticSeverity.Warning, true);
                ...
                {
#if NET8_0_OR_GREATER
                    DiagnosticDescriptor descError = new DiagnosticDescriptor("ALIS0012", "Archivo vacío", "El archivo assets.pack está vacío o no es válido.", CategoryAotResources, DiagnosticSeverity.Error, true);
                    spc.ReportDiagnostic(Diagnostic.Create(descError, Location.None));
#endif
#if NETSTANDARD2_0
                    DiagnosticDescriptor descErrorNetStandard = new DiagnosticDescriptor("ALIS0012", "Archivo vacío", "El archivo assets.pack está vacío o no es válido.", CategoryAotResources, DiagnosticSeverity.Error, true);
...
#if NET8_0_OR_GREATER
                DiagnosticDescriptor descHash = new DiagnosticDescriptor("ALIS0007", "Hash calculado", $"Hash SHA256 de assets.pack: {originalHash}", CategoryAotResources, DiagnosticSeverity.Info, true);
                spc.ReportDiagnostic(Diagnostic.Create(descHash, Location.None));
#endif
#if NETSTANDARD2_0
                DiagnosticDescriptor descHashNetStandard = new DiagnosticDescriptor("ALIS0007", "Hash calculado", $"Hash SHA256 de assets.pack: {originalHash}", CategoryAotResources, DiagnosticSeverity.Info, true);
