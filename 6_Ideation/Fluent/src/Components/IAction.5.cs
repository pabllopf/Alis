...
{
    /// <summary>
    ///     Defines a fluent action delegate that operates on 5 arguments
    ///     of types TArg1, TArg2, TArg3, TArg4, TArg5.
    /// </summary>
    ...
    public partial interface IAction<TArg1, TArg2, TArg3, TArg4, TArg5>
    {
        /// <summary>
        ///     Executes the action with the provided 5 arguments, passed by reference.
        /// </summary>
