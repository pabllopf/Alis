...
{
    /// <summary>
    ///     Defines a fluent action delegate that operates on 3 arguments
    ///     of types TArg1, TArg2, TArg3.
    /// </summary>
    ...
    public partial interface IAction<TArg1, TArg2, TArg3>
    {
        /// <summary>
        ///     Executes the action with the provided 3 arguments, passed by reference.
        /// </summary>
