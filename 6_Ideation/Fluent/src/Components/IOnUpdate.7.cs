...
namespace Alis.Core.Aspect.Fluent.Components
{
    ...
    ///     7 additional component references of types <typeparamref name="TArg1"/>, <typeparamref name="TArg2"/>, <typeparamref name="TArg3"/>, <typeparamref name="TArg4"/>, <typeparamref name="TArg5"/>, <typeparamref name="TArg6"/>, and <typeparamref name="TArg7"/>.
    /// </summary>
