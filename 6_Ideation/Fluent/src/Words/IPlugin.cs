...
{
    /// <summary>
    ///     Fluent builder interface that configures a plugin on the target builder.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Configures a plugin on the builder.
        /// </summary>
        /// <param name="value">The plugin configuration to apply.</param>
