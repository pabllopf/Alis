...
{
    /// <summary>
    ///     Fluent builder interface that sets the gravity scale factor on the target builder.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Sets the gravity scale on the builder.
        /// </summary>
        /// <param name="value">The gravity scale to apply.</param>
