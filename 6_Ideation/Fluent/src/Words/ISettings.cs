...
{
    /// <summary>
    ///     Fluent builder interface that configures settings on the target builder.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Configures settings on the builder.
        /// </summary>
        /// <param name="value">The settings value to apply.</param>
