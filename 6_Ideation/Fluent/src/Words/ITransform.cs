...
{
    /// <summary>
    ///     Fluent builder interface that configures transform on the target builder.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Configures transform on the builder.
        /// </summary>
        /// <param name="value">The transform configuration to apply.</param>
