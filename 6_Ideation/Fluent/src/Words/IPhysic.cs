...
{
    /// <summary>
    ///     Fluent builder interface that configures physics settings on the target builder.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Configures physics settings on the builder.
        /// </summary>
        /// <param name="value">The physics configuration to apply.</param>
