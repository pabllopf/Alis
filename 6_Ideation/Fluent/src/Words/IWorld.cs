...
{
    /// <summary>
    ///     Fluent builder interface that configures world settings on the target builder.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Configures world settings on the builder.
        /// </summary>
        /// <param name="value">The world configuration to apply.</param>
