...
{
    /// <summary>
    ///     Fluent builder interface that configures AI behavior on the target builder.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Configures AI behavior on the builder.
        /// </summary>
        /// <param name="value">The AI configuration to apply.</param>
