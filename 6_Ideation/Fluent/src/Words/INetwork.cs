...
{
    /// <summary>
    ///     Fluent builder interface that configures network settings on the target builder.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Configures network settings on the builder.
        /// </summary>
        /// <param name="value">The network configuration to apply.</param>
