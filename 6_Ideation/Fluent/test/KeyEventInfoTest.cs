...
namespace Alis.Core.Aspect.Fluent.Test
{
    ...
    public class KeyEventInfoTest
    {
        ...
        public void Constructor_AssignsFieldsCorrectly()
        {
            ...
            KeyEventInfo info = new KeyEventInfo(key, timestamp, duration);
        ...
        {
            KeyEventInfo info = new KeyEventInfo(ConsoleKey.Z, DateTime.MinValue, TimeSpan.Zero);
