...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests49.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 49.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests49
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 49
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_49(int value, int expected)
        {
