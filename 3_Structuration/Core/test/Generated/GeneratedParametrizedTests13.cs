...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests13.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 13.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests13
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 13
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_13(int value, int expected)
        {
