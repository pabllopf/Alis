...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests22.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 22.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests22
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 22
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_22(int value, int expected)
        {
