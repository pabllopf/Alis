...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests42.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 42.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests42
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 42
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_42(int value, int expected)
        {
