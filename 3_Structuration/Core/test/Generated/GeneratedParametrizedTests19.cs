...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests19.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 19.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests19
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 19
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_19(int value, int expected)
        {
