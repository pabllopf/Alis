...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests23.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 23.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests23
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 23
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_23(int value, int expected)
        {
