...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests16.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 16.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests16
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 16
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_16(int value, int expected)
        {
