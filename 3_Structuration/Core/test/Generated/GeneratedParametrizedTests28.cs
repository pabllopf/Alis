...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests28.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 28.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests28
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 28
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_28(int value, int expected)
        {
