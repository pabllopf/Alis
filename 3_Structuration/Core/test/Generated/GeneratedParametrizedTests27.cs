...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests27.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 27.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests27
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 27
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_27(int value, int expected)
        {
