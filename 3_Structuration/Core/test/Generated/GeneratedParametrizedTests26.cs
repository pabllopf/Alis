...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests26.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 26.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests26
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 26
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_26(int value, int expected)
        {
