...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests36.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 36.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests36
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 36
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_36(int value, int expected)
        {
