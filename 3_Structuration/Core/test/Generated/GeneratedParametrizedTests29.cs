...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests29.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 29.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests29
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 29
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_29(int value, int expected)
        {
