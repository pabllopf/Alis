...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests14.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 14.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests14
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 14
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_14(int value, int expected)
        {
