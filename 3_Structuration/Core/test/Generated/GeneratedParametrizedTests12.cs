...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests12.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 12.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests12
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 12
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_12(int value, int expected)
        {
