...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests9.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 9.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests9
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 9
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_9(int value, int expected)
        {
