...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests48.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 48.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests48
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 48
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_48(int value, int expected)
        {
