...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests38.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 38.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests38
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 38
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_38(int value, int expected)
        {
