...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests45.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 45.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests45
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 45
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_45(int value, int expected)
        {
