...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests34.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 34.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests34
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 34
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_34(int value, int expected)
        {
