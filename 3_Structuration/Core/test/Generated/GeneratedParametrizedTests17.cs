...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests17.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 17.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests17
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 17
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_17(int value, int expected)
        {
