...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests5.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 5.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests5
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 5
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_5(int value, int expected)
        {
