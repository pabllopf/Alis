...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests37.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 37.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests37
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 37
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_37(int value, int expected)
        {
