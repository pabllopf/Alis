...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests1.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 1.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests1
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 1
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_1(int value, int expected)
        {
