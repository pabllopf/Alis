...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests8.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 8.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests8
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 8
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_8(int value, int expected)
        {
