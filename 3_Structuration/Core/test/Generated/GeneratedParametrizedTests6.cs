...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests6.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 6.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests6
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 6
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_6(int value, int expected)
        {
