...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests43.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 43.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests43
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 43
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_43(int value, int expected)
        {
