...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests24.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 24.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests24
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 24
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_24(int value, int expected)
        {
