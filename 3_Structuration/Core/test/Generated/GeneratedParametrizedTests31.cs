...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests31.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 31.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests31
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 31
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_31(int value, int expected)
        {
