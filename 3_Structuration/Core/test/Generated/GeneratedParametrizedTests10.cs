...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests10.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 10.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests10
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 10
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_10(int value, int expected)
        {
