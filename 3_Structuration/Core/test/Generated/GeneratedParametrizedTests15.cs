...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests15.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 15.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests15
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 15
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_15(int value, int expected)
        {
