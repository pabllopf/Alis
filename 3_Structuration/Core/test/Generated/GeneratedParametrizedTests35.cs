...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests35.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 35.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests35
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 35
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_35(int value, int expected)
        {
