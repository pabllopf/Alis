...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests20.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 20.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests20
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 20
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_20(int value, int expected)
        {
