...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests50.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 50.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests50
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 50
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_50(int value, int expected)
        {
