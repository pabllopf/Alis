...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests41.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 41.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests41
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 41
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_41(int value, int expected)
        {
