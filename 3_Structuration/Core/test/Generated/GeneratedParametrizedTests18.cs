...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests18.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 18.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests18
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 18
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_18(int value, int expected)
        {
