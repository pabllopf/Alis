...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests21.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 21.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests21
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 21
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_21(int value, int expected)
        {
