...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests33.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 33.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests33
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 33
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_33(int value, int expected)
        {
