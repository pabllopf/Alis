...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests3.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 3.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests3
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 3
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_3(int value, int expected)
        {
