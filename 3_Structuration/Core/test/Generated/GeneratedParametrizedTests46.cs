...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests46.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 46.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests46
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 46
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_46(int value, int expected)
        {
