...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests7.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 7.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests7
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 7
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_7(int value, int expected)
        {
