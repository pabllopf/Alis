...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests25.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 25.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests25
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 25
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_25(int value, int expected)
        {
