...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests32.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 32.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests32
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 32
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_32(int value, int expected)
        {
