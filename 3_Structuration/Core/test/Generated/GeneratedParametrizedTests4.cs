...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests4.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 4.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests4
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 4
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_4(int value, int expected)
        {
