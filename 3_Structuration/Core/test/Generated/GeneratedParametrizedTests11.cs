...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests11.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 11.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests11
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 11
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_11(int value, int expected)
        {
