...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests30.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 30.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests30
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 30
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_30(int value, int expected)
        {
