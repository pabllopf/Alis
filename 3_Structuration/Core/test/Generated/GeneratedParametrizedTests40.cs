...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests40.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 40.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests40
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 40
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_40(int value, int expected)
        {
