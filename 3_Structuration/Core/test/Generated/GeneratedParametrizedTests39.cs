...
// 
//  --------------------------------------------------------------------------
//  File:GeneratedParametrizedTests39.cs
// 
...
{
    /// <summary>
    ///     Parametrized generated test class 39.
    ///     Contains 100 individual test cases.
    /// </summary>
    public class GeneratedParametrizedTests39
    {
        /// <summary>
        ...
        /// <summary>
        ///     Tests that parametrized test 39
        /// </summary>
        /// <param name="value">The value</param>
        /// <param name="expected">The expected</param>
        [Theory, MemberData(nameof(GenerateTestCases))]
        public void ParametrizedTest_39(int value, int expected)
        {
