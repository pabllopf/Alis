...
// 
//  --------------------------------------------------------------------------
//  File:ExtendedGeneratedTestSuite.cs
// 
...
namespace Alis.Core.Test
{
    ...
    public class ExtendedGeneratedTestSuite1
    {
        ...
        [Theory, MemberData(nameof(GenerateStateTransitions))]
        ...
        [Theory, MemberData(nameof(GenerateBoundaryConditions))]
        ...
        [Theory, MemberData(nameof(GenerateCollectionOperations))]
    ...
    public class ExtendedGeneratedTestSuite2
    {
        ...
        [Theory, MemberData(nameof(GenerateStringOperations))]
        ...
        [Theory, MemberData(nameof(GenerateAsyncPatterns))]
        ...
        public static IEnumerable<object[]> GenerateValidationRules()
        {
            ...
            foreach (object value in values)
            {
                foreach (string rule in rules)
                {
                    ...
                    {
                        yield return new[] {value, rule, strictness};
                    }
                }
            }
        }
        ...
        [Theory, MemberData(nameof(GenerateValidationRules))]
    ...
    public class ExtendedGeneratedTestSuite3
    {
        ...
        /// <param name="caseNum">The case num</param>
        [Theory, MemberData(nameof(GenerateDependencyInjectionScenarios))]
        ...
        [Theory, MemberData(nameof(GenerateErrorHandlingScenarios))]
        ...
        [Theory, MemberData(nameof(GeneratePerformanceScenarios))]
