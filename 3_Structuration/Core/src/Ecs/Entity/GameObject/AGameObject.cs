...
namespace Alis.Core.Ecs.Entity.GameObject
{
    ...
    public abstract class AGameObject : IGameObject<AComponent>, IHasContext<AContext>
    {
        /// <summary>
        ...
        public abstract void Add<T>(T component) where T : AComponent;
        ...
        /// <typeparam name="T">The </typeparam>
        /// <param name="component">The component</param>
        public abstract void Remove<T>(T component) where T : AComponent;
        ...
        /// <typeparam name="T">The </typeparam>
        /// <returns>The</returns>
        public abstract T Get<T>() where T : AComponent;
        ...
        public abstract bool Contains<T>() where T : AComponent;
        
        /// <summary>
        ///     Clears this instance
        /// </summary>
        /// <typeparam name="T">The </typeparam>
        public abstract void Clear<T>() where T : AComponent;
        ...
        /// </summary>
        protected internal AContext Context { get; private set; }
