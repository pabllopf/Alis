...
namespace Alis.Core.Ecs.Entity.Scene
{
    ...
    ///     The scene class
    /// </summary>
    public abstract class AScene : IScene<AGameObject>, IHasContext<AContext>
    {
        /// <summary>
        ...
        /// </summary>
        public List<AGameObject> GameObjects { get; set; } = new List<AGameObject>();
        ...
        public abstract void Add<T>(T component) where T : AGameObject;
        ...
        /// <typeparam name="T">The </typeparam>
        /// <param name="component">The component</param>
        public abstract void Remove<T>(T component) where T : AGameObject;
        ...
        /// <typeparam name="T">The </typeparam>
        /// <returns>The</returns>
        public abstract T Get<T>() where T : AGameObject;
        ...
        public abstract bool Contains<T>() where T : AGameObject;
        
        /// <summary>
        ///     Clears this instance
        /// </summary>
        /// <typeparam name="T">The </typeparam>
        public abstract void Clear<T>() where T : AGameObject;
        
        /// <summary>
        /// Gets or sets the value of the context
        /// </summary>
        protected internal AContext Context { get; set; }
        
        /// <summary>
        /// Sets the context using the specified context
        /// </summary>
        /// <param name="context">The context</param>
        public void SetContext(AContext context)
        {
            Context = context;
