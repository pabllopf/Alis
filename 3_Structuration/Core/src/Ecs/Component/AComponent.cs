...
namespace Alis.Core.Ecs.Component
{
    ...
    public abstract class AComponent : IComponent<AGameObject>, IHasContext<AContext>
    {
        /// <summary>
        ...
        /// </summary>
        public AGameObject GameObject { get; set; }
        
        /// <summary>
        ///     Gets or sets the value of the game object
        /// </summary>
        public AContext Context{ get; set; }
        ...
        public void Attach(AGameObject gameObject) => GameObject = gameObject;
        ...
        /// </summary>
        /// <param name="gameObject">The game object</param>
        public virtual void OnCollisionEnter(AGameObject gameObject) => Logger.Trace();
        
        /// <summary>
        ///     Ons the collision exit using the specified game object
        /// </summary>
        /// <param name="gameObject">The game object</param>
        public virtual void OnCollisionExit(AGameObject gameObject) => Logger.Trace();
        
        /// <summary>
        ///     Ons the collision stay using the specified game object
        /// </summary>
        /// <param name="gameObject">The game object</param>
        public virtual void OnCollisionStay(AGameObject gameObject) => Logger.Trace();
        
        /// <summary>
        ///     Ons the trigger enter using the specified game object
        /// </summary>
        /// <param name="gameObject">The game object</param>
        public virtual void OnTriggerEnter(AGameObject gameObject) => Logger.Trace();
        
        /// <summary>
        ///     Ons the trigger exit using the specified game object
        /// </summary>
        /// <param name="gameObject">The game object</param>
        public virtual void OnTriggerExit(AGameObject gameObject) => Logger.Trace();
        
        /// <summary>
        ///     Ons the trigger stay using the specified game object
        /// </summary>
        /// <param name="gameObject">The game object</param>
        public virtual void OnTriggerStay(AGameObject gameObject) => Logger.Trace();
