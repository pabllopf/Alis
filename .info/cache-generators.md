...
| **Output** | `Generator/Collections/`, `Generator/Models/`, `Generator/Structures/` |
...
| Generator | Test Project | Purpose |
|-----------|-------------|---------|
| ECS Generator | `4_Operation/Ecs/generator/Alis.Core.Ecs.Generator.csproj` | Self-testing via incremental generator |
| Graphic Generator | `4_Operation/Graphic/generator/Alis.Core.Graphic.Generator.csproj` | Self-testing via incremental generator |
| Memory Generator | `6_Ideation/Memory/generator/Alis.Core.Aspect.Memory.Generator.csproj` | Self-testing via incremental generator |
| Fluent Generator | `6_Ideation/Fluent/generator/Alis.Core.Aspect.Fluent.Generator.csproj` | Self-testing via incremental generator |
| Data Generator | `6_Ideation/Data/generator/Alis.Core.Aspect.Data.Generator.csproj` | Self-testing via incremental generator |
