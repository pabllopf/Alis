...
### Setting Builders
InputSettingBuilder, GeneralSettingBuilder, NetworkSettingBuilder, GraphicSettingBuilder, AudioSettingBuilder, PhysicSettingBuilder
...
### Adding New Code to Any Module
1. Follow existing naming conventions strictly
2. Place files in correct subdirectories
3. Use existing builder patterns for new component types
4. Add corresponding tests in `test/` directory
5. Add samples in `sample/` directory for new features
6. Update the project's QualityPlan.md with new goals/tasks
7. Update this cache file if new patterns emerge