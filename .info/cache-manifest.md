...
| `cache-module-status.md` | Per-module status, QualityPlan progress, known issues | Active |
...
| "How do modules depend on each other?" | `dependencies.md` | `cache-config.md`, `cache-module-status.md` |
| "What's the architecture?" | `architecture.md` | `cache-patterns.md` |
| "Find a specific class/interface" | `symbols.md` | `namespaces.md` |
| "How to build/test?" | `plan.md` | `cache-ci-cd.md`, `cache-config.md` |
...
| "Module status and progress?" | - | `cache-module-status.md` |
...
| File | Scope | Projects |
|------|-------|----------|
| `alis.slnx` | Main solution | All 142 projects |
