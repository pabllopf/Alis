...
namespace Alis.Core.Physic.Dynamics.Contacts
{
    ...
    public class PolyAndCircleContact : Contact
    {
        ...
        private static void CollidePolygonCircle(ref Manifold manifold, IShape shape1, XForm xf1, IShape shape2,
            XForm xf2)
        {
            Collision.CollidePolygonAndCircle(ref manifold, (PolygonShape) shape1, xf1, (CircleShape) shape2,
                xf2);
        }
        ...
        public new static Contact Create(Fixture fixtureA, Fixture fixtureB) => new PolyAndCircleContact(fixtureA, fixtureB);
