...
namespace Alis.Core.Physic.Dynamics.Contacts
{
    ...
    public class CircleContact : Contact
    {
        ...
        private static void CollideCircles(ref Manifold manifold, IShape shape1, XForm xf1, IShape shape2, XForm xf2)
        {
        ...
        public new static Contact Create(Fixture fixtureA, Fixture fixtureB) => new CircleContact(fixtureA, fixtureB);
