...
namespace Alis.Core.Physic.Test.Collisions.Shapes
{
    ...
    public class MassDataTests
    {
        ...
        /// </summary>
        public MassDataTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the mass data
        /// </summary>
        /// <returns>The mass data</returns>
        private MassData CreateMassData() => new MassData();
        ...
        {
            // Arrange
            MassData massData = CreateMassData();
