...
namespace Alis.Core.Physic.Test.Collisions
{
    ...
    public class RayCastInputTests
    {
        ...
        /// </summary>
        public RayCastInputTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the ray cast input
        /// </summary>
        /// <returns>The ray cast input</returns>
        private RayCastInput CreateRayCastInput() => new RayCastInput();
