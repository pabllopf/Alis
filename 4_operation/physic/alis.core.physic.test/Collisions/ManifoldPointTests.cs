...
namespace Alis.Core.Physic.Test.Collisions
{
    ...
    public class ManifoldPointTests
    {
        ...
        /// </summary>
        public ManifoldPointTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the manifold point
        /// </summary>
        /// <returns>The manifold point</returns>
        private ManifoldPoint CreateManifoldPoint() => new ManifoldPoint();
        ...
        {
            // Arrange
            ManifoldPoint manifoldPoint = CreateManifoldPoint();

            // Act
            ManifoldPoint result = manifoldPoint.Clone();
