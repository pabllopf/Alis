...
namespace Alis.Core.Physic.Test.Collisions
{
    ...
    public class DistanceOutputTests
    {
        ...
        /// </summary>
        public DistanceOutputTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the distance output
        /// </summary>
        /// <returns>The distance output</returns>
        private DistanceOutput CreateDistanceOutput() => new DistanceOutput();
        ...
        {
            // Arrange
            DistanceOutput distanceOutput = CreateDistanceOutput();
