...
namespace Alis.Core.Physic.Test.Dynamics.Contacts
{
    ...
    public class ContactConstraintPointTests
    {
        ...
        /// </summary>
        public ContactConstraintPointTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the contact constraint point
        /// </summary>
        /// <returns>The contact constraint point</returns>
        private ContactConstraintPoint CreateContactConstraintPoint() => new ContactConstraintPoint();
        ...
        {
            // Arrange
            ContactConstraintPoint contactConstraintPoint = CreateContactConstraintPoint();
