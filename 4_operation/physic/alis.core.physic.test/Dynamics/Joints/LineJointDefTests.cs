...
namespace Alis.Core.Physic.Test.Dynamics.Joints
{
    ...
    public class LineJointDefTests
    {
        ...
        /// </summary>
        public LineJointDefTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the line joint def
        /// </summary>
        /// <returns>The line joint def</returns>
        private LineJointDef CreateLineJointDef() => new LineJointDef();
