...
namespace Alis.Core.Physic.Test.Dynamics
{
    ...
    public class CircleDefTests
    {
        ...
        /// </summary>
        public CircleDefTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the circle def
        /// </summary>
        /// <returns>The circle def</returns>
        private CircleDef CreateCircleDef() => new CircleDef();
        ...
        {
            // Arrange
            CircleDef circleDef = CreateCircleDef();
