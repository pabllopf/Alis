...
// 
//  --------------------------------------------------------------------------
//  File:ConstantAccelControllerDefTests.cs
// 
...
namespace Alis.Core.Physic.Test.Dynamics.Controllers
{
    ...
    public class ConstantAccelControllerDefTests
    {
        ...
        /// </summary>
        public ConstantAccelControllerDefTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the constant accel controller def
        /// </summary>
        /// <returns>The constant accel controller def</returns>
        private ConstantAccelControllerDef CreateConstantAccelControllerDef() => new ConstantAccelControllerDef();
        ...
        {
            // Arrange
            ConstantAccelControllerDef constantAccelControllerDef = CreateConstantAccelControllerDef();
