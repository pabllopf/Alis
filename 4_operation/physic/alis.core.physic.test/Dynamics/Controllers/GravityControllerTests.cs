...
// 
//  --------------------------------------------------------------------------
//  File:GravityControllerTests.cs
// 
...
namespace Alis.Core.Physic.Test.Dynamics.Controllers
{
    ...
    public class GravityControllerTests
    {
        ...
        private GravityController CreateGravityController() => new GravityController(
        ...
        {
            // Arrange
            GravityController gravityController = CreateGravityController();
