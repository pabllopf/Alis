...
namespace Alis.Core.Physic.Test.Dynamics
{
    ...
    public class EdgeDefTests
    {
        ...
        /// </summary>
        public EdgeDefTests() => mockRepository = new MockRepository(MockBehavior.Strict);

        /// <summary>
        ///     Creates the edge def
        /// </summary>
        /// <returns>The edge def</returns>
        private EdgeDef CreateEdgeDef() => new EdgeDef();
