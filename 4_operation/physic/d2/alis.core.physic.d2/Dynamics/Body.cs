...
using Alis.Core.Physic.D2.Extensions.PhysicsLogics.PhysicsLogicBase;
...
namespace Alis.Core.Physic.D2.Dynamics
{
    ...
    public class Body
    {
        ...
        {
            get { return Rotation / MathConstants.Pi; }
        }
        ...
        {
            get { return (Flags & BodyFlags.BulletFlag) == BodyFlags.BulletFlag; }
            set
            {
                if (value)
                {
        ...
        {
            get { return (Flags & BodyFlags.AutoSleepFlag) == BodyFlags.AutoSleepFlag; }
            set
            {
                if (value)
                {
        ...
        public bool Awake
        {
            get { return (Flags & BodyFlags.AwakeFlag) == BodyFlags.AwakeFlag; }
            set
            {
                if (Type == BodyType.Static)
                {
        ...
        {
            get { return (Flags & BodyFlags.FixedRotationFlag) == BodyFlags.FixedRotationFlag; }
            set
            {
        ...
        {
            get { return (Flags & BodyFlags.IslandFlag) == BodyFlags.IslandFlag; }
        }
        ...
        {
            get { return Type == BodyType.Kinematic; }
        }
        ...
        {
            get { return Type == BodyType.Dynamic; }
        }
        ...
        {
            get { return inertia + mass * Vector2.Dot(Sweep.LocalCenter, Sweep.LocalCenter); }
            set
            {
                Debug.Assert(!float.IsNaN(value));
