...
namespace Alis.Core.Physic.D2.Tools.TextureTools
{
    ...
    public sealed class TextureConverter
    {
        ...
        {
            get { return polygonDetectionType; }
        ...
        {
            get { return pixelOffsetOptimization; }
        ...
        {
            get { return (byte) (alphaTolerance >> 24); }
